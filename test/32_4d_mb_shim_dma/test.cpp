...
main(int argc, char *argv[])
{
  ...
  air_packet_nd_memcpy(pkt_c, 0, col, 0, 0, 4, 2, AIR_BBUFF_BASE+(IMAGE_SIZE*sizeof(float)), TILE_WIDTH*sizeof(float), TILE_HEIGHT, IMAGE_WIDTH*sizeof(float), NUM_3D, TILE_WIDTH*sizeof(float), NUM_4D, IMAGE_WIDTH*TILE_HEIGHT*sizeof(float));
  ...
  air_packet_nd_memcpy(pkt_a, 0, col, 1, 0, 4, 2, AIR_BBUFF_BASE, TILE_WIDTH*sizeof(float), TILE_HEIGHT, IMAGE_WIDTH*sizeof(float), NUM_3D, TILE_WIDTH*sizeof(float), NUM_4D, IMAGE_WIDTH*TILE_HEIGHT*sizeof(float));
