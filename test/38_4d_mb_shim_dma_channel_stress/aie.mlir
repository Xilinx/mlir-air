...
module {
  ...
  %m84 = AIE.mem(%t84) {
    ...
    ^dma0:
      %dstDma = AIE.dmaStart("MM2S0", ^bd2, ^end)
    ^bd0:
      AIE.useLock(%l84_0, "Acquire", 0, 0)
      AIE.dmaBd(<%buf84_0 : memref<128xi32>, 0, 128>, 0)
      AIE.useLock(%l84_0, "Release", 1, 0)
      br ^bd1
    ^bd1:
      AIE.useLock(%l84_1, "Acquire", 0, 0)
      AIE.dmaBd(<%buf84_1 : memref<128xi32>, 0, 128>, 0)
      AIE.useLock(%l84_1, "Release", 1, 0)
      br ^bd0
    ^bd2:
      AIE.useLock(%l84_0, "Acquire", 1, 0)
      AIE.dmaBd(<%buf84_0 : memref<128xi32>, 0, 128>, 0)
      AIE.useLock(%l84_0, "Release", 0, 0)
      br ^bd3
    ^bd3:
      AIE.useLock(%l84_1, "Acquire", 1, 0)
      AIE.dmaBd(<%buf84_1 : memref<128xi32>, 0, 128>, 0)
      AIE.useLock(%l84_1, "Release", 0, 0)
      br ^bd2
    ^end:
      AIE.end
  }
