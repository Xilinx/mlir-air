...
def generate_add_module(shape, dtype):
    ...
    ^bb0(%arg0: !pdl.operation):
      ...
      ^bb1(%arg1: !pdl.operation):
        ...
        %name = transform.param.constant "binary_add_bf16_f32" -> !transform.any_param
    ...
    pm = PassManager.parse('builtin.module(func.func(canonicalize,cse),air-linalg-to-std)')
    pm.run(module.operation)
    return module
