...
def build_module(idtype, odtype, l3_shape, l2_shape, l1_shape):
    ...
    def mul(arg0, arg1, arg2):
        ...
        def launch_body(i, s, a, b, c):
            ...
            o = arith.MulIOp(m, i)
            ChannelPut("ChanL2A", a, src_offsets=[o], src_sizes=[m], src_strides=[1])
            ChannelPut("ChanL2B", b, src_offsets=[o], src_sizes=[m], src_strides=[1])
            ChannelGet("ChanL2C", c, dst_offsets=[o], dst_sizes=[m], dst_strides=[1])
