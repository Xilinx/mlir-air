  ...
  func.func @forward(%arg0: memref<512x1024xbf16>, %arg1: memref<128x8x8x64xbf16>, %arg2: memref<512x512xf32>) -> memref<512x512xf32> {
    ...
    scf.forall (%arg3, %arg4) in (4, 4) {
      ...
      scf.for %arg5 = %c0 to %c128 step %c32 {
        %subview_3 = memref.subview %arg1[%arg5, 0, 0, %map1] [32, 8, 8, 16] [1, 1, 1, 1] : memref<128x8x8x64xbf16> to memref<32x8x8x16xbf16, strided<[4096, 512, 64, 1], offset: ?>>
      ...
      scf.forall (%arg5, %arg6) in (2, 2) {
        ...
        scf.for %arg7 = %c0 to %c128 step %c8 {
          ...
          %subview_6 = memref.subview %alloc_1[%arg7, 0, %map, 0] [8, 8, 4, 16] [1, 1, 1, 1] : memref<128x8x8x16xbf16, 1> to memref<8x8x4x16xbf16, strided<[1024, 128, 16, 1], offset: ?>, 1>
