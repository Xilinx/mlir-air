...
//===----------------------------------------------------------------------===//
// Triton Softmax Tiling Recipe Transform Script (NPU1 / AIE2)
//===----------------------------------------------------------------------===//
// This transform script implements a comprehensive tiling and optimization
// strategy for softmax operations targeting AIE2 (AI Engine 2) hardware.
//
...
//
// NPU1/AIE2 SPECIFIC NOTES:
// - Uses 16-lane vector width (vs 32-lane on NPU2/AIE2P)
// - Requires external function (extern_func.o) for exp computation via LUT
// - exp intrinsic is implemented via getExpBf16() in extern_func.cc
//
// The recipe assumes:
...
^bb0(%arg0: !pdl.operation):
    ...
    ^bb1(%arg1: !pdl.operation):
        ...
        // NPU1/AIE2 uses 16-lane vector width (vs 32-lane on NPU2/AIE2P)

        // Tile generic operations for vectorization with tile size 16 (AIE2 vector width)
        ...
        // NPU1/AIE2: Link with external function for exp computation
        // The getExpBf16() function in extern_func.cc implements exp via LUT
        // (AIE2 does not have native exp intrinsic like AIE2P)
