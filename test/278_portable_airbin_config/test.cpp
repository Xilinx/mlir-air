...
int addone_driver(aie_libxaie_ctx_t *xaie, int fd, queue_t *q, int col,
                  int row) {
  /////////////////////////////////////////////////////////////////////////////
...
int matadd_driver(aie_libxaie_ctx_t *xaie, int fd, queue_t *q, int col,
                  int row) {
// test configuration
...
int main(int argc, char **argv) {
  ...
  if (strcmp(airbin_name, "addone.airbin") == 0) {
    errors = addone_driver(xaie, fd, q, col, row);
  } else if (strcmp(airbin_name, "matadd.airbin") == 0) {
    errors = matadd_driver(xaie, fd, q, col, row);
  } else
    errors = 1;
