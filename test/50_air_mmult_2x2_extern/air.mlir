...
module {
  ...
  func.func @forward(%arg0: memref<64x128xi32>, %arg1: memref<128x64xi32>, %arg2: memref<64x64xi32>) {
    ...
    %6 = air.herd @herd_0 async [%async_token_3]  tile (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) attributes {id = 1 : i32, link_with = "extern_kernel.o"} {
      ...
      %9:4 = scf.for %arg7 = %c0_6 to %c128_7 step %c64_5 iter_args(%arg8 = %async_token_14, %arg9 = %async_token_16, %arg10 = %async_token_16, %arg11 = %async_token_16) -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
        ...
        %async_token_19 = air.execute [%arg10, %12, %11] {
          func.call @extern_kernel(%results_15, %results_17, %results_9) : (memref<32x32xi32, 2>, memref<32x32xi32, 2>, memref<32x32xi32, 2>) -> ()
        }
        ...
        %async_token_22 = air.execute [%async_token_19, %14, %13] {
          func.call @extern_kernel(%results_13, %results_11, %results_9) : (memref<32x32xi32, 2>, memref<32x32xi32, 2>, memref<32x32xi32, 2>) -> ()
        }
  ...
  func.func private @extern_kernel(memref<32x32xi32, 2>, memref<32x32xi32, 2>, memref<32x32xi32, 2>)
}
