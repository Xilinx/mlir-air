...
module attributes {torch.debug_module_name = "test"} {
  func.func @forward(%arg0: memref<10240xi32>, %arg1: memref<10240xi32>, %arg2: memref<10240xi32>) -> memref<10240xi32> {
    ...
    air.partition @part0  args(%arg3=%arg0, %arg4=%arg1, %arg5=%arg2, %arg6=%0) : memref<10240xi32>, memref<10240xi32>, memref<10240xi32>, memref<10240xi32> {
      ...
      // %1 = %arg1 + % arg2
      air.launch_herd  tile (%arg7, %arg8) in (%arg9=%c2, %arg10=%c1) args(%arg11=%arg4, %arg12=%arg5, %arg13=%1) : memref<10240xi32>, memref<10240xi32>, memref<10240xi32> attributes {sym_name = "herd_0", x_loc = 4 : i64, y_loc = 2 : i64} {
      ...
      // %0 = %arg2 * %1
      air.launch_herd  tile (%arg7, %arg8) in (%arg9=%c2, %arg10=%c1) args(%arg11=%arg3, %arg12=%1, %arg13=%arg6) : memref<10240xi32>, memref<10240xi32>, memref<10240xi32> attributes {sym_name = "herd_1", x_loc = 10 : i64, y_loc = 2 : i64} {
        %c1_0 = arith.constant 1 : index
        %c0 = arith.constant 0 : index
        %c5120 = arith.constant 5120 : index
        %c1280 = arith.constant 1280 : index
