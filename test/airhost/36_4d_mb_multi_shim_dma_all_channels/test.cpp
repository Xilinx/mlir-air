...
int main(int argc, char *argv[]) {
  ...
  uint32_t *dram_ptr_4 = (uint32_t *)air_malloc(IMAGE_SIZE * sizeof(uint32_t));
  uint32_t *dram_ptr_5 = (uint32_t *)air_malloc(IMAGE_SIZE * sizeof(uint32_t));
  ...
  air_packet_nd_memcpy(
      &pkt_a, 0, 7, 1, 0, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_1),
  ...
  air_packet_nd_memcpy(
      &pkt_b, 0, 7, 1, 1, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_1),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
  ...
  air_packet_nd_memcpy(
      &pkt_e, 0, 6, 1, 0, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_1),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
  ...
  air_packet_nd_memcpy(
      &pkt_f, 0, 6, 1, 1, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_1),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
  ...
  air_packet_nd_memcpy(
      &pkt_c, 0, 7, 0, 0, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_2),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
  ...
  air_packet_nd_memcpy(
      &pkt_d, 0, 7, 0, 1, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_3),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
                                 &pkt_d.completion_signal);
  ...
  air_packet_nd_memcpy(
      &pkt_g, 0, 6, 0, 0, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_4),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
  hsa_amd_signal_create_on_agent(1, 0, nullptr, &agents[0], 0,
  ...
  air_packet_nd_memcpy(
      &pkt_h, 0, 6, 0, 1, 4, 2, reinterpret_cast<uint64_t>(dram_ptr_5),
      TILE_WIDTH * sizeof(float), TILE_HEIGHT, IMAGE_WIDTH * sizeof(float),
      NUM_3D, TILE_WIDTH * sizeof(float), NUM_4D,
      IMAGE_WIDTH * TILE_HEIGHT * sizeof(float));
