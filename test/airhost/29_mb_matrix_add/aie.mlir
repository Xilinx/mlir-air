...
module {
  ...
  %m72 = aie.mem(%t72) {
    ...
    ^bd1:
      ...
      aie.dma_bd(%buf72_2 : memref<128xi32>, 0, 128)
      aie.use_lock(%l72_1, "Release", 1)
      aie.next_bd ^bd0
    ^bd4:
      aie.use_lock(%l72_4, "Acquire", 0)
      aie.dma_bd(%buf72_4 : memref<128xi32>, 0, 128)
      aie.use_lock(%l72_4, "Release", 1)
      aie.next_bd ^bd5
    ^bd5:
      aie.use_lock(%l72_5, "Acquire", 0)
      aie.dma_bd(%buf72_5 : memref<128xi32>, 0, 128)
    ...
    ^bd3:
      ...
      aie.dma_bd(%buf72_3 : memref<128xi32>, 0, 128)
