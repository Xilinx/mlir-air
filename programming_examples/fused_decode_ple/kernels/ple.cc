...
// bd35a90e3 hand-rolled the gelu here because the LUT misbehaved on this core;
// that was an alignment bug in the table, now fixed at the source, and the two
// agree on device (0.998385 vs 0.998387 on layer 4).
