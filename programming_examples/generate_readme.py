...
def render_llm_benchmark(perf_path):
...
def generate_readme(base_url="", llm_perf_path=None):
    """Generate the full README.md content."""
    table_rows = generate_dashboard_table(base_url=base_url)
    table_body = "\n".join(table_rows)
    llm_section = render_llm_benchmark(llm_perf_path)
...
if __name__ == "__main__":
    ...
    content = generate_readme(base_url=args.base_url, llm_perf_path=args.llm_perf)
