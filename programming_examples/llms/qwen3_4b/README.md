...
|-------|----------|-------|
| Prefill / TTFT (2048 tokens) | **5.78 s wall** | head_dim=128 → host head-first FA seq↔head transpose included in wall; NPU-kernel time ~4.90 s |
| Decode / TPOT (steady-state) | **3.6 tok/s** | 36 layers, NPU-compute-bound; full decode O+FFN on NPU |
