...
See the **[Operator Dashboard](https://xilinx.github.io/mlir-air/dev/programming_examples/)** for the full table of supported operators with NPU1/NPU2 status indicators. The table is generated by `generate_readme.py`, and the NPU1/NPU2 status indicators are derived from LIT test files. It is published to GitHub Pages on every push to `main`.
