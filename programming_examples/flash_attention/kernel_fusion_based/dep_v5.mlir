...
#set2 = affine_set<()[s0, s1] : (s0 >= 0, -s0 + 3 >= 0, s1 - 1 == 0)>
#set3 = affine_set<()[s0, s1] : (s0 >= 0, -s0 + 3 >= 0, s1 - 2 == 0)>
        ...
        %44 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 3 : i32, link_with = "attn.o"} {
          ...
          %45 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 41 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
            ...
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
          ...
          %48 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
            ...
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
          ...
          %49 = arith.cmpi eq, %46, %c1_i32 : i32
          scf.if %49 {
            %async_token_51 = air.execute [%48] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          }
          %50 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
            ...
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
          ...
          %51 = arith.cmpi eq, %46, %c2_i32 : i32
          scf.if %51 {
          ...
          %52 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
            ...
            %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %58 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %58 : !air.async.token
            } else {
              %58 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %59 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %59 : !air.async.token
              } else {
                %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %60 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                } else {
                  %60 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %60 : !air.async.token
                }
                affine.yield %59 : !air.async.token
              }
          ...
          %53 = arith.cmpi eq, %46, %c3_i32 : i32
          scf.if %53 {
            %async_token_51 = air.execute [%52] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          }
          %54 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50] 
          %55 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %54) -> (!air.async.token) {
            ...
            %57 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %63 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async [%arg29]  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %65 = air.channel.get async [%arg29]  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %65 : !air.async.token
                } else {
                  %65 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %66 = air.channel.get async [%arg29]  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %66 : !air.async.token
                  } else {
                    %66 = air.channel.get async [%arg29]  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %66 : !air.async.token
                  }
                  affine.yield %65 : !air.async.token
                }
              ...
              %63 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async [%arg29]  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %65 = air.channel.get async [%arg29]  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %65 : !air.async.token
                } else {
                  %65 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %66 = air.channel.get async [%arg29]  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %66 : !air.async.token
                  } else {
                    %66 = air.channel.get async [%arg29]  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %66 : !air.async.token
                  }
                  affine.yield %65 : !air.async.token
                }
            ...
            %58 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %63 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async  @V2L1_0_0[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = air.channel.get async  @V2L1_0_1[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              }
              affine.yield %63 : !air.async.token
            } else {
            ...
            %59 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %63 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async [%arg29, %58]  @V2L1_1_0[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = air.channel.get async [%arg29, %58]  @V2L1_1_1[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              }
              affine.yield %63 : !air.async.token
            } else {
            ...
            %60 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %63 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async [%arg29, %59]  @V2L1_2_0[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = air.channel.get async [%arg29, %59]  @V2L1_2_1[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              }
              affine.yield %63 : !air.async.token
            } else {
            ...
            %61 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              %63 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %64 = air.channel.get async [%arg29, %60]  @V2L1_3_0[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              } else {
                %64 = air.channel.get async [%arg29, %60]  @V2L1_3_1[%arg27, %arg17, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %64 : !air.async.token
              }
              affine.yield %63 : !air.async.token
            } else {
            ...
            %async_token_52 = air.execute [%async_token_51, %57] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_59 = air.execute [%async_token_58, %61] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %62 = air.wait_all async [%58, %59, %60, %async_token_59, %async_token_61] 
            scf.yield %62 : !air.async.token
          }
          %56 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
            %57 = arith.subi %arg17, %c1_45 : index
            %58 = air.channel.put async [%55]  @cascade_gp[%arg16, %57] (%arg24[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
            %59 = air.channel.put async [%55]  @cascade_up[%arg16, %57] (%arg25[] [] []) {id = 90 : i32} : (memref<64x1xbf16, 2 : i32>)
            %60 = air.channel.put async [%55]  @cascade_sp[%arg16, %57] (%arg26[] [] []) {id = 91 : i32} : (memref<64x1xbf16, 2 : i32>)
            %61 = air.wait_all async [%58, %59, %60] 
            affine.yield %61 : !air.async.token
          } else {
            %57 = affine.if #set8()[%arg16, %arg17] -> !air.async.token {
              ...
              %58 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
              %59 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 93 : i32} : (memref<64x1xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 94 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              %async_token_59 = air.execute [%async_token_57, %55] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_58) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              }
              %async_token_60 = air.execute [%async_token_59, %59] {
              ...
              %async_token_67 = air.execute [%async_token_63, %58] {
              ...
              %async_token_73 = air.execute [%async_token_72, %async_token_67, %60] {
              ...
              %61 = arith.subi %arg17, %c1_45 : index
              %62 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %61] (%results_52[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
              %63 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %61] (%arg25[] [] []) {id = 96 : i32} : (memref<64x1xbf16, 2 : i32>)
              %64 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %61] (%results_56[] [] []) {id = 97 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_76 = air.execute [%62] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              }
              %async_token_77 = air.execute [%async_token_63] {
                memref.dealloc %results_54 : memref<64x1xbf16, 2 : i32>
              }
              %async_token_78 = air.execute [%64] {
                memref.dealloc %results_56 : memref<64x1xbf16, 2 : i32>
              }
              ...
              %65 = air.wait_all async [%62, %63, %64] 
              affine.yield %65 : !air.async.token
            } else {
              %async_token_51, %results_52 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %58 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
              %59 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 99 : i32} : (memref<64x1xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 100 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              ...
              %61 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_77 = air.execute [%61] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              }
