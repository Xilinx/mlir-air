      ...
      %37 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %44 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 3 : i32, link_with = "attn.o"} {
          ...
          %46 = affine.if #set2()[%arg16] -> !air.async.token {
            %async_token_51 = air.execute [%45, %45, %45, %45] {
          ...
          %47 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%46, %46]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%46, %46]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%46, %46]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%46, %46]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%46, %46]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%46, %46]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%46, %46]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%46, %46]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %48 = affine.if #set3()[%arg16] -> !air.async.token {
            %async_token_51 = air.execute [%47, %47, %47, %47] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
            affine.yield %async_token_51 : !air.async.token
          } else {
          ...
          %49 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%48, %48]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%48, %48]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%48, %48]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%48, %48]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%48, %48]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%48, %48]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%48, %48]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%48, %48]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %50 = affine.if #set4()[%arg16] -> !air.async.token {
            %async_token_51 = air.execute [%49, %49, %49, %49] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
            affine.yield %async_token_51 : !air.async.token
          } else {
          ...
          %51 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%50, %50]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%50, %50]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%50, %50]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%50, %50]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%50, %50]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%50, %50]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%50, %50]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%50, %50]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %52 = affine.if #set5()[%arg16] -> !air.async.token {
            %async_token_51 = air.execute [%51, %51, %51, %51] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
            affine.yield %async_token_51 : !air.async.token
          } else {
          ...
          %53 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50, %52, %52] 
          %54 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %53) -> (!air.async.token) {
            ...
            %async_token_52 = air.execute [%56, %56, %56, %56, %async_token_51] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
