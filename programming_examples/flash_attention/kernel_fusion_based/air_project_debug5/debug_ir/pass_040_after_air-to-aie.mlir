...
module {
  aie.device(npu2_4col) @attn_seg_0_0 {
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%lock_3_5_66, Release, 1)
      scf.for %arg0 = %c0_70 to %c2_69 step %c1_68 {
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%lock_1_5_61, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_1_5_60, Release, 1)
      scf.for %arg0 = %c0_69 to %c2_68 step %c1_70 {
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%lock_1_4_49, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_1_4_48, Release, 1)
      scf.for %arg0 = %c0_68 to %c2_69 step %c1_70 {
      ...
      scf.for %arg0 = %c0_68 to %c4096 step %c32 {
        %subview = memref.subview %collapse_shape[%arg0] [32] [1] : memref<4096xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0_68] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_71 = memref.collapse_shape %buf149 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0_68 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_71[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0_68] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      ...
      scf.for %arg0 = %c0_68 to %c4096 step %c32 {
        %subview = memref.subview %collapse_shape_73[%arg0] [32] [1] : memref<4096xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0_68], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%lock_2_3_40, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_2_3_39, Release, 1)
      scf.for %arg0 = %c0_68 to %c2_70 step %c1_69 {
    ...
    ^bb2:  // pred: ^bb1
      ...
      aie.use_lock(%lock_0_3_34, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_0_3_33, Release, 1)
      scf.for %arg0 = %c0_70 to %c2_68 step %c1_69 {
  ...
  func.func @attention_bf16(%arg0: memref<2x512x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x512x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16> attributes {id = 1 : i32} {
      ...
      %43 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32, x_loc = 0 : i64, x_size = 8 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %48 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %44) -> (!air.async.token) {
          %async_token_19, %results_20 = air.execute -> (memref<64x64xbf16, 1 : i32>) {
            %alloc = memref.alloc() : memref<64x64xbf16, 1 : i32>
            air.execute_terminator %alloc : memref<64x64xbf16, 1 : i32>
          } {hoist_alloc = true}
          %61 = air.channel.get async [%async_token_19, %arg17]  @VIn_0[%arg12] (%results_20[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
          %62 = arith.cmpi eq, %arg12, %c0_7 : index
          %63 = scf.if %62 -> (!air.async.token) {
            %64 = air.channel.put async [%61]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          } else {
            %64 = air.channel.put async [%61]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          }
          %async_token_21 = air.execute [%63, %61] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
          }
          scf.yield %63 : !air.async.token
        }
        %49 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %45) -> (!air.async.token) {
          %async_token_19, %results_20 = air.execute -> (memref<64x64xbf16, 1 : i32>) {
            %alloc = memref.alloc() : memref<64x64xbf16, 1 : i32>
            air.execute_terminator %alloc : memref<64x64xbf16, 1 : i32>
          } {hoist_alloc = true}
          %61 = air.channel.get async [%async_token_19, %arg17]  @VIn_1[%arg12] (%results_20[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
          %62 = arith.cmpi eq, %arg12, %c0_7 : index
          %63 = scf.if %62 -> (!air.async.token) {
            %64 = air.channel.put async [%61]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          } else {
            %64 = air.channel.put async [%61]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          }
          %async_token_21 = air.execute [%63, %61] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
        ...
        %50 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %46) -> (!air.async.token) {
          %async_token_19, %results_20 = air.execute -> (memref<64x64xbf16, 1 : i32>) {
            %alloc = memref.alloc() : memref<64x64xbf16, 1 : i32>
            air.execute_terminator %alloc : memref<64x64xbf16, 1 : i32>
          } {hoist_alloc = true}
          %61 = air.channel.get async [%async_token_19, %arg17]  @VIn_2[%arg12] (%results_20[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 1 : i32>)
          %62 = arith.cmpi eq, %arg12, %c0_7 : index
          %63 = scf.if %62 -> (!air.async.token) {
            %64 = air.channel.put async [%61]  @V2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 40 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          } else {
            %64 = air.channel.put async [%61]  @V2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 41 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          }
          %async_token_21 = air.execute [%63, %61] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
        ...
        %51 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %47) -> (!air.async.token) {
          %async_token_19, %results_20 = air.execute -> (memref<64x64xbf16, 1 : i32>) {
            %alloc = memref.alloc() : memref<64x64xbf16, 1 : i32>
            air.execute_terminator %alloc : memref<64x64xbf16, 1 : i32>
          } {hoist_alloc = true}
          %61 = air.channel.get async [%async_token_19, %arg17]  @VIn_3[%arg12] (%results_20[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 1 : i32>)
          %62 = arith.cmpi eq, %arg12, %c0_7 : index
          %63 = scf.if %62 -> (!air.async.token) {
            %64 = air.channel.put async [%61]  @V2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 43 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          } else {
            %64 = air.channel.put async [%61]  @V2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 44 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64 : !air.async.token
          }
          %async_token_21 = air.execute [%63, %61] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
        ...
        %52 = air.channel.get async [%async_token]  @Gp2L2[%c0_7, %c0_7] (%results[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 1 : i32>)
        %53 = air.channel.get async [%async_token_9]  @Gp2L2[%c1_5, %c0_7] (%results_10[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 1 : i32>)
        %54 = air.channel.get async [%async_token_11]  @Gp2L2[%c2_6, %c0_7] (%results_12[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 1 : i32>)
        %55 = air.channel.get async [%async_token_13]  @Gp2L2[%c3_2, %c0_7] (%results_14[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 1 : i32>)
        %56 = air.channel.put async [%52]  @channel_0[%c0_7, %arg12] (%results[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 1 : i32>)
        %57 = air.channel.put async [%53]  @channel_0[%c1_5, %arg12] (%results_10[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 1 : i32>)
        %58 = air.channel.put async [%54]  @channel_0[%c2_6, %arg12] (%results_12[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 1 : i32>)
        %59 = air.channel.put async [%55]  @channel_0[%c3_2, %arg12] (%results_14[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 1 : i32>)
        %60 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%arg12) : index attributes {id = 3 : i32, link_with = "attn.o", x_loc = 0 : i64, y_loc = 2 : i64} {
          ...
          %61 = arith.cmpi eq, %arg20, %c0_21 : index
          scf.if %61 {
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_0_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_0_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
            ...
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_1_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_1_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
          ...
          scf.if %63 {
            %async_token_43 = air.execute [%async_token_31, %async_token_33] {
              func.call @copy_tile(%results_32, %results_34) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          }
          scf.if %61 {
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_0_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_0_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
            ...
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_1_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_1_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
          ...
          scf.if %61 {
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_0_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_0_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
            ...
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_1_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_1_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
          ...
          scf.if %61 {
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_0_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_0_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_0_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
            ...
            %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %71 = air.channel.get async [%async_token_31]  @QK2L1_1_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %71 : !air.async.token
            } else {
              %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %72 = air.channel.get async [%async_token_31]  @QK2L1_1_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %72 : !air.async.token
              } else {
                %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                } else {
                  %73 = air.channel.get async [%async_token_31]  @QK2L1_1_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %73 : !air.async.token
                }
                affine.yield %72 : !air.async.token
              }
          ...
          %67 = air.wait_all async [%async_token_31, %async_token_33, %async_token_35, %async_token_36, %async_token_37] 
          %68 = scf.for %arg21 = %c0_21 to %c2_20 step %c1_22 iter_args(%arg22 = %67) -> (!air.async.token) {
            ...
            %async_token_47 = air.execute [%async_token_45, %arg22] {
            ...
            scf.if %61 {
              %75 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %76 = air.channel.get async [%arg22]  @QK2L1_0_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %76 : !air.async.token
              } else {
                %76 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %77 = air.channel.get async [%arg22]  @QK2L1_0_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %77 : !air.async.token
                } else {
                  %77 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %78 = air.channel.get async [%arg22]  @QK2L1_0_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %78 : !air.async.token
                  } else {
                    %78 = air.channel.get async [%arg22]  @QK2L1_0_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %78 : !air.async.token
                  }
                  affine.yield %77 : !air.async.token
                }
              ...
              %75 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %76 = air.channel.get async [%arg22]  @QK2L1_1_0[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %76 : !air.async.token
              } else {
                %76 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %77 = air.channel.get async [%arg22]  @QK2L1_1_1[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 90 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %77 : !air.async.token
                } else {
                  %77 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %78 = air.channel.get async [%arg22]  @QK2L1_1_2[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %78 : !air.async.token
                  } else {
                    %78 = air.channel.get async [%arg22]  @QK2L1_1_3[%c0_21, %c0_21, %arg16] (%results_32[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %78 : !air.async.token
                  }
                  affine.yield %77 : !air.async.token
                }
            ...
            %70 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %75 = scf.if %61 -> (!air.async.token) {
                %76 = air.channel.get async [%async_token_43]  @V2L1_0_0[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 93 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              } else {
                %76 = air.channel.get async [%async_token_43]  @V2L1_0_1[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 94 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              }
            ...
            %71 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %75 = scf.if %61 -> (!air.async.token) {
                %76 = air.channel.get async [%async_token_43, %arg22, %70]  @V2L1_1_0[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              } else {
                %76 = air.channel.get async [%async_token_43, %arg22, %70]  @V2L1_1_1[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 96 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              }
              affine.yield %75 : !air.async.token
            } else {
            ...
            %72 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %75 = scf.if %61 -> (!air.async.token) {
                %76 = air.channel.get async [%async_token_43, %arg22, %71]  @V2L1_2_0[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 97 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              } else {
                %76 = air.channel.get async [%async_token_43, %arg22, %71]  @V2L1_2_1[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              }
              affine.yield %75 : !air.async.token
            } else {
            ...
            %73 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %75 = scf.if %61 -> (!air.async.token) {
                %76 = air.channel.get async [%async_token_43, %arg22, %72]  @V2L1_3_0[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 99 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              } else {
                %76 = air.channel.get async [%async_token_43, %arg22, %72]  @V2L1_3_1[%c0_21, %arg17, %arg16] (%results_44[] [] []) {id = 100 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %76 : !air.async.token
              }
              affine.yield %75 : !air.async.token
            } else {
            ...
            %async_token_55 = air.execute [%73, %async_token_54, %async_token_43, %async_token_45] {
              %collapse_shape = memref.collapse_shape %results_46 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %74 = air.wait_all async [%70, %71, %72, %async_token_55, %async_token_57] 
            %async_token_60 = air.execute [%async_token_53, %async_token_55] {
              memref.dealloc %results_46 : memref<64x64xbf16, 2 : i32>
            }
            %async_token_61 = air.execute [%70, %71, %72, %async_token_55] {
          ...
          %69 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %71 = air.channel.put async [%async_token_29, %68]  @cascade_gp[%arg16, %70] (%results_30[] [] []) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
            %72 = air.channel.put async [%async_token_27, %68]  @cascade_up[%arg16, %70] (%results_28[] [] []) {id = 102 : i32} : (memref<64x1xbf16, 2 : i32>)
            %73 = air.channel.put async [%async_token_25, %68]  @cascade_sp[%arg16, %70] (%results_26[] [] []) {id = 103 : i32} : (memref<64x1xbf16, 2 : i32>)
            ...
            %70 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %71 = air.channel.get async [%async_token_43]  @cascade_gp[%arg16, %arg17] (%results_44[] [] []) {id = 104 : i32} : (memref<64x64xbf16, 2 : i32>)
              %72 = air.channel.get async [%async_token_45]  @cascade_up[%arg16, %arg17] (%results_46[] [] []) {id = 105 : i32} : (memref<64x1xbf16, 2 : i32>)
              %73 = air.channel.get async [%async_token_47]  @cascade_sp[%arg16, %arg17] (%results_48[] [] []) {id = 106 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_49, %results_50 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              %async_token_51 = air.execute [%async_token_27, %async_token_49, %68] {
                func.call @vector_copy_32elems(%c0_i32, %results_28, %results_50) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              }
              %async_token_52 = air.execute [%72, %async_token_51] {
              ...
              %75 = air.channel.put async [%async_token_61]  @cascade_gp[%arg16, %74] (%results_44[] [] []) {id = 107 : i32} : (memref<64x64xbf16, 2 : i32>)
              %76 = air.channel.put async [%async_token_27, %async_token_58]  @cascade_up[%arg16, %74] (%results_28[] [] []) {id = 108 : i32} : (memref<64x1xbf16, 2 : i32>)
              %77 = air.channel.put async [%async_token_67]  @cascade_sp[%arg16, %74] (%results_48[] [] []) {id = 109 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %71 = air.channel.get async [%async_token_43]  @cascade_gp[%arg16, %arg17] (%results_44[] [] []) {id = 110 : i32} : (memref<64x64xbf16, 2 : i32>)
              %72 = air.channel.get async [%async_token_45]  @cascade_up[%arg16, %arg17] (%results_46[] [] []) {id = 111 : i32} : (memref<64x1xbf16, 2 : i32>)
              %73 = air.channel.get async [%async_token_47]  @cascade_sp[%arg16, %arg17] (%results_48[] [] []) {id = 112 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_49, %results_50 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              ...
              %74 = air.channel.put async [%async_token_68]  @Gp2L2[%arg16, %c0_21] (%results_44[%c0_21, %c0_21, %c0_21] [%c64_19, %c8_23, %c8_23] [%c8_23, %c512_24, %c1_22]) {id = 113 : i32} : (memref<64x64xbf16, 2 : i32>)
          ...
          %async_token_40 = air.execute [%69, %68, %async_token_35] {
            memref.dealloc %results_30 : memref<64x64xbf16, 2 : i32>
          }
          %async_token_41 = air.execute [%69, %68, %async_token_37] {
            memref.dealloc %results_28 : memref<64x1xbf16, 2 : i32>
          }
          %async_token_42 = air.execute [%69, %68, %async_token_36] {
            memref.dealloc %results_26 : memref<64x1xbf16, 2 : i32>
          }
        }
        %async_token_15 = air.execute [%59] {
          memref.dealloc %results_14 : memref<64x64xbf16, 1 : i32>
        }
        %async_token_16 = air.execute [%58] {
          memref.dealloc %results_12 : memref<64x64xbf16, 1 : i32>
        }
        %async_token_17 = air.execute [%57] {
          memref.dealloc %results_10 : memref<64x64xbf16, 1 : i32>
        }
        %async_token_18 = air.execute [%56] {
          memref.dealloc %results : memref<64x64xbf16, 1 : i32>
        }
        air.wait_all [%48, %49, %50, %51, %60, %async_token_15, %async_token_16, %async_token_17, %async_token_18]  {air.segment_end}
      }
    }
    return
  }
