...
module {
  aie.device(npu2) @s {
    ...
    %buf77 = aie.buffer(%mem_tile_0_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf77"} : memref<64x64xbf16, 1 : i32> 
    %buf76 = aie.buffer(%mem_tile_1_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf76"} : memref<64x64xbf16, 1 : i32> 
    %buf75 = aie.buffer(%mem_tile_2_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf75"} : memref<64x64xbf16, 1 : i32> 
    %buf74 = aie.buffer(%mem_tile_3_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf74"} : memref<64x64xbf16, 1 : i32> 
    %buf73 = aie.buffer(%mem_tile_4_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf73"} : memref<64x64xbf16, 1 : i32> 
    %buf72 = aie.buffer(%mem_tile_5_1) {address = 8192 : i32, mem_bank = 0 : i32, sym_name = "buf72"} : memref<64x64xbf16, 1 : i32> 
    %buf71 = aie.buffer(%tile_3_3) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf71"} : memref<64x1xbf16, 2 : i32> 
    %buf70 = aie.buffer(%tile_3_3) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf70"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf62 = aie.buffer(%tile_2_3) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf62"} : memref<64x1xbf16, 2 : i32> 
    %buf61 = aie.buffer(%tile_2_3) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf61"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf53 = aie.buffer(%tile_1_3) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf53"} : memref<64x1xbf16, 2 : i32> 
    %buf52 = aie.buffer(%tile_1_3) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf52"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf44 = aie.buffer(%tile_0_3) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf44"} : memref<64x1xbf16, 2 : i32> 
    %buf43 = aie.buffer(%tile_0_3) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf43"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf35 = aie.buffer(%tile_3_2) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf35"} : memref<64x1xbf16, 2 : i32> 
    %buf34 = aie.buffer(%tile_3_2) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf34"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf26 = aie.buffer(%tile_2_2) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf26"} : memref<64x1xbf16, 2 : i32> 
    %buf25 = aie.buffer(%tile_2_2) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf25"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf17 = aie.buffer(%tile_1_2) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf17"} : memref<64x1xbf16, 2 : i32> 
    %buf16 = aie.buffer(%tile_1_2) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf16"} : memref<64x1xbf16, 2 : i32> 
    ...
    %buf8 = aie.buffer(%tile_0_2) {address = 41088 : i32, mem_bank = 2 : i32, sym_name = "buf8"} : memref<64x1xbf16, 2 : i32> 
    %buf7 = aie.buffer(%tile_0_2) {address = 57472 : i32, mem_bank = 3 : i32, sym_name = "buf7"} : memref<64x1xbf16, 2 : i32> 
