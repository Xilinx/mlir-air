...
module {
  aie.device(npu2) @s {
    ...
    %lock_0_2_3 = aie.lock(%tile_0_2, 6) {init = 0 : i32}
    %lock_0_2_4 = aie.lock(%tile_0_2, 5) {init = 1 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c2 step %c1 {
        %collapse_shape_17 = memref.collapse_shape %buf11 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_17) : (memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3_14, AcquireGreaterEqual, 1)
        aie.use_lock(%lock_0_3_10, AcquireGreaterEqual, 1)
        func.call @matmul_a_b_bf16(%buf13, %buf14, %collapse_shape_17) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3_13, Release, 1)
        func.call @fused_softmax(%collapse_shape_17, %buf16, %buf10, %buf9) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf9, %buf15) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_17, %buf12, %buf15) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_15 = memref.collapse_shape %buf16 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_15[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      %collapse_shape_16 = memref.collapse_shape %buf17 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_16[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      cf.br ^bb1
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      %collapse_shape_15 = memref.collapse_shape %buf7 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_15[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_16 = memref.collapse_shape %buf8 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_16[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      scf.for %arg0 = %c0 to %c2 step %c1 {
        %collapse_shape_17 = memref.collapse_shape %buf2 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_17) : (memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_2_7, AcquireGreaterEqual, 1)
        aie.use_lock(%lock_0_2_3, AcquireGreaterEqual, 1)
        func.call @matmul_a_b_bf16(%buf4, %buf5, %collapse_shape_17) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_2_6, Release, 1)
        func.call @fused_softmax(%collapse_shape_17, %buf7, %buf1, %buf0) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf0, %buf6) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_17, %buf3, %buf6) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
    ...
    aie.flow(%shim_noc_tile_1_0, DMA : 1, %mem_tile_1_1, DMA : 0)
    ...
    aie.shim_dma_allocation @air_Q2L1(%shim_noc_tile_0_0, MM2S, 0)
    aie.shim_dma_allocation @air_VIn_0(%shim_noc_tile_1_0, MM2S, 1)
    ...
    aie.runtime_sequence @s_sequence(%arg0: memref<64x64xbf16>, %arg1: memref<256x64xbf16>, %arg2: memref<256x64xbf16>, %arg3: memref<64x64xbf16>) {
      // === Q: once, vertical broadcast to tile(0,2)+tile(0,3) ===
      %q = aiex.dma_configure_task_for @air_Q2L1 {
      ...
      aiex.dma_start_task(%q)
      aiex.dma_await_task(%q)
      aiex.dma_free_task(%q)
      // === K: per-stage, per-chunk, all on same shim 0 MM2S:0 ===
      // K chunk 0 stage 0 (offset=0, pkt=1 → tile(0,2))
      %k_c0s0 = aiex.dma_configure_task_for @air_Q2L1 {
      ...
      aiex.dma_start_task(%k_c0s0)
      // K chunk 0 stage 1 (offset=8192, pkt=2 → tile(0,3))
      %k_c0s1 = aiex.dma_configure_task_for @air_Q2L1 {
      ...
      aiex.dma_start_task(%k_c0s1)
      // K chunk 1 stage 0 (offset=4096, pkt=1 → tile(0,2))
      %k_c1s0 = aiex.dma_configure_task_for @air_Q2L1 {
      ...
      aiex.dma_start_task(%k_c1s0)
      // K chunk 1 stage 1 (offset=12288, pkt=2 → tile(0,3))
      %k_c1s1 = aiex.dma_configure_task_for @air_Q2L1 {
      ...
      // === Output ===
      %out = aiex.dma_configure_task_for @air_GpOut {
      ...
      aiex.dma_free_task(%k_c0s0)
      aiex.dma_free_task(%k_c0s1)
      aiex.dma_free_task(%k_c1s0)
      aiex.dma_free_task(%k_c1s1)
