...
module {
  aie.device(npu2) @s {
    ...
    %buf23 = aie.buffer(%mem_tile_0_1) {sym_name = "buf23"} : memref<64x64xbf16, 1 : i32> 
    %buf22 = aie.buffer(%mem_tile_1_1) {sym_name = "buf22"} : memref<64x64xbf16, 1 : i32> 
    %buf21 = aie.buffer(%mem_tile_2_1) {sym_name = "buf21"} : memref<64x64xbf16, 1 : i32> 
    %buf20 = aie.buffer(%tile_0_3) {sym_name = "buf20"} : memref<64x1xbf16, 2 : i32> 
    %buf19 = aie.buffer(%tile_0_3) {sym_name = "buf19"} : memref<64x1xbf16, 2 : i32> 
    %buf18 = aie.buffer(%tile_0_3) {sym_name = "buf18"} : memref<64x64xbf16, 2 : i32> 
    %buf17 = aie.buffer(%tile_0_3) {sym_name = "buf17"} : memref<64x64xbf16, 2 : i32> 
    %buf16 = aie.buffer(%tile_0_3) {sym_name = "buf16"} : memref<64x64xbf16, 2 : i32> 
    ...
    %buf13 = aie.buffer(%tile_0_3) {sym_name = "buf13"} : memref<64x1xbf16, 2 : i32> 
    %buf12 = aie.buffer(%tile_0_3) {sym_name = "buf12"} : memref<64x1xbf16, 2 : i32> 
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf17 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf15 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      func.call @zero_fill_gp_bf16(%buf18) : (memref<64x64xbf16, 2 : i32>) -> ()
      func.call @zero_fill_sp_bf16(%buf20) : (memref<64x1xbf16, 2 : i32>) -> ()
      func.call @neg_inf_fill_up_bf16(%buf19) : (memref<64x1xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_3_10, AcquireGreaterEqual, 1)
      func.call @copy_tile(%buf17, %buf16) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_3_9, Release, 1)
      scf.for %arg0 = %c0 to %c2 step %c1 {
        %collapse_shape_13 = memref.collapse_shape %buf14 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_13) : (memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3_10, AcquireGreaterEqual, 1)
        aie.use_lock(%lock_0_3_8, AcquireGreaterEqual, 1)
        func.call @matmul_a_b_bf16(%buf16, %buf17, %collapse_shape_13) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3_9, Release, 1)
        func.call @fused_softmax(%collapse_shape_13, %buf19, %buf13, %buf12) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf12, %buf18) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_13, %buf15, %buf18) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @accum_sp_r_s(%buf20, %buf12, %buf13) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @vector_copy_32elems(%c0_i32, %buf13, %buf20) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3, Release, 1)
      } {loop_annotation = #loop_annotation}
      %collapse_shape = memref.collapse_shape %buf18 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      ...
      %collapse_shape_11 = memref.collapse_shape %buf19 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      ...
      %collapse_shape_12 = memref.collapse_shape %buf20 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c2 step %c1 {
        %collapse_shape_13 = memref.collapse_shape %buf5 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_13) : (memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_2_5, AcquireGreaterEqual, 1)
        aie.use_lock(%lock_0_2_3, AcquireGreaterEqual, 1)
        func.call @matmul_a_b_bf16(%buf7, %buf8, %collapse_shape_13) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_2_4, Release, 1)
        func.call @fused_softmax(%collapse_shape_13, %buf10, %buf4, %buf3) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf3, %buf9) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_13, %buf6, %buf9) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_11 = memref.collapse_shape %buf1 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_11[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_12 = memref.collapse_shape %buf0 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_12[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf23 : memref<64x64xbf16, 1 : i32>, 0, 4096) {task_id = 0 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf22 : memref<64x64xbf16, 1 : i32>, 0, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf22 : memref<64x64xbf16, 1 : i32>, 0, 4096) {task_id = 0 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf21 : memref<64x64xbf16, 1 : i32>, 0, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf21 : memref<64x64xbf16, 1 : i32>, 0, 4096) {task_id = 0 : i32}
