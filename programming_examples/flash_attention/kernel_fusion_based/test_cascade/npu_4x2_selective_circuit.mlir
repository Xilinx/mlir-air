  ...
  aie.device(npu2) @s {
    ...
    aie.runtime_sequence @s_sequence(%arg0: memref<256x64xbf16>, %arg1: memref<256x64xbf16>, %arg2: memref<256x64xbf16>, %arg3: memref<256x64xbf16>) {
      ...
      %4 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg1 : memref<256x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg1 : memref<256x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 7 : i32}
      ...
      %10 = aiex.dma_configure_task_for @air_QK2L1_1 {
        aie.dma_bd(%arg1 : memref<256x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @air_QK2L1_1 {
        aie.dma_bd(%arg1 : memref<256x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 7 : i32}
