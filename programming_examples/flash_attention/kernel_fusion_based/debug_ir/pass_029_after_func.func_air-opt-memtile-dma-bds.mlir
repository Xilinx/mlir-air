    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x128xbf16>, memref<2x512x128xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> attributes {id = 1 : i32} {
      ...
      %61 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %78 = scf.for %arg16 = %c0_5 to %c2_4 step %c1_3 iter_args(%arg17 = %62) -> (!air.async.token) {
          ...
          %92 = arith.cmpi eq, %arg12, %c0_5 : index
          %93 = scf.if %92 -> (!air.async.token) {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_0_0[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 90 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          } else {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_0_1[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 91 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          }
        ...
        %79 = scf.for %arg16 = %c0_5 to %c2_4 step %c1_3 iter_args(%arg17 = %63) -> (!air.async.token) {
          ...
          %92 = arith.cmpi eq, %arg12, %c0_5 : index
          %93 = scf.if %92 -> (!air.async.token) {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_1_0[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 93 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          } else {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_1_1[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 94 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          }
          %async_token_30 = air.execute [%93, %91] {
            memref.dealloc %results_29 : memref<64x64xbf16, 1 : i32>
        ...
        %80 = scf.for %arg16 = %c0_5 to %c2_4 step %c1_3 iter_args(%arg17 = %64) -> (!air.async.token) {
          ...
          %92 = arith.cmpi eq, %arg12, %c0_5 : index
          %93 = scf.if %92 -> (!air.async.token) {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_2_0[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 96 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          } else {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_2_1[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 97 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          }
          %async_token_30 = air.execute [%93, %91] {
            memref.dealloc %results_29 : memref<64x64xbf16, 1 : i32>
        ...
        %81 = scf.for %arg16 = %c0_5 to %c2_4 step %c1_3 iter_args(%arg17 = %65) -> (!air.async.token) {
          ...
          %92 = arith.cmpi eq, %arg12, %c0_5 : index
          %93 = scf.if %92 -> (!air.async.token) {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_3_0[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 99 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          } else {
            %94 = air.channel.put async [%async_token_28, %91]  @V2L1_3_1[%c0_5, %c0_5, %c0_5] (%results_29[%c0_5, %c0_5, %c0_5] [%c8, %c64_2, %c8] [%c8, %c64_2, %c1_3]) {id = 100 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %94 : !air.async.token
          }
          %async_token_30 = air.execute [%93, %91] {
            memref.dealloc %results_29 : memref<64x64xbf16, 1 : i32>
        ...
        %82 = air.channel.get async [%async_token_12]  @Gp2L2[%c0_5, %c0_5] (%results_13[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %83 = air.channel.get async [%async_token_14]  @Gp2L2[%c1_3, %c0_5] (%results_15[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %84 = air.channel.get async [%async_token_16]  @Gp2L2[%c2_4, %c0_5] (%results_17[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %85 = air.channel.get async [%async_token_18]  @Gp2L2[%c3_1, %c0_5] (%results_19[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %86 = air.channel.put async [%82]  @channel_0[%c0_5, %arg12] (%results_13[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %87 = air.channel.put async [%83]  @channel_0[%c1_3, %arg12] (%results_15[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %88 = air.channel.put async [%84]  @channel_0[%c2_4, %arg12] (%results_17[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %89 = air.channel.put async [%85]  @channel_0[%c3_1, %arg12] (%results_19[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %90 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4, %arg19=%c4) args(%arg20=%arg12) : index attributes {id = 3 : i32, link_with = "attn.o"} {
