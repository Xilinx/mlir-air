    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x128xbf16>, memref<2x512x128xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> attributes {id = 1 : i32} {
      ...
      %55 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %58 = scf.for %arg16 = %c0_4 to %c2_3 step %c1_2 iter_args(%arg17 = %57) -> (!air.async.token) {
          ...
          %78 = air.channel.get async [%77]  @QKIn_0[%arg12] (%results[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %61 = scf.for %arg16 = %c0_4 to %c2_3 step %c1_2 iter_args(%arg17 = %60) -> (!air.async.token) {
          ...
          %78 = air.channel.get async [%77]  @QKIn_1[%arg12] (%results_6[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 1 : i32>)
          %79 = scf.if %76 -> (!air.async.token) {
        ...
        %64 = scf.for %arg16 = %c0_4 to %c2_3 step %c1_2 iter_args(%arg17 = %63) -> (!air.async.token) {
          ...
          %78 = air.channel.get async [%77]  @QKIn_2[%arg12] (%results_8[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 1 : i32>)
          %79 = scf.if %76 -> (!air.async.token) {
        ...
        %67 = scf.for %arg16 = %c0_4 to %c2_3 step %c1_2 iter_args(%arg17 = %66) -> (!air.async.token) {
          ...
          %78 = air.channel.get async [%77]  @QKIn_3[%arg12] (%results_10[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 1 : i32>)
          %79 = scf.if %76 -> (!air.async.token) {
