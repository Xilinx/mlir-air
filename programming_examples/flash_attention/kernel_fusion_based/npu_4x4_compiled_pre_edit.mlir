...
module {
  aie.device(npu2) @attn_seg {
    ...
    %lock_0_2_8 = aie.lock(%tile_0_2, 6) {init = 0 : i32}
    %lock_0_2_9 = aie.lock(%tile_0_2, 5) {init = 1 : i32}
    %lock_0_2_10 = aie.lock(%tile_0_2, 4) {init = 0 : i32}
    %lock_0_2_11 = aie.lock(%tile_0_2, 3) {init = 1 : i32}
    %lock_0_2_12 = aie.lock(%tile_0_2, 2) {init = 0 : i32}
    %lock_0_2_13 = aie.lock(%tile_0_2, 1) {init = 1 : i32}
    %lock_0_2_14 = aie.lock(%tile_0_2, 0) {init = 0 : i32}
    %lock_1_2 = aie.lock(%tile_1_2, 7) {init = 1 : i32}
    %lock_1_2_15 = aie.lock(%tile_1_2, 6) {init = 0 : i32}
    %lock_1_2_16 = aie.lock(%tile_1_2, 5) {init = 1 : i32}
    ...
    %lock_2_2_22 = aie.lock(%tile_2_2, 6) {init = 0 : i32}
    %lock_2_2_23 = aie.lock(%tile_2_2, 5) {init = 1 : i32}
    %lock_2_2_24 = aie.lock(%tile_2_2, 4) {init = 0 : i32}
    %lock_2_2_25 = aie.lock(%tile_2_2, 3) {init = 1 : i32}
    %lock_2_2_26 = aie.lock(%tile_2_2, 2) {init = 0 : i32}
    %lock_2_2_27 = aie.lock(%tile_2_2, 1) {init = 1 : i32}
    %lock_2_2_28 = aie.lock(%tile_2_2, 0) {init = 0 : i32}
    %lock_3_2 = aie.lock(%tile_3_2, 7) {init = 1 : i32}
    %lock_3_2_29 = aie.lock(%tile_3_2, 6) {init = 0 : i32}
    %lock_3_2_30 = aie.lock(%tile_3_2, 5) {init = 1 : i32}
    ...
    %lock_0_3_36 = aie.lock(%tile_0_3, 4) {init = 0 : i32}
    %lock_0_3_37 = aie.lock(%tile_0_3, 3) {init = 1 : i32}
    %lock_0_3_38 = aie.lock(%tile_0_3, 2) {init = 0 : i32}
    %lock_0_3_39 = aie.lock(%tile_0_3, 1) {init = 1 : i32}
    %lock_0_3_40 = aie.lock(%tile_0_3, 0) {init = 0 : i32}
    %lock_1_3 = aie.lock(%tile_1_3, 5) {init = 1 : i32}
    %lock_1_3_41 = aie.lock(%tile_1_3, 4) {init = 0 : i32}
    %lock_1_3_42 = aie.lock(%tile_1_3, 3) {init = 1 : i32}
    ...
    %lock_0_4_56 = aie.lock(%tile_0_4, 4) {init = 0 : i32}
    %lock_0_4_57 = aie.lock(%tile_0_4, 3) {init = 1 : i32}
    %lock_0_4_58 = aie.lock(%tile_0_4, 2) {init = 0 : i32}
    %lock_0_4_59 = aie.lock(%tile_0_4, 1) {init = 1 : i32}
    %lock_0_4_60 = aie.lock(%tile_0_4, 0) {init = 0 : i32}
    %lock_1_4 = aie.lock(%tile_1_4, 5) {init = 1 : i32}
    %lock_1_4_61 = aie.lock(%tile_1_4, 4) {init = 0 : i32}
    %lock_1_4_62 = aie.lock(%tile_1_4, 3) {init = 1 : i32}
    %lock_1_4_63 = aie.lock(%tile_1_4, 2) {init = 0 : i32}
    %lock_1_4_64 = aie.lock(%tile_1_4, 1) {init = 1 : i32}
    %lock_1_4_65 = aie.lock(%tile_1_4, 0) {init = 0 : i32}
    %lock_2_4 = aie.lock(%tile_2_4, 5) {init = 1 : i32}
    %lock_2_4_66 = aie.lock(%tile_2_4, 4) {init = 0 : i32}
    %lock_2_4_67 = aie.lock(%tile_2_4, 3) {init = 1 : i32}
    %lock_2_4_68 = aie.lock(%tile_2_4, 2) {init = 0 : i32}
    %lock_2_4_69 = aie.lock(%tile_2_4, 1) {init = 1 : i32}
    %lock_2_4_70 = aie.lock(%tile_2_4, 0) {init = 0 : i32}
    %lock_3_4 = aie.lock(%tile_3_4, 5) {init = 1 : i32}
    %lock_3_4_71 = aie.lock(%tile_3_4, 4) {init = 0 : i32}
    %lock_3_4_72 = aie.lock(%tile_3_4, 3) {init = 1 : i32}
    %lock_3_4_73 = aie.lock(%tile_3_4, 2) {init = 0 : i32}
    %lock_3_4_74 = aie.lock(%tile_3_4, 1) {init = 1 : i32}
    %lock_3_4_75 = aie.lock(%tile_3_4, 0) {init = 0 : i32}
    %lock_0_5 = aie.lock(%tile_0_5, 5) {init = 1 : i32}
    %lock_0_5_76 = aie.lock(%tile_0_5, 4) {init = 0 : i32}
    %lock_0_5_77 = aie.lock(%tile_0_5, 3) {init = 1 : i32}
    %lock_0_5_78 = aie.lock(%tile_0_5, 2) {init = 0 : i32}
    %lock_0_5_79 = aie.lock(%tile_0_5, 1) {init = 1 : i32}
    %lock_0_5_80 = aie.lock(%tile_0_5, 0) {init = 0 : i32}
    %lock_1_5 = aie.lock(%tile_1_5, 5) {init = 1 : i32}
    %lock_1_5_81 = aie.lock(%tile_1_5, 4) {init = 0 : i32}
    %lock_1_5_82 = aie.lock(%tile_1_5, 3) {init = 1 : i32}
    %lock_1_5_83 = aie.lock(%tile_1_5, 2) {init = 0 : i32}
    %lock_1_5_84 = aie.lock(%tile_1_5, 1) {init = 1 : i32}
    %lock_1_5_85 = aie.lock(%tile_1_5, 0) {init = 0 : i32}
    %lock_2_5 = aie.lock(%tile_2_5, 5) {init = 1 : i32}
    %lock_2_5_86 = aie.lock(%tile_2_5, 4) {init = 0 : i32}
    %lock_2_5_87 = aie.lock(%tile_2_5, 3) {init = 1 : i32}
    %lock_2_5_88 = aie.lock(%tile_2_5, 2) {init = 0 : i32}
    %lock_2_5_89 = aie.lock(%tile_2_5, 1) {init = 1 : i32}
    %lock_2_5_90 = aie.lock(%tile_2_5, 0) {init = 0 : i32}
    %lock_3_5 = aie.lock(%tile_3_5, 5) {init = 1 : i32}
    %lock_3_5_91 = aie.lock(%tile_3_5, 4) {init = 0 : i32}
    %lock_3_5_92 = aie.lock(%tile_3_5, 3) {init = 1 : i32}
    %lock_3_5_93 = aie.lock(%tile_3_5, 2) {init = 0 : i32}
    %lock_3_5_94 = aie.lock(%tile_3_5, 1) {init = 1 : i32}
    %lock_3_5_95 = aie.lock(%tile_3_5, 0) {init = 0 : i32}
    ...
    %__air_external_buffer = aie.external_buffer {sym_name = "__air_external_buffer"} : memref<1x2048x64xbf16>
    %__air_external_buffer_1 = aie.external_buffer {sym_name = "__air_external_buffer_1"} : memref<1x2048x64xbf16>
    %__air_external_buffer_2 = aie.external_buffer {sym_name = "__air_external_buffer_2"} : memref<1x2048x64xbf16>
    %__air_external_buffer_3 = aie.external_buffer {sym_name = "__air_external_buffer_3"} : memref<1x2048x64xbf16>
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_3_5_91, Release, 1)
      aie.next_bd ^bb4
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_98 = memref.collapse_shape %buf215 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf210, %buf211, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_3_5_92, Release, 1)
        aie.use_lock(%lock_3_5_91, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf212, %buf208, %buf207) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf207, %buf214) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf209, %buf214) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf212 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      %collapse_shape_97 = memref.collapse_shape %buf213 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      cf.br ^bb1
    ...
    %mem_2_5 = aie.mem(%tile_2_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_2_5_89, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf202 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_2_5_90, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_2_5_86, Release, 1)
      aie.next_bd ^bb4
    }
    %core_2_5 = aie.core(%tile_2_5) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_2_5_90, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_2_5_89, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_2_5_88, AcquireGreaterEqual, 1)
        %collapse_shape_98 = memref.collapse_shape %buf206 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf201, %buf202, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_2_5_87, Release, 1)
        aie.use_lock(%lock_2_5_86, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf203, %buf199, %buf198) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf198, %buf205) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf200, %buf205) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf203 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      %collapse_shape_97 = memref.collapse_shape %buf204 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    %mem_1_5 = aie.mem(%tile_1_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_1_5_84, AcquireGreaterEqual, 1)
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_1_5_81, Release, 1)
      aie.next_bd ^bb4
    }
    %core_1_5 = aie.core(%tile_1_5) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_1_5_85, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_1_5_84, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_1_5_83, AcquireGreaterEqual, 1)
        %collapse_shape_98 = memref.collapse_shape %buf197 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf192, %buf193, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_1_5_82, Release, 1)
        aie.use_lock(%lock_1_5_81, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf194, %buf190, %buf189) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf189, %buf196) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf191, %buf196) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf194 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      %collapse_shape_97 = memref.collapse_shape %buf195 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    %mem_0_5 = aie.mem(%tile_0_5) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_0_5_79, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf184 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_0_5_80, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_0_5_76, Release, 1)
      aie.next_bd ^bb4
    }
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_0_5_80, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_0_5_79, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_0_5_78, AcquireGreaterEqual, 1)
        %collapse_shape_98 = memref.collapse_shape %buf188 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf183, %buf184, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_5_77, Release, 1)
        aie.use_lock(%lock_0_5_76, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf185, %buf181, %buf180) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf180, %buf187) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf182, %buf187) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf185 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      %collapse_shape_97 = memref.collapse_shape %buf186 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    %mem_3_4 = aie.mem(%tile_3_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_3_4_74, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf175 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_3_4_75, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_3_4_71, Release, 1)
      aie.next_bd ^bb4
    }
    %core_3_4 = aie.core(%tile_3_4) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_3_4_75, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_3_4_74, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_3_4_73, AcquireGreaterEqual, 1)
        %collapse_shape_99 = memref.collapse_shape %buf179 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf174, %buf175, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_3_4_72, Release, 1)
        aie.use_lock(%lock_3_4_71, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf176, %buf172, %buf171) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf171, %buf178) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf173, %buf178) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf169 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf168 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf176 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
      }
      scf.for %arg0 = %c0 to %c64 step %c32 {
    ...
    %mem_2_4 = aie.mem(%tile_2_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_2_4_69, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf160 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_2_4_70, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_2_4_66, Release, 1)
      aie.next_bd ^bb4
    }
    %core_2_4 = aie.core(%tile_2_4) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_2_4_70, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_2_4_69, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_2_4_68, AcquireGreaterEqual, 1)
        %collapse_shape_99 = memref.collapse_shape %buf164 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf159, %buf160, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_2_4_67, Release, 1)
        aie.use_lock(%lock_2_4_66, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf161, %buf157, %buf156) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf156, %buf163) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf158, %buf163) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf154 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf153 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf161 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.use_lock(%lock_1_4_65, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_1_4_61, Release, 1)
      aie.next_bd ^bb4
    }
    %core_1_4 = aie.core(%tile_1_4) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_1_4_65, AcquireGreaterEqual, 1)
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_99 = memref.collapse_shape %buf149 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf144, %buf145, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_1_4_62, Release, 1)
        aie.use_lock(%lock_1_4_61, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf146, %buf142, %buf141) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf141, %buf148) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf143, %buf148) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf139 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf138 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf146 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    %mem_0_4 = aie.mem(%tile_0_4) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_0_4_59, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf130 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_0_4_60, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.use_lock(%lock_0_4_56, Release, 1)
      aie.next_bd ^bb4
    }
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_0_4_60, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_0_4_59, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_0_4_58, AcquireGreaterEqual, 1)
        %collapse_shape_99 = memref.collapse_shape %buf134 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf129, %buf130, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_4_57, Release, 1)
        aie.use_lock(%lock_0_4_56, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf131, %buf127, %buf126) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf126, %buf133) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf128, %buf133) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf124 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf123 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf131 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    %mem_3_3 = aie.mem(%tile_3_3) {
      %0 = aie.dma_start(S2MM, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_3_3_54, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf115 : memref<64x64xbf16, 2 : i32>, 0, 4096) {task_id = 0 : i32}
      aie.use_lock(%lock_3_3_55, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    %core_3_3 = aie.core(%tile_3_3) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_3_3_55, AcquireGreaterEqual, 1)
      ...
      aie.use_lock(%lock_3_3_54, Release, 1)
      scf.for %arg0 = %c0 to %c8 step %c1 {
        aie.use_lock(%lock_3_3_53, AcquireGreaterEqual, 1)
        %collapse_shape_99 = memref.collapse_shape %buf119 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf114, %buf115, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_3_3_52, Release, 1)
        aie.use_lock(%lock_3_3_51, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf116, %buf112, %buf111) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf111, %buf118) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf113, %buf118) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf109 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf108 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf116 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.use_lock(%lock_2_3_50, Release, 1)
      aie.next_bd ^bb1
    ^bb2:  // pred: ^bb3
      aie.end
    ^bb3:  // pred: ^bb0
    ...
    %core_2_3 = aie.core(%tile_2_3) {
      ...
      cf.br ^bb1
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_2_3_50, AcquireGreaterEqual, 1)
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_99 = memref.collapse_shape %buf104 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf99, %buf100, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_2_3_47, Release, 1)
        aie.use_lock(%lock_2_3_46, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf101, %buf97, %buf96) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf96, %buf103) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf98, %buf103) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf94 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf93 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf101 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_99 = memref.collapse_shape %buf89 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf84, %buf85, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_1_3_42, Release, 1)
        aie.use_lock(%lock_1_3_41, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf86, %buf82, %buf81) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf81, %buf88) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf83, %buf88) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf79 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf78 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf86 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_99 = memref.collapse_shape %buf74 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_99) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf69, %buf70, %collapse_shape_99) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_3_37, Release, 1)
        aie.use_lock(%lock_0_3_36, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_99, %buf71, %buf67, %buf66) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf66, %buf73) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_99, %buf68, %buf73) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf64 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf63 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      ...
      %collapse_shape_98 = memref.collapse_shape %buf71 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_98[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = vector.transfer_read %subview[%c0], %cst {in_bounds = [true]} : memref<32xbf16, strided<[1], offset: ?>, 2 : i32>, vector<32xbf16>
        aie.put_cascade(%0 : vector<32xbf16>)
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_98 = memref.collapse_shape %buf59 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf54, %buf55, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_3_2_30, Release, 1)
        aie.use_lock(%lock_3_2_29, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf56, %buf52, %buf51) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf51, %buf58) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf53, %buf58) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf49 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf48 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_98 = memref.collapse_shape %buf44 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf39, %buf40, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_2_2_23, Release, 1)
        aie.use_lock(%lock_2_2_22, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf41, %buf37, %buf36) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf36, %buf43) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf38, %buf43) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf34 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf33 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_98 = memref.collapse_shape %buf29 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf24, %buf25, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_1_2_16, Release, 1)
        aie.use_lock(%lock_1_2_15, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf26, %buf22, %buf21) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf21, %buf28) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf23, %buf28) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf19 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf18 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c8 step %c1 {
        ...
        %collapse_shape_98 = memref.collapse_shape %buf14 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
        func.call @zero_fill_g_bf16(%collapse_shape_98) : (memref<4096xbf16, 2 : i32>) -> ()
        func.call @matmul_a_b_bf16(%buf9, %buf10, %collapse_shape_98) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
        aie.use_lock(%lock_0_2_9, Release, 1)
        aie.use_lock(%lock_0_2_8, AcquireGreaterEqual, 1)
        func.call @fused_softmax(%collapse_shape_98, %buf11, %buf7, %buf6) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
        func.call @mul_r_gp(%buf6, %buf13) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
        func.call @matmul_g_b_bf16(%collapse_shape_98, %buf8, %buf13) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      %collapse_shape_96 = memref.collapse_shape %buf4 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_96[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
      }
      %collapse_shape_97 = memref.collapse_shape %buf3 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      scf.for %arg0 = %c0 to %c64 step %c32 {
        %subview = memref.subview %collapse_shape_97[%arg0] [32] [1] : memref<64xbf16, 2 : i32> to memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
        %0 = aie.get_cascade() : vector<32xbf16>
        vector.transfer_write %0, %subview[%c0] {in_bounds = [true]} : vector<32xbf16>, memref<32xbf16, strided<[1], offset: ?>, 2 : i32>
    ...
    aie.packet_flow(5) {
      aie.packet_source<%shim_noc_tile_1_0, DMA : 1>
      aie.packet_dest<%tile_0_3, DMA : 0>
      aie.packet_dest<%tile_1_3, DMA : 0>
      aie.packet_dest<%tile_2_3, DMA : 0>
      aie.packet_dest<%tile_3_3, DMA : 0>
    ...
    aie.packet_flow(6) {
      aie.packet_source<%shim_noc_tile_2_0, DMA : 1>
      aie.packet_dest<%tile_0_4, DMA : 0>
      aie.packet_dest<%tile_1_4, DMA : 0>
      aie.packet_dest<%tile_2_4, DMA : 0>
      aie.packet_dest<%tile_3_4, DMA : 0>
    ...
    aie.packet_flow(7) {
      aie.packet_source<%shim_noc_tile_3_0, DMA : 1>
      aie.packet_dest<%tile_0_5, DMA : 0>
      aie.packet_dest<%tile_1_5, DMA : 0>
      aie.packet_dest<%tile_2_5, DMA : 0>
      aie.packet_dest<%tile_3_5, DMA : 0>
    ...
    aie.shim_dma_allocation @air_K2L1_0(%shim_noc_tile_0_0, MM2S, 1)
    aie.shim_dma_allocation @air_K2L1_1(%shim_noc_tile_1_0, MM2S, 1)
    aie.shim_dma_allocation @air_K2L1_2(%shim_noc_tile_2_0, MM2S, 1)
    aie.shim_dma_allocation @air_K2L1_3(%shim_noc_tile_3_0, MM2S, 1)
    ...
    aie.runtime_sequence @attn_seg_sequence(%arg0: memref<1x2048x64xbf16>, %arg1: memref<1x2048x64xbf16>, %arg2: memref<1x2048x64xbf16>, %arg3: memref<1x2048x64xbf16>) {
      %0 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 0, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 262144, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 524288, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 786432, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%12)
      %13 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%13)
      %14 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%14)
      %15 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%15)
      %16 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%18)
      %19 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%19)
      %20 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%20)
      %21 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%21)
      %22 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%22)
      %23 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%23)
      %24 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%24)
      %25 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%25)
      %26 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%26)
      %27 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%27)
      %28 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%28)
      %29 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%29)
      %30 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%30)
      %31 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%31)
      %32 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%32)
      %33 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%33)
      %34 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%34)
      %35 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%35)
      %36 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%36)
      %37 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%37)
      %38 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%38)
      %39 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%39)
      %40 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%40)
      %41 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 4096, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%41)
      %42 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 8192, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%42)
      %43 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 12288, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %44 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 16384, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%44)
      %45 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 278528, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%45)
      %46 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 540672, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%46)
      %47 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 802816, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%47)
      %48 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%48)
      %49 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%49)
      %50 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%50)
      %51 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%51)
      %52 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%52)
      %53 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%53)
      %54 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%54)
      %55 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%55)
      %56 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%56)
      %57 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%57)
      %58 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%58)
      %59 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%59)
      %60 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%60)
      %61 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%61)
      %62 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%62)
      %63 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%63)
      %64 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%64)
      %65 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%65)
      %66 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%66)
      %67 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%67)
      %68 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%68)
      %69 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%69)
      %70 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%70)
      %71 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%71)
      %72 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%72)
      %73 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%73)
      %74 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%74)
      %75 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%75)
      %76 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%76)
      %77 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%77)
      %78 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%78)
      %79 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%79)
      %80 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%80)
      %81 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%81)
      %82 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%82)
      %83 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%83)
      %84 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 16384, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%84)
      %85 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 20480, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%85)
      %86 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 24576, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%86)
      %87 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 28672, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %88 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 32768, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%88)
      %89 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 294912, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%89)
      %90 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 557056, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%90)
      %91 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 819200, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%91)
      %92 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%92)
      %93 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%93)
      %94 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%94)
      %95 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%95)
      %96 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%96)
      %97 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%97)
      %98 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%98)
      %99 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%99)
      %100 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%100)
      %101 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%101)
      %102 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%102)
      %103 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%103)
      %104 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%104)
      %105 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%105)
      %106 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%106)
      %107 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%107)
      %108 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%108)
      %109 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%109)
      %110 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%110)
      %111 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%111)
      %112 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%112)
      %113 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%113)
      %114 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%114)
      %115 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%115)
      %116 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%116)
      %117 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%117)
      %118 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%118)
      %119 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%119)
      %120 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%120)
      %121 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%121)
      %122 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%122)
      %123 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%123)
      %124 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%124)
      %125 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%125)
      %126 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%126)
      %127 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%127)
      %128 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 32768, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%128)
      %129 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 36864, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%129)
      %130 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 40960, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%130)
      %131 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 45056, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %132 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 49152, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%132)
      %133 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 311296, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%133)
      %134 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 573440, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%134)
      %135 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 835584, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%135)
      %136 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%136)
      %137 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%137)
      %138 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%138)
      %139 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%139)
      %140 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%140)
      %141 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%141)
      %142 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%142)
      %143 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%143)
      %144 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%144)
      %145 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%145)
      %146 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%146)
      %147 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%147)
      %148 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%148)
      %149 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%149)
      %150 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%150)
      %151 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%151)
      %152 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%152)
      %153 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%153)
      %154 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%154)
      %155 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%155)
      %156 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%156)
      %157 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%157)
      %158 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%158)
      %159 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%159)
      %160 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%160)
      %161 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%161)
      %162 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%162)
      %163 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%163)
      %164 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%164)
      %165 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%165)
      %166 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%166)
      %167 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%167)
      %168 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%168)
      %169 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%169)
      %170 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%170)
      %171 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%171)
      %172 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 49152, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%172)
      %173 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 53248, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%173)
      %174 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 57344, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%174)
      %175 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 61440, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %176 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 65536, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%176)
      %177 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 327680, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%177)
      %178 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 589824, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%178)
      %179 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 851968, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%179)
      %180 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%180)
      %181 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%181)
      %182 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%182)
      %183 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%183)
      %184 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%184)
      %185 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%185)
      %186 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%186)
      %187 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%187)
      %188 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%188)
      %189 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%189)
      %190 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%190)
      %191 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%191)
      %192 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%192)
      %193 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%193)
      %194 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%194)
      %195 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%195)
      %196 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%196)
      %197 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%197)
      %198 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%198)
      %199 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%199)
      %200 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%200)
      %201 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%201)
      %202 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%202)
      %203 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%203)
      %204 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%204)
      %205 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%205)
      %206 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%206)
      %207 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%207)
      %208 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%208)
      %209 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%209)
      %210 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%210)
      %211 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%211)
      %212 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%212)
      %213 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%213)
      %214 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%214)
      %215 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%215)
      %216 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 65536, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%216)
      %217 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 69632, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%217)
      %218 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 73728, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%218)
      %219 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 77824, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %220 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 81920, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%220)
      %221 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 344064, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%221)
      %222 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 606208, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%222)
      %223 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 868352, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%223)
      %224 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%224)
      %225 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%225)
      %226 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%226)
      %227 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%227)
      %228 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%228)
      %229 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%229)
      %230 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%230)
      %231 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%231)
      %232 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%232)
      %233 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%233)
      %234 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%234)
      %235 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%235)
      %236 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%236)
      %237 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%237)
      %238 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%238)
      %239 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%239)
      %240 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%240)
      %241 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%241)
      %242 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%242)
      %243 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%243)
      %244 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%244)
      %245 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%245)
      %246 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%246)
      %247 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%247)
      %248 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%248)
      %249 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%249)
      %250 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%250)
      %251 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%251)
      %252 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%252)
      %253 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%253)
      %254 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%254)
      %255 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%255)
      %256 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%256)
      %257 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%257)
      %258 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%258)
      %259 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%259)
      %260 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 81920, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%260)
      %261 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 86016, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%261)
      %262 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 90112, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%262)
      %263 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 94208, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      aiex.dma_await_task(%260)
      aiex.dma_free_task(%258)
      aiex.dma_free_task(%256)
      aiex.dma_free_task(%222)
      aiex.dma_free_task(%220)
      %264 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 98304, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%264)
      %265 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 360448, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%265)
      %266 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 622592, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%266)
      %267 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 884736, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%267)
      %268 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%268)
      %269 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%269)
      %270 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%270)
      %271 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%271)
      %272 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%272)
      %273 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%273)
      %274 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%274)
      %275 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%275)
      %276 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%276)
      %277 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%277)
      %278 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%278)
      %279 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%279)
      %280 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%280)
      %281 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%281)
      %282 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%282)
      %283 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%283)
      %284 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%284)
      %285 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%285)
      %286 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%286)
      %287 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%287)
      %288 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%288)
      %289 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%289)
      %290 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%290)
      %291 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%291)
      %292 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%292)
      %293 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%293)
      %294 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%294)
      %295 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%295)
      %296 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%296)
      %297 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%297)
      %298 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%298)
      %299 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%299)
      %300 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%300)
      %301 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%301)
      %302 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%302)
      %303 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%303)
      %304 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 98304, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%304)
      %305 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 102400, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%305)
      %306 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 106496, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%306)
      %307 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 110592, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      aiex.dma_await_task(%306)
      aiex.dma_await_task(%304)
      aiex.dma_free_task(%302)
      aiex.dma_free_task(%300)
      aiex.dma_free_task(%266)
      aiex.dma_free_task(%264)
      %308 = aiex.dma_configure_task_for @air_Q2L1_0 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 114688, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      aiex.dma_start_task(%308)
      %309 = aiex.dma_configure_task_for @air_Q2L1_1 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 376832, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 1>}
        aie.end
      }
      aiex.dma_start_task(%309)
      %310 = aiex.dma_configure_task_for @air_Q2L1_2 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 638976, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 2>}
        aie.end
      }
      aiex.dma_start_task(%310)
      %311 = aiex.dma_configure_task_for @air_Q2L1_3 {
        aie.dma_bd(%arg0 : memref<1x2048x64xbf16>, 901120, 4096, [<size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>}
        aie.end
      }
      aiex.dma_start_task(%311)
      %312 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 0, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%312)
      %313 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 4096, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%313)
      %314 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 8192, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%314)
      %315 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 12288, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%315)
      %316 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 16384, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%316)
      %317 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 20480, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%317)
      %318 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 24576, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%318)
      %319 = aiex.dma_configure_task_for @air_K2L1_0 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 28672, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 4>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%319)
      %320 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 32768, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%320)
      %321 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 36864, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%321)
      %322 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 40960, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%322)
      %323 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 45056, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%323)
      %324 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 49152, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%324)
      %325 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 53248, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%325)
      %326 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 57344, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%326)
      %327 = aiex.dma_configure_task_for @air_K2L1_1 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 61440, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%327)
      %328 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 65536, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%328)
      %329 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 69632, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%329)
      %330 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 73728, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%330)
      %331 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 77824, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%331)
      %332 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 81920, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%332)
      %333 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 86016, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%333)
      %334 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 90112, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%334)
      %335 = aiex.dma_configure_task_for @air_K2L1_2 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 94208, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 6>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%335)
      %336 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 98304, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%336)
      %337 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 102400, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%337)
      %338 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 106496, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%338)
      %339 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 110592, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%339)
      %340 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 114688, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%340)
      %341 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 118784, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%341)
      %342 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 122880, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%342)
      %343 = aiex.dma_configure_task_for @air_K2L1_3 {
        aie.dma_bd(%arg1 : memref<1x2048x64xbf16>, 126976, 512, [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
        aie.end
      } {repeat_count = 7 : i32}
      aiex.dma_start_task(%343)
      %344 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%344)
      %345 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%345)
      %346 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%346)
      %347 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<1x2048x64xbf16>, 0, 32768, [<size = 64, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%347)
      %348 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 114688, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%348)
      %349 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 118784, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%349)
      %350 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 122880, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%350)
      %351 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<1x2048x64xbf16>, 126976, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
  ...
  aie.device(npu2) {
    aie.runtime_sequence @attention_bf16(%arg0: memref<1x2048x64xbf16>, %arg1: memref<1x2048x64xbf16>, %arg2: memref<1x2048x64xbf16>, %arg3: memref<1x2048x64xbf16>) {
      aiex.configure @attn_seg {
        aiex.run @attn_seg_sequence(%arg0, %arg1, %arg2, %arg3) : (memref<1x2048x64xbf16>, memref<1x2048x64xbf16>, memref<1x2048x64xbf16>, memref<1x2048x64xbf16>)
      }
    }
  }
}
