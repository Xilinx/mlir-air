...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x512x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x512x64xbf16>) {
    ...
    air.launch (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16> {
      ...
      air.channel.put  @QK2L1[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c0, %c1_1, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c0, %c2_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c0, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %6 = affine.apply #map3()[%3, %c0]
      air.channel.put  @QK2L1[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %6] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %7 = affine.apply #map3()[%3, %c8192]
      air.channel.put  @QK2L1[%c0, %c1_1, %c0] (%arg9[%c0, %c0, %c0, %c0, %7] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %8 = affine.apply #map3()[%3, %c16384]
      air.channel.put  @QK2L1[%c0, %c2_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %8] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %9 = affine.apply #map3()[%3, %c24576]
      air.channel.put  @QK2L1[%c0, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %9] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %10 = affine.apply #map3()[%4, %c0]
      air.channel.put  @VIn_0[%c0] (%arg10[%c0, %c0, %10] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %11 = affine.apply #map3()[%4, %c8192]
      air.channel.put  @VIn_1[%c0] (%arg10[%c0, %c0, %11] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %12 = affine.apply #map3()[%4, %c16384]
      air.channel.put  @VIn_2[%c0] (%arg10[%c0, %c0, %12] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %13 = affine.apply #map3()[%4, %c24576]
      air.channel.put  @VIn_3[%c0] (%arg10[%c0, %c0, %13] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.get  @GpOut[%c0] (%arg11[%5] [%c16384] [%c1_1]) : (memref<2x512x64xbf16>)
      %14 = affine.apply #map4()[%1]
      %15 = affine.apply #map2()[%14]
      %16 = affine.apply #map2()[%14]
      %17 = affine.apply #map2()[%14]
      %18 = affine.apply #map3()[%15, %0]
      air.channel.put  @QK2L1[%c1_1, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c1_1, %c1_1, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c1_1, %c2_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.put  @QK2L1[%c1_1, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %19 = affine.apply #map3()[%16, %c0]
      air.channel.put  @QK2L1[%c1_1, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %19] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %20 = affine.apply #map3()[%16, %c8192]
      air.channel.put  @QK2L1[%c1_1, %c1_1, %c0] (%arg9[%c0, %c0, %c0, %c0, %20] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %21 = affine.apply #map3()[%16, %c16384]
      air.channel.put  @QK2L1[%c1_1, %c2_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %21] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %22 = affine.apply #map3()[%16, %c24576]
      air.channel.put  @QK2L1[%c1_1, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %22] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %23 = affine.apply #map3()[%17, %c0]
      air.channel.put  @VIn_0[%c1_1] (%arg10[%c0, %c0, %23] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %24 = affine.apply #map3()[%17, %c8192]
      air.channel.put  @VIn_1[%c1_1] (%arg10[%c0, %c0, %24] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %25 = affine.apply #map3()[%17, %c16384]
      air.channel.put  @VIn_2[%c1_1] (%arg10[%c0, %c0, %25] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      %26 = affine.apply #map3()[%17, %c24576]
      air.channel.put  @VIn_3[%c1_1] (%arg10[%c0, %c0, %26] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) : (memref<2x512x64xbf16>)
      air.channel.get  @GpOut[%c1_1] (%arg11[%18] [%c16384] [%c1_1]) : (memref<2x512x64xbf16>)
      air.segment @attn_seg  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) {
        ...
        scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 {
          ...
          air.channel.put  @V2L1_0[%arg12, %c0_7, %c0_7] (%alloc[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) : (memref<64x64xbf16, 1 : i32>)
        }
        scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 {
          air.channel.get  @VIn_1[%arg12] (%alloc_9[] [] []) : (memref<64x64xbf16, 1 : i32>)
          air.channel.put  @V2L1_1[%arg12, %c0_7, %c0_7] (%alloc_9[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) : (memref<64x64xbf16, 1 : i32>)
        }
        scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 {
          air.channel.get  @VIn_2[%arg12] (%alloc_10[] [] []) : (memref<64x64xbf16, 1 : i32>)
          air.channel.put  @V2L1_2[%arg12, %c0_7, %c0_7] (%alloc_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) : (memref<64x64xbf16, 1 : i32>)
        }
        scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 {
          air.channel.get  @VIn_3[%arg12] (%alloc_11[] [] []) : (memref<64x64xbf16, 1 : i32>)
          air.channel.put  @V2L1_3[%arg12, %c0_7, %c0_7] (%alloc_11[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) : (memref<64x64xbf16, 1 : i32>)
        }
        ...
        air.herd @herd_0  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%alloc_13, %arg21=%alloc_14, %arg22=%alloc_15, %arg23=%alloc_16, %arg24=%alloc_17, %arg25=%alloc_18, %arg26=%alloc_19, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {link_with = "attn.o"} {
          ...
          scf.for %arg28 = %c0_27 to %c2_28 step %c1_26 {
            ...
            func.call @fused_softmax(%collapse_shape, %arg25, %alloc_29, %alloc_30) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            ...
            func.call @accum_sp_r_s(%arg26, %alloc_30, %alloc_29) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            func.call @vector_copy_32elems(%c0_i32, %alloc_29, %arg26) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            memref.dealloc %alloc_29 : memref<64x1xbf16, 2 : i32>
            memref.dealloc %alloc_30 : memref<64x1xbf16, 2 : i32>
          }
          affine.if #set3()[%arg16, %arg17] {
            %35 = arith.subi %arg17, %c1_26 : index
            ...
            affine.if #set4()[%arg16, %arg17] {
              %alloc_29 = memref.alloc() : memref<64x64xbf16, 2 : i32>
              %alloc_30 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              %alloc_31 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              air.channel.get  @cascade_gp[%arg16, %arg17] (%alloc_29[] [] []) : (memref<64x64xbf16, 2 : i32>)
              air.channel.get  @cascade_up[%arg16, %arg17] (%alloc_30[] [] []) : (memref<64x1xbf16, 2 : i32>)
              air.channel.get  @cascade_sp[%arg16, %arg17] (%alloc_31[] [] []) : (memref<64x1xbf16, 2 : i32>)
              %alloc_32 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              func.call @vector_copy_32elems(%c0_i32, %arg25, %alloc_32) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @maximum_up_u_bf16(%alloc_30, %arg25) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              %alloc_33 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              func.call @exp_up_minus_u(%alloc_30, %arg25, %alloc_33) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              %alloc_34 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              func.call @exp_up_minus_u(%alloc_32, %arg25, %alloc_34) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @mul_r_gp(%alloc_33, %alloc_29) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              func.call @mul_r_gp(%alloc_34, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              func.call @add_gp_g(%arg24, %alloc_29) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              %alloc_35 = memref.alloc() : memref<64x1xbf16, 2 : i32>
              func.call @zero_fill_sp_bf16(%alloc_35) : (memref<64x1xbf16, 2 : i32>) -> ()
              func.call @accum_sp_r_s(%alloc_31, %alloc_33, %alloc_35) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @accum_sp_r_s(%arg26, %alloc_34, %alloc_35) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @vector_copy_32elems(%c0_i32, %alloc_35, %alloc_31) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              %35 = arith.subi %arg17, %c1_26 : index
              air.channel.put  @cascade_gp[%arg16, %35] (%alloc_29[] [] []) : (memref<64x64xbf16, 2 : i32>)
              air.channel.put  @cascade_up[%arg16, %35] (%arg25[] [] []) : (memref<64x1xbf16, 2 : i32>)
              air.channel.put  @cascade_sp[%arg16, %35] (%alloc_31[] [] []) : (memref<64x1xbf16, 2 : i32>)
              memref.dealloc %alloc_29 : memref<64x64xbf16, 2 : i32>
              memref.dealloc %alloc_30 : memref<64x1xbf16, 2 : i32>
              ...
              func.call @accum_sp_r_s(%arg26, %alloc_34, %alloc_35) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @vector_copy_32elems(%c0_i32, %alloc_35, %alloc_31) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              func.call @div_gp_sp(%alloc_31, %alloc_29) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              air.channel.put  @Gp2L2[%arg16, %c0_27] (%alloc_29[%c0_27, %c0_27, %c0_27, %c0_27] [%c8_25, %c8_25, %c8_25, %c8_25] [%c64_24, %c8_25, %c512_23, %c1_26]) : (memref<64x64xbf16, 2 : i32>)
              memref.dealloc %alloc_29 : memref<64x64xbf16, 2 : i32>
              memref.dealloc %alloc_30 : memref<64x1xbf16, 2 : i32>
              memref.dealloc %alloc_31 : memref<64x1xbf16, 2 : i32>
              memref.dealloc %alloc_32 : memref<64x1xbf16, 2 : i32>
