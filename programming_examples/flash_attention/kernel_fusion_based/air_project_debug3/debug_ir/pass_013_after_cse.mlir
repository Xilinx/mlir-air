...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x512x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x512x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16> attributes {id = 1 : i32} {
      ...
      %18 = air.channel.get async  @GpOut[%c0] (%arg11[%1] [%c16384] [%c1_1]) {id = 13 : i32} : (memref<2x512x64xbf16>)
      %19 = affine.apply #map5()[%arg5, %arg4]
      %20 = air.channel.put async  @QK2L1_1_0[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %19] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 14 : i32} : (memref<2x512x64xbf16>)
      %21 = air.channel.put async  @QK2L1_1_1[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %19] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 15 : i32} : (memref<2x512x64xbf16>)
      %22 = air.channel.put async  @QK2L1_1_2[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %19] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 16 : i32} : (memref<2x512x64xbf16>)
      %23 = air.channel.put async  @QK2L1_1_3[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %19] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 17 : i32} : (memref<2x512x64xbf16>)
      %24 = affine.apply #map6()[%arg5]
      %25 = air.channel.put async  @QK2L1_1_0[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %24] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 18 : i32} : (memref<2x512x64xbf16>)
      %26 = affine.apply #map7()[%arg5]
      %27 = air.channel.put async  @QK2L1_1_1[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %26] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 19 : i32} : (memref<2x512x64xbf16>)
      %28 = affine.apply #map8()[%arg5]
      %29 = air.channel.put async  @QK2L1_1_2[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %28] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 20 : i32} : (memref<2x512x64xbf16>)
      %30 = affine.apply #map9()[%arg5]
      %31 = air.channel.put async  @QK2L1_1_3[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %30] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 21 : i32} : (memref<2x512x64xbf16>)
      %32 = air.channel.put async  @VIn_0[%c1_1] (%arg10[%c0, %c0, %24] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) {id = 22 : i32} : (memref<2x512x64xbf16>)
      %33 = air.channel.put async  @VIn_1[%c1_1] (%arg10[%c0, %c0, %26] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) {id = 23 : i32} : (memref<2x512x64xbf16>)
      %34 = air.channel.put async  @VIn_2[%c1_1] (%arg10[%c0, %c0, %28] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) {id = 24 : i32} : (memref<2x512x64xbf16>)
      %35 = air.channel.put async  @VIn_3[%c1_1] (%arg10[%c0, %c0, %30] [%c2_0, %c64, %c64] [%c4096, %c64, %c1_1]) {id = 25 : i32} : (memref<2x512x64xbf16>)
      %36 = air.channel.get async  @GpOut[%c1_1] (%arg11[%19] [%c16384] [%c1_1]) {id = 26 : i32} : (memref<2x512x64xbf16>)
      %37 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %38 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_0[%arg12] (%results[] [] []) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %39 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_9) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_1[%arg12] (%results_10[] [] []) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %40 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_11) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_2[%arg12] (%results_12[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_12[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_12[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %41 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_13) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_3[%arg12] (%results_14[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %42 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%async_token_15) -> !air.async.token {
          %45 = affine.apply #map10()[%arg16]
          %46 = air.channel.get async [%async_token_15]  @Gp2L2[%arg16, %c0_7] (%results_16[%45, %c0_7] [%c64_2, %c64_2] [%c64_2, %c1_5]) {id = 39 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %44 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 3 : i32, link_with = "attn.o"} {
          ...
          %45 = arith.cmpi eq, %arg27, %c0_47 : index
          scf.if %45 {
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 41 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
            ...
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
          ...
          %46 = arith.index_cast %arg16 : index to i32
          ...
          scf.if %45 {
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
            ...
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
          ...
          scf.if %45 {
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
            ...
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
          ...
          %49 = arith.cmpi eq, %46, %c2_i32 : i32
          scf.if %49 {
            %async_token_52 = air.execute {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          ...
          scf.if %45 {
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
            ...
            %54 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %55 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %55 : !air.async.token
            } else {
              %55 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %56 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %56 : !air.async.token
              } else {
                %56 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %57 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                } else {
                  %57 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %57 : !air.async.token
                }
                affine.yield %56 : !air.async.token
              }
          ...
          %50 = arith.cmpi eq, %46, %c3_i32 : i32
          scf.if %50 {
            %async_token_52 = air.execute {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          }
          %51 = air.wait_all async [%async_token_49, %async_token_50, %async_token_51] 
          %52 = scf.for %arg28 = %c0_47 to %c2_48 step %c1_46 iter_args(%arg29 = %51) -> (!air.async.token) {
            ...
            scf.if %45 {
              %59 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async [%arg29]  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async [%arg29]  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %62 = air.channel.get async [%arg29]  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %62 : !air.async.token
                  } else {
                    %62 = air.channel.get async [%arg29]  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %62 : !air.async.token
                  }
                  affine.yield %61 : !air.async.token
                }
              ...
              %59 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async [%arg29]  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async [%arg29]  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %62 = air.channel.get async [%arg29]  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %62 : !air.async.token
                  } else {
                    %62 = air.channel.get async [%arg29]  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %62 : !air.async.token
                  }
                  affine.yield %61 : !air.async.token
                }
            ...
            %54 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %59 = scf.if %45 -> (!air.async.token) {
                %60 = air.channel.get async  @V2L1_0_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              } else {
                %60 = air.channel.get async  @V2L1_0_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              }
            ...
            %55 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %59 = scf.if %45 -> (!air.async.token) {
                %60 = air.channel.get async [%arg29, %54]  @V2L1_1_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              } else {
                %60 = air.channel.get async [%arg29, %54]  @V2L1_1_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              }
              affine.yield %59 : !air.async.token
            } else {
            ...
            %56 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %59 = scf.if %45 -> (!air.async.token) {
                %60 = air.channel.get async [%arg29, %55]  @V2L1_2_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              } else {
                %60 = air.channel.get async [%arg29, %55]  @V2L1_2_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              }
              affine.yield %59 : !air.async.token
            } else {
            ...
            %57 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %59 = scf.if %45 -> (!air.async.token) {
                %60 = air.channel.get async [%arg29, %56]  @V2L1_3_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              } else {
                %60 = air.channel.get async [%arg29, %56]  @V2L1_3_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %60 : !air.async.token
              }
              affine.yield %59 : !air.async.token
            } else {
            ...
            %async_token_53 = air.execute [%async_token_52] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_60 = air.execute [%async_token_59, %57] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %58 = air.wait_all async [%54, %55, %56, %async_token_60, %async_token_62] 
            scf.yield %58 : !air.async.token
          }
          %53 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %54 = arith.subi %arg17, %c1_46 : index
            %55 = air.channel.put async [%52]  @cascade_gp[%arg16, %54] (%arg24[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
            %56 = air.channel.put async [%52]  @cascade_up[%arg16, %54] (%arg25[] [] []) {id = 90 : i32} : (memref<64x1xbf16, 2 : i32>)
            %57 = air.channel.put async [%52]  @cascade_sp[%arg16, %54] (%arg26[] [] []) {id = 91 : i32} : (memref<64x1xbf16, 2 : i32>)
            %58 = air.wait_all async [%55, %56, %57] 
            affine.yield %58 : !air.async.token
          } else {
            %54 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %55 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 93 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 94 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %59 = air.channel.put async [%async_token_70]  @cascade_gp[%arg16, %58] (%results_53[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.put async [%async_token_67]  @cascade_up[%arg16, %58] (%arg25[] [] []) {id = 96 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.put async [%async_token_76]  @cascade_sp[%arg16, %58] (%results_57[] [] []) {id = 97 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %62 = air.wait_all async [%59, %60, %61] 
              affine.yield %62 : !air.async.token
            } else {
              %async_token_52, %results_53 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %55 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 99 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 100 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              ...
              %58 = air.channel.put async [%async_token_77]  @Gp2L2[%arg16, %c0_47] (%results_53[%c0_47, %c0_47, %c0_47, %c0_47] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_44, %c8_45, %c512_43, %c1_46]) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
        ...
        %async_token_37 = air.execute [%44] {
          memref.dealloc %results_30 : memref<64x1xbf16, 2 : i32>
        }
        %async_token_38 = air.execute [%38] {
