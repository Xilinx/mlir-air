...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x512x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x512x64xbf16>) {
    ...
    air.launch (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1_0) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16> {
      ...
      air.channel.put  @QK2L1[%c0, %c0_1, %c0_2] (%arg8[%c0_3, %c0_4, %c0_5, %c0_6, %5] [%c4, %c8, %c8_7, %c8_8, %c8_9] [%c4096, %c8_10, %c512, %c64, %c1_11]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0, %c1_12, %c0_13] (%arg8[%c0_14, %c0_15, %c0_16, %c0_17, %5] [%c4_18, %c8_19, %c8_20, %c8_21, %c8_22] [%c4096_23, %c8_24, %c512_25, %c64_26, %c1_27]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0, %c2_28, %c0_29] (%arg8[%c0_30, %c0_31, %c0_32, %c0_33, %5] [%c4_34, %c8_35, %c8_36, %c8_37, %c8_38] [%c4096_39, %c8_40, %c512_41, %c64_42, %c1_43]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0, %c3, %c0_44] (%arg8[%c0_45, %c0_46, %c0_47, %c0_48, %5] [%c4_49, %c8_50, %c8_51, %c8_52, %c8_53] [%c4096_54, %c8_55, %c512_56, %c64_57, %c1_58]) : (memref<2x512x64xbf16>)
      ...
      air.channel.get  @GpOut[%c0] (%arg11[%5] [%c16384_160] [%c1_161]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_162, %c0_163, %c0_164] (%arg8[%c0_165, %c0_166, %c0_167, %c0_168, %18] [%c4_169, %c8_170, %c8_171, %c8_172, %c8_173] [%c4096_174, %c8_175, %c512_176, %c64_177, %c1_178]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_162, %c1_179, %c0_180] (%arg8[%c0_181, %c0_182, %c0_183, %c0_184, %18] [%c4_185, %c8_186, %c8_187, %c8_188, %c8_189] [%c4096_190, %c8_191, %c512_192, %c64_193, %c1_194]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_162, %c2_195, %c0_196] (%arg8[%c0_197, %c0_198, %c0_199, %c0_200, %18] [%c4_201, %c8_202, %c8_203, %c8_204, %c8_205] [%c4096_206, %c8_207, %c512_208, %c64_209, %c1_210]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_162, %c3_211, %c0_212] (%arg8[%c0_213, %c0_214, %c0_215, %c0_216, %18] [%c4_217, %c8_218, %c8_219, %c8_220, %c8_221] [%c4096_222, %c8_223, %c512_224, %c64_225, %c1_226]) : (memref<2x512x64xbf16>)
      ...
      air.channel.get  @GpOut[%c1_162] (%arg11[%18] [%c16384_331] [%c1_332]) : (memref<2x512x64xbf16>)
