    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c8, %arg7=%c6) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16> attributes {id = 3 : i32} {
      ...
      %54 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1) attributes {id = 2 : i32} {
        ...
        %56 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %55) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_0[%arg12, %c0_5, %c0_5] (%results[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %58 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %57) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_1[%arg12, %c0_5, %c0_5] (%results_8[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %60 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %59) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_2[%arg12, %c0_5, %c0_5] (%results_10[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %62 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %61) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_3[%arg12, %c0_5, %c0_5] (%results_12[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %66 = air.herd @herd_0 async [%async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_6, %arg19=%c4_6) args(%arg20=%results_16, %arg21=%results_18, %arg22=%results_20, %arg23=%results_22, %arg24=%results_24, %arg25=%results_26, %arg26=%results_28, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %76 = scf.if %74 -> (!air.async.token) {
            %async_token_49 = air.execute [%72] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 17 : i32}
            %91 = air.wait_all async [%async_token_49]  {id = 15 : i32}
            scf.yield %91 : !air.async.token
          } else {
          ...
          %81 = scf.if %79 -> (!air.async.token) {
            %async_token_49 = air.execute [%77] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
            %91 = air.wait_all async [%async_token_49]  {id = 18 : i32}
            scf.yield %91 : !air.async.token
          } else {
          ...
          %86 = scf.if %84 -> (!air.async.token) {
            %async_token_49 = air.execute [%82] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
            %91 = air.wait_all async [%async_token_49]  {id = 21 : i32}
            scf.yield %91 : !air.async.token
          } else {
            %91 = air.wait_all async  {id = 22 : i32}
            scf.yield %91 : !air.async.token
          }
          %87 = air.wait_all async [%async_token_46, %async_token_47, %async_token_48]  {id = 35 : i32}
          %88 = scf.for %arg28 = %c0_44 to %c8_45 step %c1_43 iter_args(%arg29 = %87) -> (!air.async.token) {
            ...
            %async_token_50 = air.execute [%arg29, %91, %async_token_49] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_57 = air.execute [%arg29, %async_token_56, %99] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %90 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            ...
            %92 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              ...
              %94 = air.channel.get async [%async_token_49]  @cascade_gp[%arg16, %arg17] (%results_50[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %95 = air.channel.get async [%async_token_51]  @cascade_up[%arg16, %arg17] (%results_52[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %96 = air.channel.get async [%async_token_53]  @cascade_sp[%arg16, %arg17] (%results_54[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_55, %results_56 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_57 = air.execute [%async_token_55, %91] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_56) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_58 = air.execute [%async_token_57, %95] {
              ...
              %async_token_65 = air.execute [%async_token_61, %94] {
                func.call @mul_r_gp(%results_60, %results_50) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_66 = air.execute [%async_token_64, %91] {
              ...
              %async_token_71 = air.execute [%async_token_70, %async_token_65, %96] {
              ...
              %async_token_72 = air.execute [%async_token_71, %async_token_66, %91] {
              ...
              %97 = arith.subi %arg17, %c1_43 : index
              %98 = air.channel.put async [%async_token_67]  @cascade_gp[%arg16, %97] (%results_50[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %99 = air.channel.put async [%async_token_64]  @cascade_up[%arg16, %97] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %100 = air.channel.put async [%async_token_73]  @cascade_sp[%arg16, %97] (%results_54[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_74 = air.execute [%98] {
                memref.dealloc %results_50 : memref<64x64xbf16, 2 : i32>
              } {id = 49 : i32}
              %async_token_75 = air.execute [%async_token_61] {
                memref.dealloc %results_52 : memref<64x1xbf16, 2 : i32>
              } {id = 50 : i32}
              %async_token_76 = air.execute [%100] {
                memref.dealloc %results_54 : memref<64x1xbf16, 2 : i32>
              } {id = 51 : i32}
              ...
              %94 = air.channel.get async [%async_token_49]  @cascade_gp[%arg16, %arg17] (%results_50[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %95 = air.channel.get async [%async_token_51]  @cascade_up[%arg16, %arg17] (%results_52[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %96 = air.channel.get async [%async_token_53]  @cascade_sp[%arg16, %arg17] (%results_54[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_55, %results_56 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %97 = air.channel.put async [%async_token_74]  @Gp2L2[%arg16, %c0_44] (%results_50[%c0_44, %c0_44, %c0_44, %c0_44] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_42, %c8_45, %c512_41, %c1_43]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_75 = air.execute [%97] {
                memref.dealloc %results_50 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
