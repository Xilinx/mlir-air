...
module {
  ...
  func.func @attention_bf16(%arg0: memref<12x2048x64xbf16>, %arg1: memref<12x2048x64xbf16>, %arg2: memref<12x2048x64xbf16>, %arg3: memref<12x2048x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c8, %arg7=%c6) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16> attributes {id = 3 : i32} {
      ...
      %7 = air.channel.put async  @QK2L1_0_0[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 1 : i32} : (memref<12x2048x64xbf16>)
      %8 = air.channel.put async  @QK2L1_0_1[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 2 : i32} : (memref<12x2048x64xbf16>)
      %9 = air.channel.put async  @QK2L1_0_2[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 3 : i32} : (memref<12x2048x64xbf16>)
      %10 = air.channel.put async  @QK2L1_0_3[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 4 : i32} : (memref<12x2048x64xbf16>)
      %11 = affine.apply #map3()[%4, %c0]
      %12 = air.channel.put async  @QK2L1_0_0[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %11] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 5 : i32} : (memref<12x2048x64xbf16>)
      %13 = affine.apply #map3()[%4, %c32768]
      %14 = air.channel.put async  @QK2L1_0_1[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %13] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 6 : i32} : (memref<12x2048x64xbf16>)
      %15 = affine.apply #map3()[%4, %c65536]
      %16 = air.channel.put async  @QK2L1_0_2[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %15] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 7 : i32} : (memref<12x2048x64xbf16>)
      %17 = affine.apply #map3()[%4, %c98304]
      %18 = air.channel.put async  @QK2L1_0_3[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %17] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 8 : i32} : (memref<12x2048x64xbf16>)
      ...
      %33 = air.channel.put async  @QK2L1_1_0[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 14 : i32} : (memref<12x2048x64xbf16>)
      %34 = air.channel.put async  @QK2L1_1_1[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 15 : i32} : (memref<12x2048x64xbf16>)
      %35 = air.channel.put async  @QK2L1_1_2[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 16 : i32} : (memref<12x2048x64xbf16>)
      %36 = air.channel.put async  @QK2L1_1_3[%c0, %c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 17 : i32} : (memref<12x2048x64xbf16>)
      %37 = affine.apply #map3()[%30, %c0]
      %38 = air.channel.put async  @QK2L1_1_0[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %37] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 18 : i32} : (memref<12x2048x64xbf16>)
      %39 = affine.apply #map3()[%30, %c32768]
      %40 = air.channel.put async  @QK2L1_1_1[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %39] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 19 : i32} : (memref<12x2048x64xbf16>)
      %41 = affine.apply #map3()[%30, %c65536]
      %42 = air.channel.put async  @QK2L1_1_2[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %41] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 20 : i32} : (memref<12x2048x64xbf16>)
      %43 = affine.apply #map3()[%30, %c98304]
      %44 = air.channel.put async  @QK2L1_1_3[%c0, %c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %43] [%c8_0, %c8_0, %c8_0, %c8_0, %c8_0] [%c4096, %c8_0, %c512, %c64, %c1]) {id = 21 : i32} : (memref<12x2048x64xbf16>)
      ...
      %54 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1) attributes {id = 2 : i32} {
        ...
        %56 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %55) -> (!air.async.token) {
          ...
          %69 = scf.if %68 -> (!air.async.token) {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_0_0[%c0_5, %c0_5, %c0_5] (%results[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          } else {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_0_1[%c0_5, %c0_5, %c0_5] (%results[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          }
        ...
        %58 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %57) -> (!air.async.token) {
          ...
          %68 = arith.cmpi eq, %arg12, %c0_5 : index
          %69 = scf.if %68 -> (!air.async.token) {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_1_0[%c0_5, %c0_5, %c0_5] (%results_8[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          } else {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_1_1[%c0_5, %c0_5, %c0_5] (%results_8[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          }
        ...
        %60 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %59) -> (!air.async.token) {
          ...
          %68 = arith.cmpi eq, %arg12, %c0_5 : index
          %69 = scf.if %68 -> (!air.async.token) {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_2_0[%c0_5, %c0_5, %c0_5] (%results_10[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          } else {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_2_1[%c0_5, %c0_5, %c0_5] (%results_10[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          }
        ...
        %62 = scf.for %arg16 = %c0_5 to %c8_4 step %c1_3 iter_args(%arg17 = %61) -> (!air.async.token) {
          ...
          %68 = arith.cmpi eq, %arg12, %c0_5 : index
          %69 = scf.if %68 -> (!air.async.token) {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_3_0[%c0_5, %c0_5, %c0_5] (%results_12[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          } else {
            %71 = air.channel.put async [%arg17, %67]  @V2L1_3_1[%c0_5, %c0_5, %c0_5] (%results_12[%c0_5, %c0_5, %c0_5, %c0_5] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_2, %c64_1, %c1_3]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %71 : !air.async.token
          }
        ...
        %64 = scf.parallel (%arg16) = (%c0_5) to (%c4_6) step (%c1_3) init (%63) -> !air.async.token {
          %67 = affine.apply #map5()[%arg16]
          %68 = air.channel.get async [%63]  @Gp2L2[%arg16, %c0_5] (%results_14[%67, %c0_5] [%c64_1, %c64_1] [%c64_1, %c1_3]) {id = 35 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %66 = air.herd @herd_0 async [%async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_6, %arg19=%c4_6) args(%arg20=%results_16, %arg21=%results_18, %arg22=%results_20, %arg23=%results_22, %arg24=%results_24, %arg25=%results_26, %arg26=%results_28, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %67 = arith.cmpi eq, %arg27, %c0_44 : index
          %68 = scf.if %67 -> (!air.async.token) {
            %95 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %96 = air.channel.get async  @QK2L1_0_0[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %96 : !air.async.token
            } else {
              %96 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %97 = air.channel.get async  @QK2L1_0_1[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %97 : !air.async.token
              } else {
                %97 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %98 = air.channel.get async  @QK2L1_0_2[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %98 : !air.async.token
                } else {
                  %98 = air.channel.get async  @QK2L1_0_3[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %98 : !air.async.token
                }
                affine.yield %97 : !air.async.token
              }
            ...
            %95 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %96 = air.channel.get async  @QK2L1_1_0[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %96 : !air.async.token
            } else {
              %96 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %97 = air.channel.get async  @QK2L1_1_1[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %97 : !air.async.token
              } else {
                %97 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %98 = air.channel.get async  @QK2L1_1_2[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %98 : !air.async.token
                } else {
                  %98 = air.channel.get async  @QK2L1_1_3[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %98 : !air.async.token
                }
                affine.yield %97 : !air.async.token
              }
          ...
          %78 = scf.if %76 -> (!air.async.token) {
            ...
            %95 = air.wait_all async [%async_token_49]  {id = 15 : i32}
            scf.yield %95 : !air.async.token
          } else {
          ...
          %84 = scf.if %82 -> (!air.async.token) {
            %async_token_49 = air.execute [%80] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
            %95 = air.wait_all async [%async_token_49]  {id = 18 : i32}
            scf.yield %95 : !air.async.token
          } else {
            %95 = air.wait_all async  {id = 19 : i32}
            scf.yield %95 : !air.async.token
          }
          %85 = arith.cmpi eq, %arg27, %c0_44 : index
          ...
          %90 = scf.if %88 -> (!air.async.token) {
            ...
            %95 = air.wait_all async [%async_token_49]  {id = 21 : i32}
            scf.yield %95 : !air.async.token
          } else {
            %95 = air.wait_all async  {id = 22 : i32}
            scf.yield %95 : !air.async.token
          }
          %91 = air.wait_all async [%async_token_46, %async_token_47, %async_token_48]  {id = 35 : i32}
          %92 = scf.for %arg28 = %c0_44 to %c8_45 step %c1_43 iter_args(%arg29 = %91) -> (!air.async.token) {
            ...
            %95 = arith.cmpi eq, %arg27, %c0_44 : index
            %96 = scf.if %95 -> (!air.async.token) {
              %106 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %107 = air.channel.get async [%arg29]  @QK2L1_0_0[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %107 : !air.async.token
              } else {
                %107 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %108 = air.channel.get async [%arg29]  @QK2L1_0_1[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %108 : !air.async.token
                } else {
                  %108 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %109 = air.channel.get async [%arg29]  @QK2L1_0_2[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %109 : !air.async.token
                  } else {
                    %109 = air.channel.get async [%arg29]  @QK2L1_0_3[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %109 : !air.async.token
                  }
                  affine.yield %108 : !air.async.token
                }
              ...
              %106 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %107 = air.channel.get async [%arg29]  @QK2L1_1_0[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %107 : !air.async.token
              } else {
                %107 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %108 = air.channel.get async [%arg29]  @QK2L1_1_1[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %108 : !air.async.token
                } else {
                  %108 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %109 = air.channel.get async [%arg29]  @QK2L1_1_2[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %109 : !air.async.token
                  } else {
                    %109 = air.channel.get async [%arg29]  @QK2L1_1_3[%c0_44, %c0_44, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %109 : !air.async.token
                  }
                  affine.yield %108 : !air.async.token
                }
            ...
            %98 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %106 = arith.cmpi eq, %arg27, %c0_44 : index
              %107 = scf.if %106 -> (!air.async.token) {
                %109 = air.channel.get async  @V2L1_0_0[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              } else {
                %109 = air.channel.get async  @V2L1_0_1[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              }
            ...
            %100 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %106 = arith.cmpi eq, %arg27, %c0_44 : index
              %107 = scf.if %106 -> (!air.async.token) {
                %109 = air.channel.get async [%99]  @V2L1_1_0[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              } else {
                %109 = air.channel.get async [%99]  @V2L1_1_1[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              }
            ...
            %102 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %106 = arith.cmpi eq, %arg27, %c0_44 : index
              %107 = scf.if %106 -> (!air.async.token) {
                %109 = air.channel.get async [%101]  @V2L1_2_0[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              } else {
                %109 = air.channel.get async [%101]  @V2L1_2_1[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              }
            ...
            %104 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %106 = arith.cmpi eq, %arg27, %c0_44 : index
              %107 = scf.if %106 -> (!air.async.token) {
                %109 = air.channel.get async [%103]  @V2L1_3_0[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              } else {
                %109 = air.channel.get async [%103]  @V2L1_3_1[%c0_44, %arg17, %arg16] (%arg22[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %109 : !air.async.token
              }
            ...
            %async_token_50 = air.execute [%arg29, %96, %async_token_49] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_56 = air.execute [%async_token_55, %arg29] {
              func.call @mul_r_gp(%results_54, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 25 : i32}
            %async_token_57 = air.execute [%arg29, %async_token_56, %104] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_59 = air.execute [%arg29, %async_token_58] {
          ...
          %94 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %96 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %98 = air.channel.get async [%async_token_49]  @cascade_gp[%arg16, %arg17] (%results_50[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %99 = air.channel.get async [%async_token_51]  @cascade_up[%arg16, %arg17] (%results_52[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %100 = air.channel.get async [%async_token_53]  @cascade_sp[%arg16, %arg17] (%results_54[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_55, %results_56 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_57 = air.execute [%async_token_55, %95] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_56) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_58 = air.execute [%async_token_57, %99] {
              ...
              %async_token_65 = air.execute [%async_token_61, %98] {
                func.call @mul_r_gp(%results_60, %results_50) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_66 = air.execute [%async_token_64, %95] {
              ...
              %async_token_71 = air.execute [%async_token_70, %async_token_65, %100] {
              ...
              %async_token_72 = air.execute [%async_token_71, %async_token_66, %95] {
              ...
              %101 = arith.subi %arg17, %c1_43 : index
              %102 = air.channel.put async [%async_token_67]  @cascade_gp[%arg16, %101] (%results_50[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %103 = air.channel.put async [%async_token_64]  @cascade_up[%arg16, %101] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %104 = air.channel.put async [%async_token_73]  @cascade_sp[%arg16, %101] (%results_54[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_74 = air.execute [%102] {
                memref.dealloc %results_50 : memref<64x64xbf16, 2 : i32>
              } {id = 49 : i32}
              %async_token_75 = air.execute [%async_token_61] {
                memref.dealloc %results_52 : memref<64x1xbf16, 2 : i32>
              } {id = 50 : i32}
              %async_token_76 = air.execute [%104] {
                memref.dealloc %results_54 : memref<64x1xbf16, 2 : i32>
              } {id = 51 : i32}
              ...
              %98 = air.channel.get async [%async_token_49]  @cascade_gp[%arg16, %arg17] (%results_50[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %99 = air.channel.get async [%async_token_51]  @cascade_up[%arg16, %arg17] (%results_52[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %100 = air.channel.get async [%async_token_53]  @cascade_sp[%arg16, %arg17] (%results_54[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_55, %results_56 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %101 = air.channel.put async [%async_token_74]  @Gp2L2[%arg16, %c0_44] (%results_50[%c0_44, %c0_44, %c0_44, %c0_44] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_42, %c8_45, %c512_41, %c1_43]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
        ...
        %async_token_36 = air.execute [%56] {
          memref.dealloc %results : memref<64x64xbf16, 1 : i32>
        } {id = 89 : i32}
        %async_token_37 = air.execute [%58] {
        ...
        %async_token_39 = air.execute [%62] {
          memref.dealloc %results_12 : memref<64x64xbf16, 1 : i32>
        } {id = 92 : i32}
        %async_token_40 = air.execute [%65] {
