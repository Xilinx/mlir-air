  ...
  func.func @attention_bf16(%arg0: memref<12x2048x64xbf16>, %arg1: memref<12x2048x64xbf16>, %arg2: memref<12x2048x64xbf16>, %arg3: memref<12x2048x64xbf16>) {
    ...
    air.launch (%arg4, %arg5) in (%arg6=%c8, %arg7=%c6) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16>, memref<12x2048x64xbf16> {
      ...
      air.segment @attn_seg  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1) {
        ...
        scf.parallel (%arg16) = (%c0_18) to (%c4_19) step (%c1_20) {
        ...
        air.herd @herd_0  tile (%arg16, %arg17) in (%arg18=%c4_6, %arg19=%c4_6) args(%arg20=%alloc_11, %arg21=%alloc_12, %arg22=%alloc_13, %arg23=%alloc_14, %arg24=%alloc_15, %arg25=%alloc_16, %arg26=%alloc_17, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {link_with = "attn.o"} {
          ...
          scf.for %arg28 = %c0_24 to %c8_25 step %c1_23 {
          ...
          affine.if #set3()[%arg16, %arg17] {
            %35 = arith.subi %arg17, %c1_23 : index
            ...
            affine.if #set4()[%arg16, %arg17] {
              ...
              %35 = arith.subi %arg17, %c1_23 : index
              air.channel.put  @cascade_gp[%arg16, %35] (%alloc_26[] [] []) : (memref<64x64xbf16, 2 : i32>)
              air.channel.put  @cascade_up[%arg16, %35] (%arg25[] [] []) : (memref<64x1xbf16, 2 : i32>)
              air.channel.put  @cascade_sp[%arg16, %35] (%alloc_28[] [] []) : (memref<64x1xbf16, 2 : i32>)
              ...
              air.channel.put  @Gp2L2[%arg16, %c0_24] (%alloc_26[%c0_24, %c0_24, %c0_24, %c0_24] [%c8_25, %c8_25, %c8_25, %c8_25] [%c64_22, %c8_25, %c512_21, %c1_23]) : (memref<64x64xbf16, 2 : i32>)
              memref.dealloc %alloc_26 : memref<64x64xbf16, 2 : i32>
              memref.dealloc %alloc_27 : memref<64x1xbf16, 2 : i32>
              memref.dealloc %alloc_28 : memref<64x1xbf16, 2 : i32>
              memref.dealloc %alloc_29 : memref<64x1xbf16, 2 : i32>
