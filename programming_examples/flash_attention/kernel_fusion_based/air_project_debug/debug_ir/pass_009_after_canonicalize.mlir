        ...
        %52 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %53 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %68 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %69 = air.channel.get async  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %69 : !air.async.token
            } else {
              %69 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %70 = air.channel.get async  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %70 : !air.async.token
              } else {
                %70 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %71 = air.channel.get async  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                } else {
                  %71 = air.channel.get async  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                }
                affine.yield %70 : !air.async.token
              }
            ...
            %68 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %69 = air.channel.get async  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %69 : !air.async.token
            } else {
              %69 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %70 = air.channel.get async  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %70 : !air.async.token
              } else {
                %70 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %71 = air.channel.get async  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                } else {
                  %71 = air.channel.get async  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                }
                affine.yield %70 : !air.async.token
              }
          ...
          %66 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %65) -> (!air.async.token) {
            ...
            %68 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async [%arg29]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                    %77 = air.channel.get async [%arg29]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  } else {
                    %77 = air.channel.get async [%arg29]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  }
                  affine.yield %76 : !air.async.token
                }
              ...
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async [%arg29]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                    %77 = air.channel.get async [%arg29]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  } else {
                    %77 = air.channel.get async [%arg29]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  }
                  affine.yield %76 : !air.async.token
                }
            ...
            %69 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @V2L1_0_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async  @V2L1_0_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
            ...
            %70 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %69]  @V2L1_1_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %69]  @V2L1_1_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
            ...
            %71 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %70]  @V2L1_2_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %70]  @V2L1_2_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
            ...
            %72 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %71]  @V2L1_3_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %71]  @V2L1_3_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
          ...
          %67 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
            ...
            %68 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
