        ...
        %44 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 3 : i32, link_with = "attn.o"} {
          ...
          %46 = scf.if %45 -> (!air.async.token) {
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 41 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
            ...
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
          ...
          %49 = scf.if %45 -> (!air.async.token) {
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
            ...
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
          ...
          %51 = scf.if %45 -> (!air.async.token) {
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
            ...
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
          ...
          %53 = scf.if %45 -> (!air.async.token) {
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
            ...
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
          ...
          %55 = air.wait_all async [%async_token_49, %async_token_50, %async_token_51] 
          %56 = scf.for %arg28 = %c0_47 to %c2_48 step %c1_46 iter_args(%arg29 = %55) -> (!air.async.token) {
            ...
            %58 = scf.if %45 -> (!air.async.token) {
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg29]  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg29]  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg29]  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg29]  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
              ...
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg29]  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg29]  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg29]  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg29]  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
            ...
            %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async  @V2L1_0_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async  @V2L1_0_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
            ...
            %60 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %59]  @V2L1_1_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %59]  @V2L1_1_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %61 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %60]  @V2L1_2_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %60]  @V2L1_2_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %62 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %61]  @V2L1_3_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %61]  @V2L1_3_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %async_token_60 = air.execute [%async_token_59, %62] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %63 = air.wait_all async [%59, %60, %61, %async_token_60, %async_token_62] 
            scf.yield %63 : !air.async.token
          }
          %57 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %58 = arith.subi %arg17, %c1_46 : index
            %59 = air.channel.put async [%56]  @cascade_gp[%arg16, %58] (%arg24[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
            %60 = air.channel.put async [%56]  @cascade_up[%arg16, %58] (%arg25[] [] []) {id = 90 : i32} : (memref<64x1xbf16, 2 : i32>)
            %61 = air.channel.put async [%56]  @cascade_sp[%arg16, %58] (%arg26[] [] []) {id = 91 : i32} : (memref<64x1xbf16, 2 : i32>)
            ...
            %58 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %59 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 93 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 94 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              %async_token_60 = air.execute [%async_token_58, %56] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_59) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              }
              %async_token_61 = air.execute [%async_token_60, %60] {
              ...
              %async_token_68 = air.execute [%async_token_64, %59] {
              ...
              %async_token_74 = air.execute [%async_token_73, %async_token_68, %61] {
              ...
              %62 = arith.subi %arg17, %c1_46 : index
              %63 = air.channel.put async [%async_token_70]  @cascade_gp[%arg16, %62] (%results_53[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
              %64 = air.channel.put async [%async_token_67]  @cascade_up[%arg16, %62] (%arg25[] [] []) {id = 96 : i32} : (memref<64x1xbf16, 2 : i32>)
              %65 = air.channel.put async [%async_token_76]  @cascade_sp[%arg16, %62] (%results_57[] [] []) {id = 97 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_77 = air.execute [%63] {
                memref.dealloc %results_53 : memref<64x64xbf16, 2 : i32>
              }
              %async_token_78 = air.execute [%async_token_64] {
                memref.dealloc %results_55 : memref<64x1xbf16, 2 : i32>
              }
              %async_token_79 = air.execute [%65] {
                memref.dealloc %results_57 : memref<64x1xbf16, 2 : i32>
              }
              ...
              %66 = air.wait_all async [%63, %64, %65] 
              affine.yield %66 : !air.async.token
            } else {
              %async_token_52, %results_53 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %59 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 99 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 100 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              ...
              %62 = air.channel.put async [%async_token_77]  @Gp2L2[%arg16, %c0_47] (%results_53[%c0_47, %c0_47, %c0_47, %c0_47] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_44, %c8_45, %c512_43, %c1_46]) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_78 = air.execute [%62] {
                memref.dealloc %results_53 : memref<64x64xbf16, 2 : i32>
              }
