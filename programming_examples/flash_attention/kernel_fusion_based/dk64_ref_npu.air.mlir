module {
  aie.device(npu2) @attn_seg {
    ...
    aie.runtime_sequence @attn_seg_sequence(%arg0: memref<2x256x64xbf16>, %arg1: memref<2x256x64xbf16>, %arg2: memref<2x256x64xbf16>, %arg3: memref<2x256x64xbf16>) {
      ...
      %1 = aiex.dma_configure_task_for @air_QKIn_0_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %3 = aiex.dma_configure_task_for @air_QKIn_1_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 4096, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %5 = aiex.dma_configure_task_for @air_QKIn_2_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 8192, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %7 = aiex.dma_configure_task_for @air_QKIn_3_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 12288, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %17 = aiex.dma_configure_task_for @air_QKIn_0_1_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 16384, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %19 = aiex.dma_configure_task_for @air_QKIn_1_1_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 20480, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %21 = aiex.dma_configure_task_for @air_QKIn_2_1_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 24576, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      ...
      %23 = aiex.dma_configure_task_for @air_QKIn_3_1_0_0 {
        aie.dma_bd(%arg1 : memref<2x256x64xbf16>, 28672, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
  ...
  aie.device(npu2) {
    aie.runtime_sequence @attention_bf16(%arg0: memref<2x256x64xbf16>, %arg1: memref<2x256x64xbf16>, %arg2: memref<2x256x64xbf16>, %arg3: memref<2x256x64xbf16>) {
      aiex.configure @attn_seg {
        aiex.run @attn_seg_sequence(%arg0, %arg1, %arg2, %arg3) : (memref<2x256x64xbf16>, memref<2x256x64xbf16>, memref<2x256x64xbf16>, memref<2x256x64xbf16>)
      }
    }
  }
}
