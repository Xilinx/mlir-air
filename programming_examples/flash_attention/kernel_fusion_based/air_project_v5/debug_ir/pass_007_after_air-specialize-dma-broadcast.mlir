        ...
        %66 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %67 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %91 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %92 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %92 : !air.async.token
            } else {
              %92 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %93 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %93 : !air.async.token
              } else {
                %93 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %94 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %94 : !air.async.token
                } else {
                  %94 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %94 : !air.async.token
                }
                affine.yield %93 : !air.async.token
              }
            ...
            %91 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %92 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %92 : !air.async.token
            } else {
              %92 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %93 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %93 : !air.async.token
              } else {
                %93 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %94 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %94 : !air.async.token
                } else {
                  %94 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %94 : !air.async.token
                }
                affine.yield %93 : !air.async.token
              }
          ...
          %88 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %87) -> (!air.async.token) {
            ...
            %91 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %101 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %102 = air.channel.get async [%arg29]  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %102 : !air.async.token
              } else {
                %102 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %103 = air.channel.get async [%arg29]  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %103 : !air.async.token
                } else {
                  %103 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %104 = air.channel.get async [%arg29]  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %104 : !air.async.token
                  } else {
                    %104 = air.channel.get async [%arg29]  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %104 : !air.async.token
                  }
                  affine.yield %103 : !air.async.token
                }
              ...
              %101 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %102 = air.channel.get async [%arg29]  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %102 : !air.async.token
              } else {
                %102 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %103 = air.channel.get async [%arg29]  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %103 : !air.async.token
                } else {
                  %103 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %104 = air.channel.get async [%arg29]  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %104 : !air.async.token
                  } else {
                    %104 = air.channel.get async [%arg29]  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %104 : !air.async.token
                  }
                  affine.yield %103 : !air.async.token
                }
            ...
            %93 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %101 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %103 = air.channel.get async  @V2L1_0_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              } else {
                %103 = air.channel.get async  @V2L1_0_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              }
            ...
            %95 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %101 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %103 = air.channel.get async [%94]  @V2L1_1_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              } else {
                %103 = air.channel.get async [%94]  @V2L1_1_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              }
            ...
            %97 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %101 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %103 = air.channel.get async [%96]  @V2L1_2_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              } else {
                %103 = air.channel.get async [%96]  @V2L1_2_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              }
            ...
            %99 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              %101 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %103 = air.channel.get async [%98]  @V2L1_3_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              } else {
                %103 = air.channel.get async [%98]  @V2L1_3_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %103 : !air.async.token
              }
          ...
          %90 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
            ...
            %92 = affine.if #set8()[%arg16, %arg17] -> !air.async.token {
