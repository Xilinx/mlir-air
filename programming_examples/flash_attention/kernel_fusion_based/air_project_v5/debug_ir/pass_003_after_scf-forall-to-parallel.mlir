...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x256x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x256x64xbf16>) {
    ...
    air.launch (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> {
      ...
      air.channel.put  @QK2L1[%c0, %c1_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      air.channel.put  @QK2L1[%c0, %c2, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      air.channel.put  @QK2L1[%c0, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %5] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0, %c1_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %7] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      %8 = affine.apply #map3()[%3, %c16384]
      air.channel.put  @QK2L1[%c0, %c2, %c0] (%arg9[%c0, %c0, %c0, %c0, %8] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      %9 = affine.apply #map3()[%3, %c24576]
      air.channel.put  @QK2L1[%c0, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %9] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_0, %c1_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      air.channel.put  @QK2L1[%c1_0, %c2, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      air.channel.put  @QK2L1[%c1_0, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %18] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x256x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c1_0, %c1_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %20] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      %21 = affine.apply #map3()[%16, %c16384]
      air.channel.put  @QK2L1[%c1_0, %c2, %c0] (%arg9[%c0, %c0, %c0, %c0, %21] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      %22 = affine.apply #map3()[%16, %c24576]
      air.channel.put  @QK2L1[%c1_0, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %22] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) : (memref<2x512x64xbf16>)
      ...
      air.segment @attn_seg  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) {
        ...
        air.herd @herd_0  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%alloc_12, %arg21=%alloc_13, %arg22=%alloc_14, %arg23=%alloc_15, %arg24=%alloc_16, %arg25=%alloc_17, %arg26=%alloc_18, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {link_with = "attn.o"} {
          ...
          scf.for %arg28 = %c0_26 to %c2_27 step %c1_25 {
          ...
          affine.if #set3()[%arg16, %arg17] {
            %35 = arith.subi %arg17, %c1_25 : index
            ...
            affine.if #set4()[%arg16, %arg17] {
              ...
              %35 = arith.subi %arg17, %c1_25 : index
              air.channel.put  @cascade_gp[%arg16, %35] (%alloc_28[] [] []) : (memref<64x64xbf16, 2 : i32>)
              air.channel.put  @cascade_up[%arg16, %35] (%arg25[] [] []) : (memref<64x1xbf16, 2 : i32>)
              air.channel.put  @cascade_sp[%arg16, %35] (%alloc_30[] [] []) : (memref<64x1xbf16, 2 : i32>)
