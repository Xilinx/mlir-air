        ...
        %52 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %53 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %68 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %69 = air.channel.get async  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %69 : !air.async.token
            } else {
              %69 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %70 = air.channel.get async  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %70 : !air.async.token
              } else {
                %70 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %71 = air.channel.get async  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                } else {
                  %71 = air.channel.get async  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                }
                affine.yield %70 : !air.async.token
              }
            ...
            %68 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %69 = air.channel.get async  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %69 : !air.async.token
            } else {
              %69 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %70 = air.channel.get async  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %70 : !air.async.token
              } else {
                %70 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                  %71 = air.channel.get async  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                } else {
                  %71 = air.channel.get async  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %71 : !air.async.token
                }
                affine.yield %70 : !air.async.token
              }
          ...
          %54 = arith.index_cast %arg16 : index to i32
          ...
          %58 = arith.cmpi eq, %57, %c1_i32 : i32
          scf.if %58 {
          ...
          %60 = arith.index_cast %arg16 : index to i32
          %61 = arith.cmpi eq, %60, %c2_i32 : i32
          scf.if %61 {
          ...
          %64 = arith.cmpi eq, %63, %c3_i32 : i32
          scf.if %64 {
            %async_token_51 = air.execute [%62] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
          }
          %65 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50]  {id = 35 : i32}
          %66 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %65) -> (!air.async.token) {
            ...
            %68 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29]  @QK2L1_0_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async [%arg29]  @QK2L1_0_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %77 = air.channel.get async [%arg29]  @QK2L1_0_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  } else {
                    %77 = air.channel.get async [%arg29]  @QK2L1_0_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  }
                  affine.yield %76 : !air.async.token
                }
              ...
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29]  @QK2L1_1_0[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async [%arg29]  @QK2L1_1_1[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
                    %77 = air.channel.get async [%arg29]  @QK2L1_1_2[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  } else {
                    %77 = air.channel.get async [%arg29]  @QK2L1_1_3[%arg27, %arg17, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %77 : !air.async.token
                  }
                  affine.yield %76 : !air.async.token
                }
            ...
            %69 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @V2L1_0_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async  @V2L1_0_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
              %74 = air.wait_all async  {id = 25 : i32}
              affine.yield %74 : !air.async.token
            }
            %70 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %69]  @V2L1_1_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %69]  @V2L1_1_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
              %74 = air.wait_all async  {id = 28 : i32}
              affine.yield %74 : !air.async.token
            }
            %71 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %70]  @V2L1_2_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %70]  @V2L1_2_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
              %74 = air.wait_all async  {id = 31 : i32}
              affine.yield %74 : !air.async.token
            }
            %72 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              %74 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async [%arg29, %71]  @V2L1_3_0[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = air.channel.get async [%arg29, %71]  @V2L1_3_1[%arg27, %arg17, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              }
              affine.yield %74 : !air.async.token
            } else {
              %74 = air.wait_all async  {id = 34 : i32}
              affine.yield %74 : !air.async.token
            }
            %async_token_52 = air.execute [%async_token_51, %68] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_59 = air.execute [%arg29, %async_token_58, %72] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %73 = air.wait_all async [%69, %70, %71, %async_token_59, %async_token_61]  {id = 36 : i32}
            scf.yield %73 : !air.async.token
          }
          %67 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
            %68 = arith.subi %arg17, %c1_45 : index
            %69 = air.channel.put async [%66]  @cascade_gp[%arg16, %68] (%arg24[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
            %70 = air.channel.put async [%66]  @cascade_up[%arg16, %68] (%arg25[] [] []) {id = 47 : i32} : (memref<64x1xbf16, 2 : i32>)
            %71 = air.channel.put async [%66]  @cascade_sp[%arg16, %68] (%arg26[] [] []) {id = 48 : i32} : (memref<64x1xbf16, 2 : i32>)
            %72 = air.wait_all async [%69, %70, %71]  {id = 41 : i32}
            affine.yield %72 : !air.async.token
          } else {
            %68 = affine.if #set8()[%arg16, %arg17] -> !air.async.token {
              ...
              %69 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %70 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %71 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_59 = air.execute [%async_token_57, %66] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_58) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_60 = air.execute [%async_token_59, %70] {
              ...
              %async_token_67 = air.execute [%async_token_63, %69] {
                func.call @mul_r_gp(%results_62, %results_52) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_68 = air.execute [%async_token_66, %66] {
              ...
              %async_token_73 = air.execute [%async_token_72, %async_token_67, %71] {
              ...
              %72 = arith.subi %arg17, %c1_45 : index
              %73 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %72] (%results_52[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %74 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %72] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %75 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %72] (%results_56[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_76 = air.execute [%73] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              } {id = 49 : i32}
              %async_token_77 = air.execute [%async_token_63] {
                memref.dealloc %results_54 : memref<64x1xbf16, 2 : i32>
              } {id = 50 : i32}
              %async_token_78 = air.execute [%75] {
                memref.dealloc %results_56 : memref<64x1xbf16, 2 : i32>
              } {id = 51 : i32}
              ...
              %76 = air.wait_all async [%73, %74, %75]  {id = 38 : i32}
              affine.yield %76 : !air.async.token
            } else {
              %async_token_51, %results_52 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %69 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %70 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %71 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %72 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_77 = air.execute [%72] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
