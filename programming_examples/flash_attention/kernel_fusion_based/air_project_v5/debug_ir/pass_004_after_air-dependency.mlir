...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x256x64xbf16>, %arg1: memref<2x512x64xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x256x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> attributes {id = 3 : i32} {
      ...
      %8 = air.channel.put async  @QK2L1[%c0, %c1_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 2 : i32} : (memref<2x256x64xbf16>)
      %9 = air.channel.put async  @QK2L1[%c0, %c2, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 3 : i32} : (memref<2x256x64xbf16>)
      %10 = air.channel.put async  @QK2L1[%c0, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %6] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 4 : i32} : (memref<2x256x64xbf16>)
      ...
      %14 = air.channel.put async  @QK2L1[%c0, %c1_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %13] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 6 : i32} : (memref<2x512x64xbf16>)
      %15 = affine.apply #map3()[%4, %c16384]
      %16 = air.channel.put async  @QK2L1[%c0, %c2, %c0] (%arg9[%c0, %c0, %c0, %c0, %15] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 7 : i32} : (memref<2x512x64xbf16>)
      %17 = affine.apply #map3()[%4, %c24576]
      %18 = air.channel.put async  @QK2L1[%c0, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %17] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 8 : i32} : (memref<2x512x64xbf16>)
      ...
      %34 = air.channel.put async  @QK2L1[%c1_0, %c1_0, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 15 : i32} : (memref<2x256x64xbf16>)
      %35 = air.channel.put async  @QK2L1[%c1_0, %c2, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 16 : i32} : (memref<2x256x64xbf16>)
      %36 = air.channel.put async  @QK2L1[%c1_0, %c3, %c0] (%arg8[%c0, %c0, %c0, %c0, %32] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 17 : i32} : (memref<2x256x64xbf16>)
      ...
      %40 = air.channel.put async  @QK2L1[%c1_0, %c1_0, %c0] (%arg9[%c0, %c0, %c0, %c0, %39] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 19 : i32} : (memref<2x512x64xbf16>)
      %41 = affine.apply #map3()[%30, %c16384]
      %42 = air.channel.put async  @QK2L1[%c1_0, %c2, %c0] (%arg9[%c0, %c0, %c0, %c0, %41] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 20 : i32} : (memref<2x512x64xbf16>)
      %43 = affine.apply #map3()[%30, %c24576]
      %44 = air.channel.put async  @QK2L1[%c1_0, %c3, %c0] (%arg9[%c0, %c0, %c0, %c0, %43] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 21 : i32} : (memref<2x512x64xbf16>)
      ...
      %54 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %66 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %71 = scf.if %69 -> (!air.async.token) {
            ...
            %91 = air.wait_all async [%async_token_54]  {id = 12 : i32}
          ...
          %76 = scf.if %74 -> (!air.async.token) {
            ...
            %91 = air.wait_all async [%async_token_54]  {id = 15 : i32}
            scf.yield %91 : !air.async.token
          } else {
          ...
          %81 = scf.if %79 -> (!air.async.token) {
            ...
            %91 = air.wait_all async [%async_token_54]  {id = 18 : i32}
            scf.yield %91 : !air.async.token
          } else {
          ...
          %86 = scf.if %84 -> (!air.async.token) {
            %async_token_54 = air.execute [%82] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
            %91 = air.wait_all async [%async_token_54]  {id = 21 : i32}
            scf.yield %91 : !air.async.token
          } else {
            %91 = air.wait_all async  {id = 22 : i32}
            scf.yield %91 : !air.async.token
          }
          %87 = air.wait_all async [%async_token_51, %async_token_52, %async_token_53]  {id = 35 : i32}
          %88 = scf.for %arg28 = %c0_49 to %c2_50 step %c1_48 iter_args(%arg29 = %87) -> (!air.async.token) {
            ...
            %async_token_56 = air.execute [%arg29, %91, %async_token_55] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_63 = air.execute [%arg29, %async_token_62, %99] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %90 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            ...
            %92 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              ...
              %94 = air.channel.get async [%async_token_54]  @cascade_gp[%arg16, %arg17] (%results_55[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %95 = air.channel.get async [%async_token_56]  @cascade_up[%arg16, %arg17] (%results_57[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %96 = air.channel.get async [%async_token_58]  @cascade_sp[%arg16, %arg17] (%results_59[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_60, %results_61 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_62 = air.execute [%async_token_60, %91] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_61) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_63 = air.execute [%async_token_62, %95] {
              ...
              %async_token_70 = air.execute [%async_token_66, %94] {
                func.call @mul_r_gp(%results_65, %results_55) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_71 = air.execute [%async_token_69, %91] {
              ...
              %async_token_76 = air.execute [%async_token_75, %async_token_70, %96] {
              ...
              %async_token_77 = air.execute [%async_token_76, %async_token_71, %91] {
              ...
              %97 = arith.subi %arg17, %c1_48 : index
              %98 = air.channel.put async [%async_token_72]  @cascade_gp[%arg16, %97] (%results_55[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %99 = air.channel.put async [%async_token_69]  @cascade_up[%arg16, %97] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %100 = air.channel.put async [%async_token_78]  @cascade_sp[%arg16, %97] (%results_59[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_79 = air.execute [%98] {
              ...
              %async_token_81 = air.execute [%100] {
              ...
              %94 = air.channel.get async [%async_token_54]  @cascade_gp[%arg16, %arg17] (%results_55[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %95 = air.channel.get async [%async_token_56]  @cascade_up[%arg16, %arg17] (%results_57[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %96 = air.channel.get async [%async_token_58]  @cascade_sp[%arg16, %arg17] (%results_59[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_60, %results_61 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %97 = air.channel.put async [%async_token_79]  @Gp2L2[%arg16, %c0_49] (%results_55[%c0_49, %c0_49, %c0_49, %c0_49] [%c8_47, %c8_47, %c8_47, %c8_47] [%c64_46, %c8_47, %c512_45, %c1_48]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_80 = air.execute [%97] {
                memref.dealloc %results_55 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
