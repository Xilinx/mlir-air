; ModuleID = 'air_project_2h_ref/attn_seg_core_2_5.peanohack.ll'
...
define void @core_2_5() local_unnamed_addr #2 {
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf216_unroll_0)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf218_unroll_0)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf217_unroll_0)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf215_unroll_0, ptr nonnull @buf214_unroll_0)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf212_unroll_0)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf214_unroll_0, ptr nonnull @buf215_unroll_0, ptr nonnull @buf212_unroll_0)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf212_unroll_0, ptr nonnull @buf217_unroll_0, ptr nonnull @buf211_unroll_0, ptr nonnull @buf210_unroll_0)
  tail call void @mul_r_gp(ptr nonnull @buf210_unroll_0, ptr nonnull @buf216_unroll_0)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf212_unroll_0, ptr nonnull @buf213_unroll_0, ptr nonnull @buf216_unroll_0)
  tail call void @accum_sp_r_s(ptr nonnull @buf218_unroll_0, ptr nonnull @buf210_unroll_0, ptr nonnull @buf211_unroll_0)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf211_unroll_0, ptr nonnull @buf218_unroll_0)
...
.preheader5:                                      ; preds = %.loopexit, %.preheader5
  ...
  %3 = getelementptr bfloat, ptr @buf216_unroll_0, i20 %2
...
.preheader4:                                      ; preds = %.preheader5, %.preheader4
  ...
  %9 = getelementptr bfloat, ptr @buf217_unroll_0, i20 %8
...
.preheader:                                       ; preds = %.preheader4, %.preheader
  ...
  %15 = getelementptr bfloat, ptr @buf218_unroll_0, i20 %14
