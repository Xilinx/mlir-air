; ModuleID = 'air_project_2h_ref/attn_seg_core_4_5.peanohack.ll'
...
define void @core_4_5() local_unnamed_addr #2 {
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf434_unroll_1)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf436_unroll_1)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf435_unroll_1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf433_unroll_1, ptr nonnull @buf432_unroll_1)
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf430_unroll_1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf432_unroll_1, ptr nonnull @buf433_unroll_1, ptr nonnull @buf430_unroll_1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf430_unroll_1, ptr nonnull @buf435_unroll_1, ptr nonnull @buf429_unroll_1, ptr nonnull @buf428_unroll_1)
  tail call void @mul_r_gp(ptr nonnull @buf428_unroll_1, ptr nonnull @buf434_unroll_1)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf430_unroll_1, ptr nonnull @buf431_unroll_1, ptr nonnull @buf434_unroll_1)
  tail call void @accum_sp_r_s(ptr nonnull @buf436_unroll_1, ptr nonnull @buf428_unroll_1, ptr nonnull @buf429_unroll_1)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf429_unroll_1, ptr nonnull @buf436_unroll_1)
...
.preheader5:                                      ; preds = %.loopexit, %.preheader5
  ...
  %3 = getelementptr bfloat, ptr @buf434_unroll_1, i20 %2
...
.preheader4:                                      ; preds = %.preheader5, %.preheader4
  ...
  %9 = getelementptr bfloat, ptr @buf435_unroll_1, i20 %8
...
.preheader:                                       ; preds = %.preheader4, %.preheader
  ...
  %15 = getelementptr bfloat, ptr @buf436_unroll_1, i20 %14
