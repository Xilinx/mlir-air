      ...
      %37 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %38 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          ...
          %47 = scf.if %46 -> (!air.async.token) {
            ...
            %48 = air.channel.put async [%45]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %39 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_9) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_1[%arg12] (%results_10[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %40 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_11) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_2[%arg12] (%results_12[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_12[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_12[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %41 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %async_token_13) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_3[%arg12] (%results_14[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_7 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_4, %c8_4, %c8_4, %c8_4] [%c8_4, %c512_3, %c64_2, %c1_5]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %42 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%async_token_15) -> !air.async.token {
          ...
          %46 = air.channel.get async [%async_token_15]  @Gp2L2[%arg16, %c0_7] (%results_16[%45, %c0_7] [%c64_2, %c64_2] [%c64_2, %c1_5]) {id = 35 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %43 = air.channel.put async [%42]  @GpOut[%arg12] (%results_16[] [] []) {id = 36 : i32} : (memref<256x64xbf16, 1 : i32>)
        %44 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %46 = scf.if %45 -> (!air.async.token) {
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
            ...
            %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %59 = air.channel.get async  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %59 : !air.async.token
            } else {
              %59 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %60 = air.channel.get async  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %60 : !air.async.token
              } else {
                %60 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %61 = air.channel.get async  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                } else {
                  %61 = air.channel.get async  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %61 : !air.async.token
                }
                affine.yield %60 : !air.async.token
              }
          ...
          %55 = air.wait_all async [%async_token_49, %async_token_50, %async_token_51]  {id = 35 : i32}
          %56 = scf.for %arg28 = %c0_47 to %c2_48 step %c1_46 iter_args(%arg29 = %55) -> (!air.async.token) {
            ...
            %58 = scf.if %45 -> (!air.async.token) {
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg29]  @QK2L1_0_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg29]  @QK2L1_0_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg29]  @QK2L1_0_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg29]  @QK2L1_0_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
              ...
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg29]  @QK2L1_1_0[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg29]  @QK2L1_1_1[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg29]  @QK2L1_1_2[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg29]  @QK2L1_1_3[%c0_47, %c0_47, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
            ...
            %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async  @V2L1_0_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async  @V2L1_0_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
            ...
            %60 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %59]  @V2L1_1_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %59]  @V2L1_1_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %61 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %60]  @V2L1_2_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %60]  @V2L1_2_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %62 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %64 = scf.if %45 -> (!air.async.token) {
                %65 = air.channel.get async [%arg29, %61]  @V2L1_3_0[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              } else {
                %65 = air.channel.get async [%arg29, %61]  @V2L1_3_1[%c0_47, %arg17, %arg16] (%arg22[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                scf.yield %65 : !air.async.token
              }
              affine.yield %64 : !air.async.token
            } else {
            ...
            %async_token_53 = air.execute [%async_token_52, %58] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_60 = air.execute [%arg29, %async_token_59, %62] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %63 = air.wait_all async [%59, %60, %61, %async_token_60, %async_token_62]  {id = 36 : i32}
          ...
          %57 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %58 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %59 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %async_token_69 = air.execute [%async_token_67, %56] {
              ...
              %63 = air.channel.put async [%async_token_70]  @cascade_gp[%arg16, %62] (%results_53[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %64 = air.channel.put async [%async_token_67]  @cascade_up[%arg16, %62] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %65 = air.channel.put async [%async_token_76]  @cascade_sp[%arg16, %62] (%results_57[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %59 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %62 = air.channel.put async [%async_token_77]  @Gp2L2[%arg16, %c0_47] (%results_53[%c0_47, %c0_47, %c0_47, %c0_47] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_44, %c8_45, %c512_43, %c1_46]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
