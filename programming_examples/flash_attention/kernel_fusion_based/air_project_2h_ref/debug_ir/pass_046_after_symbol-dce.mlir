    ...
    affine.for %arg4 = 0 to 1 {
      ...
      affine.for %arg5 = 0 to 2 {
        affine.for %arg6 = 0 to 1 {
          ...
          %973 = airrt.wait_all : !airrt.event
          %974 = airrt.alloc : memref<64x64xbf16, 1 : i32>
          %975 = airrt.wait_all : !airrt.event
          airrt.dealloc %974 : memref<64x64xbf16, 1 : i32>
          %976 = airrt.wait_all : !airrt.event
          %977 = airrt.alloc : memref<64x64xbf16, 1 : i32>
          %978 = airrt.wait_all : !airrt.event
          airrt.dealloc %977 : memref<64x64xbf16, 1 : i32>
          %979 = airrt.wait_all : !airrt.event
          %980 = airrt.alloc : memref<64x64xbf16, 1 : i32>
          %981 = airrt.wait_all : !airrt.event
          airrt.dealloc %980 : memref<64x64xbf16, 1 : i32>
          %982 = airrt.wait_all : !airrt.event
          %983 = airrt.wait_all %964 : !airrt.event
          %984 = airrt.wait_all %966 : !airrt.event
          %985 = airrt.wait_all %968 : !airrt.event
          %986 = airrt.wait_all %970 : !airrt.event
          %987 = airrt.wait_all %983 : !airrt.event
          %988 = airrt.wait_all %984 : !airrt.event
          %989 = airrt.wait_all %985 : !airrt.event
          %990 = airrt.wait_all %986 : !airrt.event
          %h = airrt.herd_load "herd_0" (%arg5) {segment_name = "attn_seg"} : (index) -> i64
          %991 = airrt.wait_all : !airrt.event
          airrt.dealloc %969 : memref<64x64xbf16, 1 : i32>
          %992 = airrt.wait_all : !airrt.event
          airrt.dealloc %967 : memref<64x64xbf16, 1 : i32>
          %993 = airrt.wait_all : !airrt.event
          airrt.dealloc %965 : memref<64x64xbf16, 1 : i32>
          %994 = airrt.wait_all : !airrt.event
          airrt.dealloc %963 : memref<64x64xbf16, 1 : i32>
          %995 = airrt.wait_all : !airrt.event
          airrt.wait_all %972, %975, %978, %981, %991, %992, %993, %994, %995 {air.segment_end}
        }
      }
