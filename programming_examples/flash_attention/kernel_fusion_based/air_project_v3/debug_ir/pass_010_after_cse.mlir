      ...
      %37 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %38 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          ...
          %47 = scf.if %46 -> (!air.async.token) {
            ...
            %48 = air.channel.put async [%45]  @V2L1_0_1[%c0_6, %c0_6, %c0_6] (%results[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %39 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %async_token_8) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_1[%arg12] (%results_9[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_6 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_1_0[%c0_6, %c0_6, %c0_6] (%results_9[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_1_1[%c0_6, %c0_6, %c0_6] (%results_9[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %40 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %async_token_10) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_2[%arg12] (%results_11[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_6 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_2_0[%c0_6, %c0_6, %c0_6] (%results_11[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_2_1[%c0_6, %c0_6, %c0_6] (%results_11[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %41 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %async_token_12) -> (!air.async.token) {
          %45 = air.channel.get async [%arg17]  @VIn_3[%arg12] (%results_13[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
          %46 = arith.cmpi eq, %arg12, %c0_6 : index
          %47 = scf.if %46 -> (!air.async.token) {
            %48 = air.channel.put async [%45]  @V2L1_3_0[%c0_6, %c0_6, %c0_6] (%results_13[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          } else {
            %48 = air.channel.put async [%45]  @V2L1_3_1[%c0_6, %c0_6, %c0_6] (%results_13[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %48 : !air.async.token
          }
          scf.yield %47 : !air.async.token
        }
        %42 = scf.parallel (%arg16) = (%c0_6) to (%c4_7) step (%c1_4) init (%async_token_14) -> !air.async.token {
          ...
          %46 = air.channel.get async [%async_token_14]  @Gp2L2[%arg16, %c0_6] (%results_15[%45, %c0_6] [%c64_1, %c64_1] [%c64_1, %c1_4]) {id = 35 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %43 = air.channel.put async [%42]  @GpOut[%arg12] (%results_15[] [] []) {id = 36 : i32} : (memref<256x64xbf16, 1 : i32>)
        %44 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %45 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %46 = affine.if #set2()[%arg16] -> !air.async.token {
            ...
            %56 = air.wait_all async  {id = 13 : i32}
            affine.yield %56 : !air.async.token
          }
          %47 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%46]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%46]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%46]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%46]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%46]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%46]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%46]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%46]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %48 = affine.if #set3()[%arg16] -> !air.async.token {
            ...
            %56 = air.wait_all async  {id = 16 : i32}
            affine.yield %56 : !air.async.token
          }
          %49 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%48]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%48]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%48]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%48]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%48]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%48]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%48]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%48]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %50 = affine.if #set4()[%arg16] -> !air.async.token {
            ...
            %56 = air.wait_all async  {id = 19 : i32}
            affine.yield %56 : !air.async.token
          }
          %51 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%50]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%50]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%50]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%50]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
            ...
            %56 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %57 = air.channel.get async [%50]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %57 : !air.async.token
            } else {
              %57 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %58 = air.channel.get async [%50]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %58 : !air.async.token
              } else {
                %58 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %59 = air.channel.get async [%50]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                } else {
                  %59 = air.channel.get async [%50]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %59 : !air.async.token
                }
                affine.yield %58 : !air.async.token
              }
          ...
          %52 = affine.if #set5()[%arg16] -> !air.async.token {
            ...
            %56 = air.wait_all async  {id = 22 : i32}
            affine.yield %56 : !air.async.token
          }
          %53 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50, %52]  {id = 35 : i32}
          %54 = scf.for %arg28 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg29 = %53) -> (!air.async.token) {
            ...
            %56 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg29]  @QK2L1_0_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async [%arg29]  @QK2L1_0_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                    %65 = air.channel.get async [%arg29]  @QK2L1_0_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %65 : !air.async.token
                  } else {
                    %65 = air.channel.get async [%arg29]  @QK2L1_0_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %65 : !air.async.token
                  }
                  affine.yield %64 : !air.async.token
                }
              ...
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg29]  @QK2L1_1_0[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async [%arg29]  @QK2L1_1_1[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                    %65 = air.channel.get async [%arg29]  @QK2L1_1_2[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %65 : !air.async.token
                  } else {
                    %65 = air.channel.get async [%arg29]  @QK2L1_1_3[%arg27, %arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %65 : !air.async.token
                  }
                  affine.yield %64 : !air.async.token
                }
            ...
            %57 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %62 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @V2L1_0_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = air.channel.get async  @V2L1_0_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              }
              affine.yield %62 : !air.async.token
            } else {
            ...
            %58 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              %62 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg29, %57]  @V2L1_1_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = air.channel.get async [%arg29, %57]  @V2L1_1_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              }
              affine.yield %62 : !air.async.token
            } else {
            ...
            %59 = affine.if #set8()[%arg16, %arg17] -> !air.async.token {
              %62 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg29, %58]  @V2L1_2_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = air.channel.get async [%arg29, %58]  @V2L1_2_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              }
              affine.yield %62 : !air.async.token
            } else {
            ...
            %60 = affine.if #set9()[%arg16, %arg17] -> !air.async.token {
              %62 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg29, %59]  @V2L1_3_0[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = air.channel.get async [%arg29, %59]  @V2L1_3_1[%arg27, %arg16, %arg17] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              }
              affine.yield %62 : !air.async.token
            } else {
            ...
            %async_token_59 = air.execute [%arg29, %async_token_58, %60] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %61 = air.wait_all async [%57, %58, %59, %async_token_59, %async_token_61]  {id = 36 : i32}
            scf.yield %61 : !air.async.token
          }
          %55 = affine.if #set9()[%arg16, %arg17] -> !air.async.token {
            %56 = arith.subi %arg17, %c1_45 : index
            %57 = air.channel.put async [%54]  @cascade_gp[%arg16, %56] (%arg24[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
            %58 = air.channel.put async [%54]  @cascade_up[%arg16, %56] (%arg25[] [] []) {id = 47 : i32} : (memref<64x1xbf16, 2 : i32>)
            %59 = air.channel.put async [%54]  @cascade_sp[%arg16, %56] (%arg26[] [] []) {id = 48 : i32} : (memref<64x1xbf16, 2 : i32>)
            %60 = air.wait_all async [%57, %58, %59]  {id = 41 : i32}
            ...
            %56 = affine.if #set10()[%arg16, %arg17] -> !air.async.token {
              ...
              %57 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %58 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %59 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %async_token_68 = air.execute [%async_token_66, %54] {
              ...
              %61 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %60] (%results_52[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %62 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %60] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %63 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %60] (%results_56[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %64 = air.wait_all async [%61, %62, %63]  {id = 38 : i32}
              affine.yield %64 : !air.async.token
            } else {
              %async_token_51, %results_52 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %57 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %58 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %59 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %60 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
