    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x64xbf16>, memref<2x512x64xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> attributes {id = 3 : i32} {
      ...
      %54 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %56 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %55) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_0[%arg12, %c0_45, %c0_45] (%results[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_46, %c8_46, %c8_46, %c8_46] [%c8_46, %c512_47, %c64_48, %c1_49]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %58 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %57) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_1[%arg12, %c0_45, %c0_45] (%results_9[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_46, %c8_46, %c8_46, %c8_46] [%c8_46, %c512_47, %c64_48, %c1_49]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %60 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %59) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_2[%arg12, %c0_45, %c0_45] (%results_11[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_46, %c8_46, %c8_46, %c8_46] [%c8_46, %c512_47, %c64_48, %c1_49]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %62 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %61) -> (!air.async.token) {
          ...
          %68 = air.channel.put async [%arg17, %67]  @V2L1_3[%arg12, %c0_45, %c0_45] (%results_13[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_46, %c8_46, %c8_46, %c8_46] [%c8_46, %c512_47, %c64_48, %c1_49]) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %64 = scf.parallel (%arg16) = (%c0_30) to (%c4_31) step (%c1_32) init (%63) -> !air.async.token {
          %c0_45 = arith.constant 0 : index
          %c64_46 = arith.constant 64 : index
          %c1_47 = arith.constant 1 : index
          %67 = affine.apply #map5()[%arg16]
          %68 = air.channel.get async [%63]  @Gp2L2[%arg16, %c0_45] (%results_15[%67, %c0_45] [%c64_46, %c64_46] [%c64_46, %c1_47]) {id = 35 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %66 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29, %arg27=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %69 = affine.if #set()[%arg16] -> !air.async.token {
            %async_token_54 = air.execute [%68] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 16 : i32}
            %83 = air.wait_all async [%async_token_54]  {id = 12 : i32}
            affine.yield %83 : !air.async.token
          } else {
            %83 = air.wait_all async  {id = 13 : i32}
            affine.yield %83 : !air.async.token
          }
          %70 = air.channel.get async [%69]  @QK2L1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 38 : i32} : (memref<64x64xbf16, 2 : i32>)
          %71 = air.wait_all async [%70, %70]  {id = 14 : i32}
          %72 = affine.if #set1()[%arg16] -> !air.async.token {
            %async_token_54 = air.execute [%71] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 17 : i32}
            %83 = air.wait_all async [%async_token_54]  {id = 15 : i32}
            affine.yield %83 : !air.async.token
          } else {
            %83 = air.wait_all async  {id = 16 : i32}
            affine.yield %83 : !air.async.token
          }
          %73 = air.channel.get async [%72]  @QK2L1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
          %74 = air.wait_all async [%73, %73]  {id = 17 : i32}
          %75 = affine.if #set2()[%arg16] -> !air.async.token {
            %async_token_54 = air.execute [%74] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
            %83 = air.wait_all async [%async_token_54]  {id = 18 : i32}
            affine.yield %83 : !air.async.token
          } else {
            %83 = air.wait_all async  {id = 19 : i32}
            affine.yield %83 : !air.async.token
          }
          %76 = air.channel.get async [%75]  @QK2L1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 40 : i32} : (memref<64x64xbf16, 2 : i32>)
          %77 = air.wait_all async [%76, %76]  {id = 20 : i32}
          %78 = affine.if #set3()[%arg16] -> !air.async.token {
            %async_token_54 = air.execute [%77] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
            %83 = air.wait_all async [%async_token_54]  {id = 21 : i32}
            affine.yield %83 : !air.async.token
          } else {
            %83 = air.wait_all async  {id = 22 : i32}
            affine.yield %83 : !air.async.token
          }
          %79 = air.wait_all async [%async_token_51, %async_token_52, %async_token_53, %78]  {id = 35 : i32}
          %80 = scf.for %arg28 = %c0_49 to %c2_50 step %c1_48 iter_args(%arg29 = %79) -> (!air.async.token) {
            %c0_i32_54 = arith.constant 0 : i32
            %async_token_55 = air.execute [%arg29] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
              func.call @zero_fill_g_bf16(%collapse_shape) : (memref<4096xbf16, 2 : i32>) -> ()
            } {id = 20 : i32}
            %83 = air.channel.get async [%arg29]  @QK2L1[%arg27, %arg16, %arg17] (%arg21[] [] []) {id = 41 : i32} : (memref<64x64xbf16, 2 : i32>)
            %84 = air.wait_all async [%arg29]  {id = 23 : i32}
            %85 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %93 = air.channel.get async  @V2L1_0[%arg27, %arg16, %arg17] (%arg22[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
            ...
            %87 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %93 = air.channel.get async [%86]  @V2L1_1[%arg27, %arg16, %arg17] (%arg22[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
            ...
            %89 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %93 = air.channel.get async [%88]  @V2L1_2[%arg27, %arg16, %arg17] (%arg22[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
            ...
            %91 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              %93 = air.channel.get async [%90]  @V2L1_3[%arg27, %arg16, %arg17] (%arg22[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
            ...
            %async_token_56 = air.execute [%arg29, %83, %async_token_55] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_61 = air.execute [%async_token_59, %async_token_57, %async_token_56, %arg29] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_62 = air.execute [%async_token_61, %arg29] {
              func.call @mul_r_gp(%results_60, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 25 : i32}
            %async_token_63 = air.execute [%arg29, %async_token_62, %91] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %92 = air.wait_all async [%84, %86, %88, %90, %async_token_63, %async_token_65]  {id = 36 : i32}
            scf.yield %92 : !air.async.token
          }
          %81 = air.wait_all async [%80, %80]  {id = 40 : i32}
          %82 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
            %83 = arith.subi %arg17, %c1_48 : index
            ...
            %84 = affine.if #set8()[%arg16, %arg17] -> !air.async.token {
              ...
              %86 = air.channel.get async [%async_token_54]  @cascade_gp[%arg16, %arg17] (%results_55[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
              %87 = air.channel.get async [%async_token_56]  @cascade_up[%arg16, %arg17] (%results_57[] [] []) {id = 50 : i32} : (memref<64x1xbf16, 2 : i32>)
              %88 = air.channel.get async [%async_token_58]  @cascade_sp[%arg16, %arg17] (%results_59[] [] []) {id = 51 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_60, %results_61 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_62 = air.execute [%async_token_60, %83] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_61) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_63 = air.execute [%async_token_62, %87] {
              ...
              %async_token_70 = air.execute [%async_token_66, %86] {
                func.call @mul_r_gp(%results_65, %results_55) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_71 = air.execute [%async_token_69, %83] {
              ...
              %async_token_76 = air.execute [%async_token_75, %async_token_70, %88] {
              ...
              %async_token_77 = air.execute [%async_token_76, %async_token_71, %83] {
              ...
              %89 = arith.subi %arg17, %c1_48 : index
              %90 = air.channel.put async [%async_token_72]  @cascade_gp[%arg16, %89] (%results_55[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
              %91 = air.channel.put async [%async_token_69]  @cascade_up[%arg16, %89] (%arg25[] [] []) {id = 53 : i32} : (memref<64x1xbf16, 2 : i32>)
              %92 = air.channel.put async [%async_token_78]  @cascade_sp[%arg16, %89] (%results_59[] [] []) {id = 54 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_79 = air.execute [%90] {
              ...
              %86 = air.channel.get async [%async_token_54]  @cascade_gp[%arg16, %arg17] (%results_55[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              %87 = air.channel.get async [%async_token_56]  @cascade_up[%arg16, %arg17] (%results_57[] [] []) {id = 56 : i32} : (memref<64x1xbf16, 2 : i32>)
              %88 = air.channel.get async [%async_token_58]  @cascade_sp[%arg16, %arg17] (%results_59[] [] []) {id = 57 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_60, %results_61 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %89 = air.channel.put async [%async_token_79]  @Gp2L2[%arg16, %c0_49] (%results_55[%c0_49, %c0_49, %c0_49, %c0_49] [%c8_47, %c8_47, %c8_47, %c8_47] [%c64_46, %c8_47, %c512_45, %c1_48]) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_80 = air.execute [%89] {
                memref.dealloc %results_55 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
        ...
        %async_token_43 = air.execute [%62] {
          memref.dealloc %results_13 : memref<64x64xbf16, 1 : i32>
        } {id = 92 : i32}
        %async_token_44 = air.execute [%65] {
