; ModuleID = 'air_project_1h_ref/attn_seg_core_0_3.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf77)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf79)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf78)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf76, ptr nonnull @buf75)
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf73)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf75, ptr nonnull @buf76, ptr nonnull @buf73)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf73, ptr nonnull @buf78, ptr nonnull @buf72, ptr nonnull @buf71)
  tail call void @mul_r_gp(ptr nonnull @buf71, ptr nonnull @buf77)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf73, ptr nonnull @buf74, ptr nonnull @buf77)
  tail call void @accum_sp_r_s(ptr nonnull @buf79, ptr nonnull @buf71, ptr nonnull @buf72)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf72, ptr nonnull @buf79)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf70, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf69, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf68, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf78, ptr nonnull @buf67)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf69, ptr nonnull @buf78)
  tail call void @exp_up_minus_u(ptr nonnull @buf69, ptr nonnull @buf78, ptr nonnull @buf66)
  tail call void @exp_up_minus_u(ptr nonnull @buf67, ptr nonnull @buf78, ptr nonnull @buf65)
  tail call void @mul_r_gp(ptr nonnull @buf66, ptr nonnull @buf70)
  tail call void @mul_r_gp(ptr nonnull @buf65, ptr nonnull @buf77)
  tail call void @add_gp_g(ptr nonnull @buf77, ptr nonnull @buf70)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf64)
  tail call void @accum_sp_r_s(ptr nonnull @buf68, ptr nonnull @buf66, ptr nonnull @buf64)
  tail call void @accum_sp_r_s(ptr nonnull @buf79, ptr nonnull @buf65, ptr nonnull @buf64)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf64, ptr nonnull @buf68)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf70, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf78, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf68, i20 %34
