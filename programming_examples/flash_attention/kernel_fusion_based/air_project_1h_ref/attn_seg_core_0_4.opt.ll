; ModuleID = 'air_project_1h_ref/attn_seg_core_0_4.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf141)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf143)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf142)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf140, ptr nonnull @buf139)
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf137)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf139, ptr nonnull @buf140, ptr nonnull @buf137)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf137, ptr nonnull @buf142, ptr nonnull @buf136, ptr nonnull @buf135)
  tail call void @mul_r_gp(ptr nonnull @buf135, ptr nonnull @buf141)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf137, ptr nonnull @buf138, ptr nonnull @buf141)
  tail call void @accum_sp_r_s(ptr nonnull @buf143, ptr nonnull @buf135, ptr nonnull @buf136)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf136, ptr nonnull @buf143)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf134, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf133, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf132, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf142, ptr nonnull @buf131)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf133, ptr nonnull @buf142)
  tail call void @exp_up_minus_u(ptr nonnull @buf133, ptr nonnull @buf142, ptr nonnull @buf130)
  tail call void @exp_up_minus_u(ptr nonnull @buf131, ptr nonnull @buf142, ptr nonnull @buf129)
  tail call void @mul_r_gp(ptr nonnull @buf130, ptr nonnull @buf134)
  tail call void @mul_r_gp(ptr nonnull @buf129, ptr nonnull @buf141)
  tail call void @add_gp_g(ptr nonnull @buf141, ptr nonnull @buf134)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf128)
  tail call void @accum_sp_r_s(ptr nonnull @buf132, ptr nonnull @buf130, ptr nonnull @buf128)
  tail call void @accum_sp_r_s(ptr nonnull @buf143, ptr nonnull @buf129, ptr nonnull @buf128)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf128, ptr nonnull @buf132)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf134, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf142, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf132, i20 %34
