...
module {
  aie.device(npu2) @attn_seg {
    ...
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf223, %buf224, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_3_5_62, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf226, %buf220, %buf219) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf219, %buf225) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf222, %buf225) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
    ...
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf225 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      %5 = vector.load %collapse_shape_64[%3] : memref<4096xbf16, 2 : i32>, vector<32xbf16>
      aie.put_cascade(%5 : vector<32xbf16>)
      %6 = arith.addi %3, %c32 : index
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf226 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      %9 = vector.load %collapse_shape_65[%7] : memref<64xbf16, 2 : i32>, vector<32xbf16>
      aie.put_cascade(%9 : vector<32xbf16>)
      %10 = arith.addi %7, %c32 : index
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf227 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ^bb12:  // pred: ^bb11
      %13 = vector.load %collapse_shape_66[%11] : memref<64xbf16, 2 : i32>, vector<32xbf16>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_2_5_60, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_2_5_59, Release, 1)
      %collapse_shape = memref.collapse_shape %buf212 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf214, %buf215, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_2_5_59, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf217, %buf211, %buf210) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf210, %buf216) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf213, %buf216) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf216 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf217 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf218 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_1_5_57, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_1_5_56, Release, 1)
      %collapse_shape = memref.collapse_shape %buf203 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf205, %buf206, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_1_5_56, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf208, %buf202, %buf201) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf201, %buf207) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf204, %buf207) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf207 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf208 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf209 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_0_5_54, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_0_5_53, Release, 1)
      %collapse_shape = memref.collapse_shape %buf194 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf196, %buf197, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_5_53, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf199, %buf193, %buf192) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf192, %buf198) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf195, %buf198) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf198 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf199 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf200 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf187, %buf188, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_3_4_50, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf190, %buf184, %buf183) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf183, %buf189) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf186, %buf189) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf182 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      vector.store %5, %collapse_shape_64[%3] : memref<4096xbf16, 2 : i32>, vector<32xbf16>
      %6 = arith.addi %3, %c32 : index
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf181 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      vector.store %9, %collapse_shape_65[%7] : memref<64xbf16, 2 : i32>, vector<32xbf16>
      %10 = arith.addi %7, %c32 : index
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf180 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ^bb12:  // pred: ^bb11
      ...
      vector.store %13, %collapse_shape_66[%11] : memref<64xbf16, 2 : i32>, vector<32xbf16>
      %14 = arith.addi %11, %c32 : index
      cf.br ^bb11(%14 : index)
    ^bb13:  // pred: ^bb11
    ...
    ^bb15:  // pred: ^bb14
      %17 = vector.load %collapse_shape_64[%15] : memref<4096xbf16, 2 : i32>, vector<32xbf16>
    ...
    ^bb18:  // pred: ^bb17
      %21 = vector.load %collapse_shape_67[%19] : memref<64xbf16, 2 : i32>, vector<32xbf16>
    ...
    ^bb21:  // pred: ^bb20
      %25 = vector.load %collapse_shape_66[%23] : memref<64xbf16, 2 : i32>, vector<32xbf16>
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb22
      ...
      aie.use_lock(%lock_2_4_48, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_2_4_47, Release, 1)
      %collapse_shape = memref.collapse_shape %buf169 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf171, %buf172, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_2_4_47, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf174, %buf168, %buf167) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf167, %buf173) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf170, %buf173) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf166 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf165 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf164 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb3:  // pred: ^bb2
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf150 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf149 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf148 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb22
      ...
      aie.use_lock(%lock_0_4_42, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_0_4_41, Release, 1)
      %collapse_shape = memref.collapse_shape %buf137 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf139, %buf140, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_4_41, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf142, %buf136, %buf135) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf135, %buf141) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf138, %buf141) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf134 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf133 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf132 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb22
      ...
      aie.use_lock(%lock_3_3_38, Release, 1)
      %collapse_shape = memref.collapse_shape %buf121 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf123, %buf124, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_3_3_38, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf126, %buf120, %buf119) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf119, %buf125) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf122, %buf125) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf118 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf117 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb22
      ...
      aie.use_lock(%lock_2_3_36, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_2_3_35, Release, 1)
      %collapse_shape = memref.collapse_shape %buf105 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf107, %buf108, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_2_3_35, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf110, %buf104, %buf103) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf103, %buf109) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf106, %buf109) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf102 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf101 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf100 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf91, %buf92, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_1_3_32, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf94, %buf88, %buf87) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf87, %buf93) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf90, %buf93) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf86 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf85 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf84 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb3:  // pred: ^bb2
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf70 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf69 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf68 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf59, %buf60, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_3_2_24, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf62, %buf56, %buf55) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf55, %buf61) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf58, %buf61) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf54 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf53 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf52 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_2_2_20, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_2_2_19, Release, 1)
      %collapse_shape = memref.collapse_shape %buf41 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf43, %buf44, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_2_2_19, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf46, %buf40, %buf39) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf39, %buf45) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf42, %buf45) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf38 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf37 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf36 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_1_2_15, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_1_2_14, Release, 1)
      %collapse_shape = memref.collapse_shape %buf25 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf27, %buf28, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_1_2_14, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf30, %buf24, %buf23) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf23, %buf29) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf26, %buf29) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf22 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf21 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf20 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb13
      ...
      aie.use_lock(%lock_0_2_10, AcquireGreaterEqual, 1)
      aie.use_lock(%lock_0_2_9, Release, 1)
      %collapse_shape = memref.collapse_shape %buf9 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb2(%c0 : index)
    ^bb2(%0: index):  // 2 preds: ^bb1, ^bb3
      %1 = arith.cmpi slt, %0, %c2 : index
      cf.cond_br %1, ^bb3, ^bb4
    ^bb3:  // pred: ^bb2
      ...
      func.call @matmul_a_b_bf16(%buf11, %buf12, %collapse_shape) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<4096xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_2_9, Release, 1)
      func.call @fused_softmax(%collapse_shape, %buf14, %buf8, %buf7) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
      func.call @mul_r_gp(%buf7, %buf13) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      func.call @matmul_g_b_bf16(%collapse_shape, %buf10, %buf13) : (memref<4096xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
      ...
      cf.br ^bb2(%2 : index) {loop_annotation = #loop_annotation}
    ^bb4:  // pred: ^bb2
      %collapse_shape_64 = memref.collapse_shape %buf6 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
      cf.br ^bb5(%c0 : index)
    ^bb5(%3: index):  // 2 preds: ^bb4, ^bb6
      %4 = arith.cmpi slt, %3, %c4096 : index
      cf.cond_br %4, ^bb6, ^bb7
    ^bb6:  // pred: ^bb5
      ...
      cf.br ^bb5(%6 : index)
    ^bb7:  // pred: ^bb5
      %collapse_shape_65 = memref.collapse_shape %buf5 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb8(%c0 : index)
    ^bb8(%7: index):  // 2 preds: ^bb7, ^bb9
      %8 = arith.cmpi slt, %7, %c64 : index
      cf.cond_br %8, ^bb9, ^bb10
    ^bb9:  // pred: ^bb8
      ...
      cf.br ^bb8(%10 : index)
    ^bb10:  // pred: ^bb8
      %collapse_shape_66 = memref.collapse_shape %buf4 [[0, 1]] : memref<64x1xbf16, 2 : i32> into memref<64xbf16, 2 : i32>
      cf.br ^bb11(%c0 : index)
    ^bb11(%11: index):  // 2 preds: ^bb10, ^bb12
      %12 = arith.cmpi slt, %11, %c64 : index
      cf.cond_br %12, ^bb12, ^bb13
    ...
    aie.runtime_sequence @attn_seg_sequence(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
      %0 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 0, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @air_QK2L1_1 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @air_QK2L1_1 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 8192, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 16384, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 24576, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 0, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 8192, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 16384, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 24576, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      }
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%12)
      %13 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 4096, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%13)
      %14 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 8192, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%14)
      %15 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 12288, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      ...
      %16 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 16384, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 0, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %20 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 16384, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%20)
      %21 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 16384, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %28 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 16384, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%28)
      %29 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 20480, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%29)
      %30 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 24576, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%30)
      %31 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 28672, 4096, [<size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
  ...
  aie.device(npu2) {
    aie.runtime_sequence @attention_bf16(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
      aiex.configure @attn_seg {
        aiex.run @attn_seg_sequence(%arg0, %arg1, %arg2, %arg3) : (memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>)
      }
    }
  }
}
