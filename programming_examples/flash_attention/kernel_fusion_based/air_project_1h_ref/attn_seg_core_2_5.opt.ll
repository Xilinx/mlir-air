; ModuleID = 'air_project_1h_ref/attn_seg_core_2_5.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf216)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf218)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf217)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf215, ptr nonnull @buf214)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf212)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf214, ptr nonnull @buf215, ptr nonnull @buf212)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf212, ptr nonnull @buf217, ptr nonnull @buf211, ptr nonnull @buf210)
  tail call void @mul_r_gp(ptr nonnull @buf210, ptr nonnull @buf216)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf212, ptr nonnull @buf213, ptr nonnull @buf216)
  tail call void @accum_sp_r_s(ptr nonnull @buf218, ptr nonnull @buf210, ptr nonnull @buf211)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf211, ptr nonnull @buf218)
...
.preheader5:                                      ; preds = %.loopexit, %.preheader5
  ...
  %3 = getelementptr bfloat, ptr @buf216, i20 %2
...
.preheader4:                                      ; preds = %.preheader5, %.preheader4
  ...
  %9 = getelementptr bfloat, ptr @buf217, i20 %8
...
.preheader:                                       ; preds = %.preheader4, %.preheader
  ...
  %15 = getelementptr bfloat, ptr @buf218, i20 %14
