; ModuleID = 'air_project_1h_ref/attn_seg_core_1_4.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf157)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf159)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf158)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf156, ptr nonnull @buf155)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf153)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf155, ptr nonnull @buf156, ptr nonnull @buf153)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf153, ptr nonnull @buf158, ptr nonnull @buf152, ptr nonnull @buf151)
  tail call void @mul_r_gp(ptr nonnull @buf151, ptr nonnull @buf157)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf153, ptr nonnull @buf154, ptr nonnull @buf157)
  tail call void @accum_sp_r_s(ptr nonnull @buf159, ptr nonnull @buf151, ptr nonnull @buf152)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf152, ptr nonnull @buf159)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf150, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf149, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf148, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf158, ptr nonnull @buf147)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf149, ptr nonnull @buf158)
  tail call void @exp_up_minus_u(ptr nonnull @buf149, ptr nonnull @buf158, ptr nonnull @buf146)
  tail call void @exp_up_minus_u(ptr nonnull @buf147, ptr nonnull @buf158, ptr nonnull @buf145)
  tail call void @mul_r_gp(ptr nonnull @buf146, ptr nonnull @buf150)
  tail call void @mul_r_gp(ptr nonnull @buf145, ptr nonnull @buf157)
  tail call void @add_gp_g(ptr nonnull @buf157, ptr nonnull @buf150)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf144)
  tail call void @accum_sp_r_s(ptr nonnull @buf148, ptr nonnull @buf146, ptr nonnull @buf144)
  tail call void @accum_sp_r_s(ptr nonnull @buf159, ptr nonnull @buf145, ptr nonnull @buf144)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf144, ptr nonnull @buf148)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf150, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf158, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf148, i20 %34
