; ModuleID = 'air_project_1h_ref/attn_seg_core_3_3.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf125)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf127)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf126)
  ...
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf124, ptr nonnull @buf123)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf121)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf123, ptr nonnull @buf124, ptr nonnull @buf121)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf121, ptr nonnull @buf126, ptr nonnull @buf120, ptr nonnull @buf119)
  tail call void @mul_r_gp(ptr nonnull @buf119, ptr nonnull @buf125)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf121, ptr nonnull @buf122, ptr nonnull @buf125)
  tail call void @accum_sp_r_s(ptr nonnull @buf127, ptr nonnull @buf119, ptr nonnull @buf120)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf120, ptr nonnull @buf127)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf118, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf117, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf116, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf126, ptr nonnull @buf115)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf117, ptr nonnull @buf126)
  tail call void @exp_up_minus_u(ptr nonnull @buf117, ptr nonnull @buf126, ptr nonnull @buf114)
  tail call void @exp_up_minus_u(ptr nonnull @buf115, ptr nonnull @buf126, ptr nonnull @buf113)
  tail call void @mul_r_gp(ptr nonnull @buf114, ptr nonnull @buf118)
  tail call void @mul_r_gp(ptr nonnull @buf113, ptr nonnull @buf125)
  tail call void @add_gp_g(ptr nonnull @buf125, ptr nonnull @buf118)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf112)
  tail call void @accum_sp_r_s(ptr nonnull @buf116, ptr nonnull @buf114, ptr nonnull @buf112)
  tail call void @accum_sp_r_s(ptr nonnull @buf127, ptr nonnull @buf113, ptr nonnull @buf112)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf112, ptr nonnull @buf116)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf118, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf126, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf116, i20 %34
