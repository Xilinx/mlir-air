; ModuleID = 'air_project_1h_ref/attn_seg_core_2_4.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf173)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf175)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf174)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf172, ptr nonnull @buf171)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf169)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf171, ptr nonnull @buf172, ptr nonnull @buf169)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf169, ptr nonnull @buf174, ptr nonnull @buf168, ptr nonnull @buf167)
  tail call void @mul_r_gp(ptr nonnull @buf167, ptr nonnull @buf173)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf169, ptr nonnull @buf170, ptr nonnull @buf173)
  tail call void @accum_sp_r_s(ptr nonnull @buf175, ptr nonnull @buf167, ptr nonnull @buf168)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf168, ptr nonnull @buf175)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf166, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf165, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf164, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf174, ptr nonnull @buf163)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf165, ptr nonnull @buf174)
  tail call void @exp_up_minus_u(ptr nonnull @buf165, ptr nonnull @buf174, ptr nonnull @buf162)
  tail call void @exp_up_minus_u(ptr nonnull @buf163, ptr nonnull @buf174, ptr nonnull @buf161)
  tail call void @mul_r_gp(ptr nonnull @buf162, ptr nonnull @buf166)
  tail call void @mul_r_gp(ptr nonnull @buf161, ptr nonnull @buf173)
  tail call void @add_gp_g(ptr nonnull @buf173, ptr nonnull @buf166)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf160)
  tail call void @accum_sp_r_s(ptr nonnull @buf164, ptr nonnull @buf162, ptr nonnull @buf160)
  tail call void @accum_sp_r_s(ptr nonnull @buf175, ptr nonnull @buf161, ptr nonnull @buf160)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf160, ptr nonnull @buf164)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf166, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf174, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf164, i20 %34
