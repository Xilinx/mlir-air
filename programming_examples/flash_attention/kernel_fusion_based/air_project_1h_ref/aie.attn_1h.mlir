    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16> attributes {id = 1 : i32} {
      ...
      %18 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_1, %arg15=%c1_1) attributes {id = 2 : i32, x_loc = 0 : i64, x_size = 8 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %23 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %19) -> (!air.async.token) {
          ...
          %37 = air.channel.put async [%36]  @V2L1_0[%c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %24 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %20) -> (!air.async.token) {
          ...
          %37 = air.channel.put async [%36]  @V2L1_1[%c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
          %async_token_21 = air.execute [%37] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
          }
          scf.yield %37 : !air.async.token
        ...
        %25 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %21) -> (!air.async.token) {
          ...
          %37 = air.channel.put async [%36]  @V2L1_2[%c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
          %async_token_21 = air.execute [%37] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
          }
          scf.yield %37 : !air.async.token
        ...
        %26 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %22) -> (!air.async.token) {
          ...
          %37 = air.channel.put async [%36]  @V2L1_3[%c0_7, %c0_7] (%results_20[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
          %async_token_21 = air.execute [%37] {
            memref.dealloc %results_20 : memref<64x64xbf16, 1 : i32>
          }
          scf.yield %37 : !air.async.token
        }
        %27 = air.channel.get async [%async_token]  @Gp2L2[%c0_7, %c0_7] (%results[] [] []) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
        %28 = air.channel.get async [%async_token_9]  @Gp2L2[%c1_5, %c0_7] (%results_10[] [] []) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
        %29 = air.channel.get async [%async_token_11]  @Gp2L2[%c2_6, %c0_7] (%results_12[] [] []) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
        %30 = air.channel.get async [%async_token_13]  @Gp2L2[%c3_2, %c0_7] (%results_14[] [] []) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
        %31 = air.channel.put async [%27]  @channel_0[%c0_7, %c0_7] (%results[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
        %32 = air.channel.put async [%28]  @channel_0[%c1_5, %c0_7] (%results_10[] [] []) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
        %33 = air.channel.put async [%29]  @channel_0[%c2_6, %c0_7] (%results_12[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
        %34 = air.channel.put async [%30]  @channel_0[%c3_2, %c0_7] (%results_14[] [] []) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
        %35 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) attributes {id = 3 : i32, link_with = "attn.o", x_loc = 0 : i64, y_loc = 2 : i64} {
