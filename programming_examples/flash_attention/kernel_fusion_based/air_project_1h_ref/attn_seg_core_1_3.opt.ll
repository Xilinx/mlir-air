; ModuleID = 'air_project_1h_ref/attn_seg_core_1_3.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf93)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf95)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf94)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf92, ptr nonnull @buf91)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf89)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf91, ptr nonnull @buf92, ptr nonnull @buf89)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf89, ptr nonnull @buf94, ptr nonnull @buf88, ptr nonnull @buf87)
  tail call void @mul_r_gp(ptr nonnull @buf87, ptr nonnull @buf93)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf89, ptr nonnull @buf90, ptr nonnull @buf93)
  tail call void @accum_sp_r_s(ptr nonnull @buf95, ptr nonnull @buf87, ptr nonnull @buf88)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf88, ptr nonnull @buf95)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf86, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf85, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf84, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf94, ptr nonnull @buf83)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf85, ptr nonnull @buf94)
  tail call void @exp_up_minus_u(ptr nonnull @buf85, ptr nonnull @buf94, ptr nonnull @buf82)
  tail call void @exp_up_minus_u(ptr nonnull @buf83, ptr nonnull @buf94, ptr nonnull @buf81)
  tail call void @mul_r_gp(ptr nonnull @buf82, ptr nonnull @buf86)
  tail call void @mul_r_gp(ptr nonnull @buf81, ptr nonnull @buf93)
  tail call void @add_gp_g(ptr nonnull @buf93, ptr nonnull @buf86)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf80)
  tail call void @accum_sp_r_s(ptr nonnull @buf84, ptr nonnull @buf82, ptr nonnull @buf80)
  tail call void @accum_sp_r_s(ptr nonnull @buf95, ptr nonnull @buf81, ptr nonnull @buf80)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf80, ptr nonnull @buf84)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf86, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf94, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf84, i20 %34
