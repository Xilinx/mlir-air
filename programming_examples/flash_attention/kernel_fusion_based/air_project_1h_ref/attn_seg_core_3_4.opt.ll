; ModuleID = 'air_project_1h_ref/attn_seg_core_3_4.peanohack.ll'
...
.loopexit:                                        ; preds = %.preheader, %0
  tail call void @zero_fill_gp_bf16(ptr nonnull @buf189)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf191)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @buf190)
  ...
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @buf188, ptr nonnull @buf187)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16(ptr nonnull @buf185)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @buf187, ptr nonnull @buf188, ptr nonnull @buf185)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @fused_softmax(ptr nonnull @buf185, ptr nonnull @buf190, ptr nonnull @buf184, ptr nonnull @buf183)
  tail call void @mul_r_gp(ptr nonnull @buf183, ptr nonnull @buf189)
  tail call void @matmul_g_b_bf16(ptr nonnull @buf185, ptr nonnull @buf186, ptr nonnull @buf189)
  tail call void @accum_sp_r_s(ptr nonnull @buf191, ptr nonnull @buf183, ptr nonnull @buf184)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf184, ptr nonnull @buf191)
...
.preheader10:                                     ; preds = %.loopexit, %.preheader10
  ...
  %4 = getelementptr bfloat, ptr @buf182, i20 %3
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %10 = getelementptr bfloat, ptr @buf181, i20 %9
...
.preheader8:                                      ; preds = %.preheader9, %.preheader8
  ...
  %16 = getelementptr bfloat, ptr @buf180, i20 %15
...
19:                                               ; preds = %.preheader8
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf190, ptr nonnull @buf179)
  tail call void @maximum_up_u_bf16(ptr nonnull @buf181, ptr nonnull @buf190)
  tail call void @exp_up_minus_u(ptr nonnull @buf181, ptr nonnull @buf190, ptr nonnull @buf178)
  tail call void @exp_up_minus_u(ptr nonnull @buf179, ptr nonnull @buf190, ptr nonnull @buf177)
  tail call void @mul_r_gp(ptr nonnull @buf178, ptr nonnull @buf182)
  tail call void @mul_r_gp(ptr nonnull @buf177, ptr nonnull @buf189)
  tail call void @add_gp_g(ptr nonnull @buf189, ptr nonnull @buf182)
  tail call void @zero_fill_sp_bf16(ptr nonnull @buf176)
  tail call void @accum_sp_r_s(ptr nonnull @buf180, ptr nonnull @buf178, ptr nonnull @buf176)
  tail call void @accum_sp_r_s(ptr nonnull @buf191, ptr nonnull @buf177, ptr nonnull @buf176)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @buf176, ptr nonnull @buf180)
  br label %20

20:                                               ; preds = %19, %20
  %21 = phi i32 [ 0, %19 ], [ %25, %20 ]
  %22 = trunc nuw i32 %21 to i20
  %23 = getelementptr bfloat, ptr @buf182, i20 %22
...
.preheader7:                                      ; preds = %20, %.preheader7
  ...
  %29 = getelementptr bfloat, ptr @buf190, i20 %28
...
.preheader:                                       ; preds = %.preheader7, %.preheader
  ...
  %35 = getelementptr bfloat, ptr @buf180, i20 %34
