...
module {
  ...
  func.func @attention_bf16(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16> attributes {id = 3 : i32} {
      ...
      %2 = air.channel.put async  @QK2L1[%c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 1 : i32} : (memref<512x64xbf16>)
      %3 = air.channel.put async  @QK2L1[%c0, %c1_1] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 2 : i32} : (memref<512x64xbf16>)
      %4 = air.channel.put async  @QK2L1[%c0, %c2_0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 3 : i32} : (memref<512x64xbf16>)
      %5 = air.channel.put async  @QK2L1[%c0, %c3] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 4 : i32} : (memref<512x64xbf16>)
      %6 = air.channel.put async  @QK2L1[%c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %c0] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 5 : i32} : (memref<512x64xbf16>)
      %7 = air.channel.put async  @QK2L1[%c0, %c1_1] (%arg9[%c0, %c0, %c0, %c0, %c8192] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 6 : i32} : (memref<512x64xbf16>)
      %8 = air.channel.put async  @QK2L1[%c0, %c2_0] (%arg9[%c0, %c0, %c0, %c0, %c16384] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 7 : i32} : (memref<512x64xbf16>)
      %9 = air.channel.put async  @QK2L1[%c0, %c3] (%arg9[%c0, %c0, %c0, %c0, %c24576] [%c2_0, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_1]) {id = 8 : i32} : (memref<512x64xbf16>)
      ...
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_1, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %17 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %16) -> (!air.async.token) {
          ...
          %28 = air.channel.get async [%arg17]  @VIn_0[%c0_46] (%results[] [] []) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_0[%c0_46, %c0_46] (%results[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_47, %c8_47, %c8_47, %c8_47] [%c8_47, %c512_48, %c64_49, %c1_50]) {id = 15 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %19 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %18) -> (!air.async.token) {
          ...
          %c64_49 = arith.constant 64 : index
          %c1_50 = arith.constant 1 : index
          %28 = air.channel.get async [%arg17]  @VIn_1[%c0_46] (%results_10[] [] []) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_1[%c0_46, %c0_46] (%results_10[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_47, %c8_47, %c8_47, %c8_47] [%c8_47, %c512_48, %c64_49, %c1_50]) {id = 17 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %21 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %20) -> (!air.async.token) {
          ...
          %c64_49 = arith.constant 64 : index
          %c1_50 = arith.constant 1 : index
          %28 = air.channel.get async [%arg17]  @VIn_2[%c0_46] (%results_12[] [] []) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_2[%c0_46, %c0_46] (%results_12[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_47, %c8_47, %c8_47, %c8_47] [%c8_47, %c512_48, %c64_49, %c1_50]) {id = 19 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %23 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %22) -> (!air.async.token) {
          ...
          %c64_49 = arith.constant 64 : index
          %c1_50 = arith.constant 1 : index
          %28 = air.channel.get async [%arg17]  @VIn_3[%c0_46] (%results_14[] [] []) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_3[%c0_46, %c0_46] (%results_14[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_47, %c8_47, %c8_47, %c8_47] [%c8_47, %c512_48, %c64_49, %c1_50]) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %25 = scf.parallel (%arg16) = (%c0_31) to (%c4_32) step (%c1_33) init (%24) -> !air.async.token {
          %c0_46 = arith.constant 0 : index
          %c64_47 = arith.constant 64 : index
          %c1_48 = arith.constant 1 : index
          %28 = affine.apply #map1()[%arg16]
          %29 = air.channel.get async [%24]  @Gp2L2[%arg16, %c0_46] (%results_16[%28, %c0_46] [%c64_47, %c64_47] [%c64_47, %c1_48]) {id = 22 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %27 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %37 = scf.if %35 -> (!air.async.token) {
            %async_token_55 = air.execute [%33] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 17 : i32}
            %52 = air.wait_all async [%async_token_55]  {id = 15 : i32}
            scf.yield %52 : !air.async.token
          } else {
          ...
          %42 = scf.if %40 -> (!air.async.token) {
            %async_token_55 = air.execute [%38] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
            %52 = air.wait_all async [%async_token_55]  {id = 18 : i32}
            scf.yield %52 : !air.async.token
          } else {
          ...
          %47 = scf.if %45 -> (!air.async.token) {
            %async_token_55 = air.execute [%43] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
            %52 = air.wait_all async [%async_token_55]  {id = 21 : i32}
            scf.yield %52 : !air.async.token
          } else {
            %52 = air.wait_all async  {id = 22 : i32}
            scf.yield %52 : !air.async.token
          }
          %48 = air.wait_all async [%async_token_52, %async_token_53, %async_token_54]  {id = 35 : i32}
          %49 = scf.for %arg27 = %c0_50 to %c2_51 step %c1_49 iter_args(%arg28 = %48) -> (!air.async.token) {
            %c0_i32_55 = arith.constant 0 : i32
            %async_token_56 = air.execute [%arg28] {
            ...
            %async_token_57 = air.execute [%arg28, %52, %async_token_56] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_62 = air.execute [%async_token_60, %async_token_58, %async_token_57, %arg28] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_63 = air.execute [%async_token_62, %arg28] {
              func.call @mul_r_gp(%results_61, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 25 : i32}
            %async_token_64 = air.execute [%arg28, %async_token_63, %60] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %51 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            ...
            %53 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              ...
              %55 = air.channel.get async [%async_token_55]  @cascade_gp[%arg16, %arg17] (%results_56[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_57]  @cascade_up[%arg16, %arg17] (%results_58[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_59]  @cascade_sp[%arg16, %arg17] (%results_60[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_61, %results_62 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_63 = air.execute [%async_token_61, %52] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_62) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_64 = air.execute [%async_token_63, %56] {
              ...
              %async_token_71 = air.execute [%async_token_67, %55] {
                func.call @mul_r_gp(%results_66, %results_56) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_72 = air.execute [%async_token_70, %52] {
              ...
              %async_token_77 = air.execute [%async_token_76, %async_token_71, %57] {
              ...
              %async_token_78 = air.execute [%async_token_77, %async_token_72, %52] {
              ...
              %58 = arith.subi %arg17, %c1_49 : index
              %59 = air.channel.put async [%async_token_73]  @cascade_gp[%arg16, %58] (%results_56[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.put async [%async_token_70]  @cascade_up[%arg16, %58] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.put async [%async_token_79]  @cascade_sp[%arg16, %58] (%results_60[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_80 = air.execute [%59] {
              ...
              %55 = air.channel.get async [%async_token_55]  @cascade_gp[%arg16, %arg17] (%results_56[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_57]  @cascade_up[%arg16, %arg17] (%results_58[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_59]  @cascade_sp[%arg16, %arg17] (%results_60[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_61, %results_62 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %58 = air.channel.put async [%async_token_80]  @Gp2L2[%arg16, %c0_50] (%results_56[%c0_50, %c0_50, %c0_50, %c0_50] [%c8_48, %c8_48, %c8_48, %c8_48] [%c64_47, %c8_48, %c512_46, %c1_49]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_81 = air.execute [%58] {
                memref.dealloc %results_56 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
