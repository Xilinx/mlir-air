      ...
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_1, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %22 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %23 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %38 = air.channel.get async  @QK2L1_0[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %38 : !air.async.token
          } else {
            %38 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %39 = air.channel.get async  @QK2L1_1[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %39 : !air.async.token
            } else {
              %39 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %40 = air.channel.get async  @QK2L1_2[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %40 : !air.async.token
              } else {
                %40 = air.channel.get async  @QK2L1_3[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %40 : !air.async.token
              }
              affine.yield %39 : !air.async.token
            }
          ...
          scf.if %34 {
            %async_token_52 = air.execute [%32] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
          }
          %35 = air.wait_all async [%async_token_49, %async_token_50, %async_token_51]  {id = 35 : i32}
          %36 = scf.for %arg27 = %c0_47 to %c2_48 step %c1_46 iter_args(%arg28 = %35) -> (!air.async.token) {
            ...
            %38 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async [%arg28]  @QK2L1_0[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %45 = air.channel.get async [%arg28]  @QK2L1_1[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %45 : !air.async.token
              } else {
                %45 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %46 = air.channel.get async [%arg28]  @QK2L1_2[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %46 : !air.async.token
                } else {
                  %46 = air.channel.get async [%arg28]  @QK2L1_3[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %46 : !air.async.token
                }
                affine.yield %45 : !air.async.token
              }
            ...
            %async_token_53 = air.execute [%async_token_52, %38] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_60 = air.execute [%arg28, %async_token_59, %42] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %43 = air.wait_all async [%39, %40, %41, %async_token_60, %async_token_62]  {id = 36 : i32}
            scf.yield %43 : !air.async.token
          }
          %37 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %38 = arith.subi %arg17, %c1_46 : index
            ...
            %38 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %39 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %40 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %41 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_60 = air.execute [%async_token_58, %36] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_59) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_61 = air.execute [%async_token_60, %40] {
              ...
              %async_token_68 = air.execute [%async_token_64, %39] {
                func.call @mul_r_gp(%results_63, %results_53) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_69 = air.execute [%async_token_67, %36] {
              ...
              %async_token_74 = air.execute [%async_token_73, %async_token_68, %41] {
              ...
              %42 = arith.subi %arg17, %c1_46 : index
              %43 = air.channel.put async [%async_token_70]  @cascade_gp[%arg16, %42] (%results_53[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %44 = air.channel.put async [%async_token_67]  @cascade_up[%arg16, %42] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %45 = air.channel.put async [%async_token_76]  @cascade_sp[%arg16, %42] (%results_57[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_77 = air.execute [%43] {
                memref.dealloc %results_53 : memref<64x64xbf16, 2 : i32>
              } {id = 49 : i32}
              %async_token_78 = air.execute [%async_token_64] {
                memref.dealloc %results_55 : memref<64x1xbf16, 2 : i32>
              } {id = 50 : i32}
              %async_token_79 = air.execute [%45] {
                memref.dealloc %results_57 : memref<64x1xbf16, 2 : i32>
              } {id = 51 : i32}
              ...
              %39 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %40 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %41 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %42 = air.channel.put async [%async_token_77]  @Gp2L2[%arg16, %c0_47] (%results_53[%c0_47, %c0_47, %c0_47, %c0_47] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_44, %c8_45, %c512_43, %c1_46]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
