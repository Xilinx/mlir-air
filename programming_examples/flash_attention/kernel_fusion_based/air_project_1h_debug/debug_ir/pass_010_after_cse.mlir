      ...
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_1, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %22 = air.herd @herd_0 async [%async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27, %async_token_29]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_18, %arg21=%results_20, %arg22=%results_22, %arg23=%results_24, %arg24=%results_26, %arg25=%results_28, %arg26=%results_30) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %23 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %35 = air.channel.get async  @QK2L1_0[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %35 : !air.async.token
          } else {
            %35 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %36 = air.channel.get async  @QK2L1_1[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %36 : !air.async.token
            } else {
              %36 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %37 = air.channel.get async  @QK2L1_2[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %37 : !air.async.token
              } else {
                %37 = air.channel.get async  @QK2L1_3[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %37 : !air.async.token
              }
              affine.yield %36 : !air.async.token
            }
          ...
          %32 = air.wait_all async [%async_token_49, %async_token_50, %async_token_51]  {id = 35 : i32}
          %33 = scf.for %arg27 = %c0_47 to %c2_48 step %c1_46 iter_args(%arg28 = %32) -> (!air.async.token) {
            ...
            %35 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async [%arg28]  @QK2L1_0[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %42 = air.channel.get async [%arg28]  @QK2L1_1[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %42 : !air.async.token
              } else {
                %42 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %43 = air.channel.get async [%arg28]  @QK2L1_2[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %43 : !air.async.token
                } else {
                  %43 = air.channel.get async [%arg28]  @QK2L1_3[%arg16, %c0_47] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %43 : !air.async.token
                }
                affine.yield %42 : !air.async.token
              }
            ...
            %async_token_60 = air.execute [%arg28, %async_token_59, %39] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %40 = air.wait_all async [%36, %37, %38, %async_token_60, %async_token_62]  {id = 36 : i32}
          ...
          %34 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %35 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %36 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %37 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %38 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %async_token_69 = air.execute [%async_token_67, %33] {
              ...
              %40 = air.channel.put async [%async_token_70]  @cascade_gp[%arg16, %39] (%results_53[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %41 = air.channel.put async [%async_token_67]  @cascade_up[%arg16, %39] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %42 = air.channel.put async [%async_token_76]  @cascade_sp[%arg16, %39] (%results_57[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %36 = air.channel.get async [%async_token_52]  @cascade_gp[%arg16, %arg17] (%results_53[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %37 = air.channel.get async [%async_token_54]  @cascade_up[%arg16, %arg17] (%results_55[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %38 = air.channel.get async [%async_token_56]  @cascade_sp[%arg16, %arg17] (%results_57[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_58, %results_59 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %39 = air.channel.put async [%async_token_77]  @Gp2L2[%arg16, %c0_47] (%results_53[%c0_47, %c0_47, %c0_47, %c0_47] [%c8_45, %c8_45, %c8_45, %c8_45] [%c64_44, %c8_45, %c512_43, %c1_46]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
