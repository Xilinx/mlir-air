module {
  aie.device(npu2) @attn_seg {
    ...
    aie.runtime_sequence @attn_seg_sequence(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
      ...
      %4 = aiex.dma_configure_task_for @air_QK2L1_1 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @air_QK2L1_1 {
      ...
      %8 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 16384, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 16384, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @air_QK2L1_2 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 16384, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%12)
      %13 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 24576, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%13)
      %14 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg0 : memref<512x64xbf16>, 16384, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
      aiex.dma_start_task(%14)
      %15 = aiex.dma_configure_task_for @air_QK2L1_3 {
        aie.dma_bd(%arg1 : memref<512x64xbf16>, 24576, 4096, [<size = 2, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%15)
      %16 = aiex.dma_configure_task_for @air_VIn_0 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 0, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @air_VIn_1 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 8192, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @air_VIn_2 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 16384, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%18)
      %19 = aiex.dma_configure_task_for @air_VIn_3 {
        aie.dma_bd(%arg2 : memref<512x64xbf16>, 24576, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%19)
      %20 = aiex.dma_configure_task_for @air_channel_0_0 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 0, 8192, [<size = 2, stride = 16384>, <size = 8, stride = 512>, <size = 512, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%20)
      %21 = aiex.dma_configure_task_for @air_channel_0_1 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 4096, 8192, [<size = 2, stride = 16384>, <size = 64, stride = 64>, <size = 64, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%21)
      %22 = aiex.dma_configure_task_for @air_channel_0_2 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 8192, 8192, [<size = 2, stride = 16384>, <size = 64, stride = 64>, <size = 64, stride = 1>])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%22)
      %23 = aiex.dma_configure_task_for @air_channel_0_3 {
        aie.dma_bd(%arg3 : memref<512x64xbf16>, 12288, 8192, [<size = 2, stride = 16384>, <size = 64, stride = 64>, <size = 64, stride = 1>])
        aie.end
      } {issue_token = true}
