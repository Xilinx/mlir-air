  ...
  func.func @attention_bf16(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16> attributes {id = 1 : i32} {
      ...
      %18 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_1, %arg15=%c1_1) attributes {id = 2 : i32, x_loc = 0 : i64, x_size = 8 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %22 = air.channel.put async [%21]  @V2L1_0[%c0_7, %c0_7] (%results_19[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %24 = air.channel.put async [%23]  @V2L1_1[%c0_7, %c0_7] (%results_22[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %26 = air.channel.put async [%25]  @V2L1_1[%c0_7, %c0_7] (%results_25[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %28 = air.channel.put async [%27]  @V2L1_2[%c0_7, %c0_7] (%results_28[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %30 = air.channel.put async [%29]  @V2L1_2[%c0_7, %c0_7] (%results_31[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %32 = air.channel.put async [%31]  @V2L1_3[%c0_7, %c0_7] (%results_34[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %34 = air.channel.put async [%33]  @V2L1_3[%c0_7, %c0_7] (%results_37[%c0_7, %c0_7, %c0_7] [%c8_4, %c64_3, %c8_4] [%c8_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %38 = air.channel.get async [%async_token_13]  @Gp2L2[%c3_2, %c0_7] (%results_14[] [] []) : (memref<64x64xbf16, 1 : i32>)
        ...
        %42 = air.channel.put async [%38]  @channel_0[%c3_2, %c0_7] (%results_14[] [] []) : (memref<64x64xbf16, 1 : i32>)
        %43 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) attributes {id = 3 : i32, link_with = "attn.o", x_loc = 0 : i64, y_loc = 2 : i64} {
          ...
          %44 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_54]  @QK2L1_0[%arg16, %c0_44] (%results_55[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async [%async_token_54]  @QK2L1_1[%arg16, %c0_44] (%results_55[] [] []) {id = 34 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async [%async_token_54]  @QK2L1_2[%arg16, %c0_44] (%results_55[] [] []) {id = 35 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = air.channel.get async [%async_token_54]  @QK2L1_3[%arg16, %c0_44] (%results_55[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              }
              affine.yield %66 : !air.async.token
            }
          ...
          %47 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_54]  @QK2L1_0[%arg16, %c0_44] (%results_55[] [] []) {id = 37 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async [%async_token_54]  @QK2L1_1[%arg16, %c0_44] (%results_55[] [] []) {id = 38 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async [%async_token_54]  @QK2L1_2[%arg16, %c0_44] (%results_55[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = air.channel.get async [%async_token_54]  @QK2L1_3[%arg16, %c0_44] (%results_55[] [] []) {id = 40 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              }
              affine.yield %66 : !air.async.token
            }
          ...
          %64 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %65 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %69 = air.channel.put async [%async_token_129]  @Gp2L2[%arg16, %c0_44] (%results_105[%c0_44, %c0_44, %c0_44] [%c64_43, %c8_46, %c8_46] [%c8_46, %c512_47, %c1_45]) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
