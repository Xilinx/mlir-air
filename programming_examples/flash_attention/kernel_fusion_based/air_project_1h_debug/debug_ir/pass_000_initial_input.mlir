...
module {
  ...
  func.func @attention_bf16(%arg0: memref<512x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
    ...
    air.launch (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16> {
      ...
      air.channel.put  @QK2L1[%c0, %c0_0] (%arg8[%c0_1, %c0_2, %c0_3, %c0_4, %0] [%c4, %c8, %c8_5, %c8_6, %c8_7] [%c4096, %c8_8, %c512, %c64, %c1_9]) : (memref<512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0_10, %c1_11] (%arg8[%c0_12, %c0_13, %c0_14, %c0_15, %0] [%c4_16, %c8_17, %c8_18, %c8_19, %c8_20] [%c4096_21, %c8_22, %c512_23, %c64_24, %c1_25]) : (memref<512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0_26, %c2_27] (%arg8[%c0_28, %c0_29, %c0_30, %c0_31, %0] [%c4_32, %c8_33, %c8_34, %c8_35, %c8_36] [%c4096_37, %c8_38, %c512_39, %c64_40, %c1_41]) : (memref<512x64xbf16>)
      ...
      air.channel.put  @QK2L1[%c0_42, %c3] (%arg8[%c0_43, %c0_44, %c0_45, %c0_46, %0] [%c4_47, %c8_48, %c8_49, %c8_50, %c8_51] [%c4096_52, %c8_53, %c512_54, %c64_55, %c1_56]) : (memref<512x64xbf16>)
      ...
      air.channel.get  @GpOut[%c0_162] (%arg11[%0] [%c16384_163] [%c1_164]) : (memref<512x64xbf16>)
