...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x256x128xbf16>, %arg1: memref<2x512x128xbf16>, %arg2: memref<2x512x64xbf16>, %arg3: memref<2x256x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x128xbf16>, memref<2x512x128xbf16>, memref<2x512x64xbf16>, memref<2x256x64xbf16> attributes {id = 1 : i32} {
      ...
      %131 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32, x_loc = 0 : i64, x_size = 8 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %137 = scf.for %arg16 = %c0_7 to %c4 step %c1_5 iter_args(%arg17 = %136) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_2[%c0_7, %arg12] (%results_9[] [] []) {id = 113 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_9[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 114 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_11[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 115 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_9[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 116 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_11[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 117 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %138 = air.channel.get async [%136]  @channel_2[%c1_5, %arg12] (%results[] [] []) {id = 118 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %140 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %139) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_2[%c0_7, %arg12] (%results_9[] [] []) {id = 119 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_9[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 120 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_11[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 121 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_9[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 122 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_11[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 123 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %141 = air.channel.get async [%139]  @channel_2[%c1_5, %arg12] (%results[] [] []) {id = 124 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %143 = scf.for %arg16 = %c0_7 to %c4 step %c1_5 iter_args(%arg17 = %142) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_0[%c0_7, %arg12] (%results_15[] [] []) {id = 125 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_15[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 126 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_17[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 127 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_15[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 128 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_17[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 129 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %144 = air.channel.get async [%142]  @channel_0[%c1_5, %arg12] (%results_13[] [] []) {id = 130 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %146 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %145) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_0[%c0_7, %arg12] (%results_15[] [] []) {id = 131 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_15[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 132 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_17[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 133 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_15[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 134 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_17[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 135 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %147 = air.channel.get async [%145]  @channel_0[%c1_5, %arg12] (%results_13[] [] []) {id = 136 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %149 = scf.for %arg16 = %c0_7 to %c4 step %c1_5 iter_args(%arg17 = %148) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_3[%c0_7, %arg12] (%results_21[] [] []) {id = 137 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_21[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 138 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_23[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 139 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_21[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 140 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_23[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 141 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %150 = air.channel.get async [%148]  @channel_3[%c1_5, %arg12] (%results_19[] [] []) {id = 142 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %152 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %151) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_3[%c0_7, %arg12] (%results_21[] [] []) {id = 143 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_21[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 144 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_2_0[%c0_7, %c0_7, %c0_7] (%results_23[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 145 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_21[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 146 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_2_1[%c0_7, %c0_7, %c0_7] (%results_23[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 147 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %153 = air.channel.get async [%151]  @channel_3[%c1_5, %arg12] (%results_19[] [] []) {id = 148 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %155 = scf.for %arg16 = %c0_7 to %c4 step %c1_5 iter_args(%arg17 = %154) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_1[%c0_7, %arg12] (%results_27[] [] []) {id = 149 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_27[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 150 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_29[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 151 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_27[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 152 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_29[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 153 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %156 = air.channel.get async [%154]  @channel_1[%c1_5, %arg12] (%results_25[] [] []) {id = 154 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %158 = scf.for %arg16 = %c0_7 to %c2_6 step %c1_5 iter_args(%arg17 = %157) -> (!air.async.token) {
          %173 = air.channel.get async [%arg17]  @channel_1[%c0_7, %arg12] (%results_27[] [] []) {id = 155 : i32} : (memref<32x128xbf16, 1 : i32>)
          %174 = arith.cmpi eq, %arg12, %c0_7 : index
          %175:2 = scf.if %174 -> (!air.async.token, !air.async.token) {
            %177 = air.channel.put async [%173]  @QK2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_27[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 156 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_3_0[%c0_7, %c0_7, %c0_7] (%results_29[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 157 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          } else {
            %177 = air.channel.put async [%173]  @QK2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_27[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c512, %c128_4, %c1_5]) {id = 158 : i32} : (memref<32x128xbf16, 1 : i32>)
            %178 = air.channel.put async [%arg17]  @QK2L1_3_1[%c0_7, %c0_7, %c0_7] (%results_29[%c0_7, %c0_7, %c0_7, %c0_7] [%c8, %c8, %c8, %c8] [%c8, %c256_1, %c64_3, %c1_5]) {id = 159 : i32} : (memref<32x64xbf16, 1 : i32>)
            scf.yield %177, %178 : !air.async.token, !air.async.token
          }
          %176 = air.wait_all async [%175#0, %175#1] 
          scf.yield %176 : !air.async.token
        }
        %159 = air.channel.get async [%157]  @channel_1[%c1_5, %arg12] (%results_25[] [] []) {id = 160 : i32} : (memref<32x128xbf16, 1 : i32>)
        ...
        %164 = air.channel.get async [%async_token_30]  @Gp2L2[%c0_7, %c0_7] (%results_31[] [] []) {id = 173 : i32} : (memref<64x64xbf16, 1 : i32>)
        %165 = air.channel.get async [%async_token_32]  @Gp2L2[%c1_5, %c0_7] (%results_33[] [] []) {id = 174 : i32} : (memref<64x64xbf16, 1 : i32>)
        %166 = air.channel.get async [%async_token_34]  @Gp2L2[%c2_6, %c0_7] (%results_35[] [] []) {id = 175 : i32} : (memref<64x64xbf16, 1 : i32>)
        %167 = air.channel.get async [%async_token_36]  @Gp2L2[%c3_2, %c0_7] (%results_37[] [] []) {id = 176 : i32} : (memref<64x64xbf16, 1 : i32>)
        %168 = air.channel.put async [%164]  @channel_4[%c0_7, %arg12] (%results_31[] [] []) {id = 177 : i32} : (memref<64x64xbf16, 1 : i32>)
        %169 = air.channel.put async [%165]  @channel_4[%c1_5, %arg12] (%results_33[] [] []) {id = 178 : i32} : (memref<64x64xbf16, 1 : i32>)
        %170 = air.channel.put async [%166]  @channel_4[%c2_6, %arg12] (%results_35[] [] []) {id = 179 : i32} : (memref<64x64xbf16, 1 : i32>)
        %171 = air.channel.put async [%167]  @channel_4[%c3_2, %arg12] (%results_37[] [] []) {id = 180 : i32} : (memref<64x64xbf16, 1 : i32>)
        %172 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4, %arg19=%c4) args(%arg20=%arg12) : index attributes {id = 3 : i32, link_with = "attn.o", x_loc = 0 : i64, y_loc = 2 : i64} {
