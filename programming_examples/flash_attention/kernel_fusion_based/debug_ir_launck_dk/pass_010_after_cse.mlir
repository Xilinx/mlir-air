...
module {
  ...
  func.func @attention_bf16(%arg0: memref<2x256x128xbf16>, %arg1: memref<2x256x128xbf16>, %arg2: memref<2x256x64xbf16>, %arg3: memref<2x256x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<2x256x128xbf16>, memref<2x256x128xbf16>, memref<2x256x64xbf16>, memref<2x256x64xbf16> attributes {id = 3 : i32} {
      ...
      %35 = air.channel.get async  @GpOut[%c0] (%arg11[] [] []) : (memref<2x256x64xbf16>)
      ...
      %70 = air.channel.get async  @GpOut[%c1_0] (%arg11[] [] []) : (memref<2x256x64xbf16>)
      %71 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %72 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          ...
          %110 = scf.if %109 -> (!air.async.token) {
            ...
            %111 = air.channel.put async [%108]  @QK2L1_0_1[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 44 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %111 : !air.async.token
          }
          scf.yield %110 : !air.async.token
        }
        %73 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %72) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_0[%arg12] (%results[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = arith.cmpi eq, %arg12, %c0_3 : index
          %110 = scf.if %109 -> (!air.async.token) {
            %111 = air.channel.put async [%108]  @QK2L1_0_0[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 46 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %111 : !air.async.token
          } else {
            %111 = air.channel.put async [%108]  @QK2L1_0_1[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 46 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %111 : !air.async.token
          }
          scf.yield %110 : !air.async.token
        }
        %74 = air.channel.get async [%73]  @QKIn_0[%arg12] (%results[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 1 : i32>)
        %75 = arith.cmpi eq, %arg12, %c0_3 : index
        %76 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%74]  @QK2L1_0_0[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 48 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%74]  @QK2L1_0_1[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 48 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %77 = air.channel.get async [%73, %76]  @QKIn_0[%arg12] (%results[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 1 : i32>)
        %78 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%77]  @QK2L1_0_0[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 50 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%77]  @QK2L1_0_1[%c0_3, %c0_3, %c0_3] (%results[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 50 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %79 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %async_token_4) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_1[%arg12] (%results_5[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_1_0[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 52 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_1_1[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 52 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %80 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %79) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_1[%arg12] (%results_5[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_1_0[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 54 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_1_1[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 54 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %81 = air.channel.get async [%80]  @QKIn_1[%arg12] (%results_5[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 1 : i32>)
        %82 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%81]  @QK2L1_1_0[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 56 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%81]  @QK2L1_1_1[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 56 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %83 = air.channel.get async [%80, %82]  @QKIn_1[%arg12] (%results_5[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 1 : i32>)
        %84 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%83]  @QK2L1_1_0[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 58 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%83]  @QK2L1_1_1[%c0_3, %c0_3, %c0_3] (%results_5[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 58 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %85 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %async_token_6) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_2[%arg12] (%results_7[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_2_0[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 60 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_2_1[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 60 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %86 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %85) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_2[%arg12] (%results_7[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_2_0[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 62 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_2_1[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 62 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %87 = air.channel.get async [%86]  @QKIn_2[%arg12] (%results_7[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 1 : i32>)
        %88 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%87]  @QK2L1_2_0[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 64 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%87]  @QK2L1_2_1[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 64 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %89 = air.channel.get async [%86, %88]  @QKIn_2[%arg12] (%results_7[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 1 : i32>)
        %90 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%89]  @QK2L1_2_0[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 66 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%89]  @QK2L1_2_1[%c0_3, %c0_3, %c0_3] (%results_7[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 66 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %91 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %async_token_8) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_3[%arg12] (%results_9[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_3_0[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 68 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_3_1[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 68 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %92 = scf.for %arg16 = %c0_3 to %c4 step %c1_2 iter_args(%arg17 = %91) -> (!air.async.token) {
          %108 = air.channel.get async [%arg17]  @QKIn_3[%arg12] (%results_9[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 1 : i32>)
          %109 = scf.if %75 -> (!air.async.token) {
            %110 = air.channel.put async [%108]  @QK2L1_3_0[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 70 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          } else {
            %110 = air.channel.put async [%108]  @QK2L1_3_1[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 70 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %110 : !air.async.token
          }
          scf.yield %109 : !air.async.token
        }
        %93 = air.channel.get async [%92]  @QKIn_3[%arg12] (%results_9[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 1 : i32>)
        %94 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%93]  @QK2L1_3_0[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 72 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%93]  @QK2L1_3_1[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 72 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %95 = air.channel.get async [%92, %94]  @QKIn_3[%arg12] (%results_9[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 1 : i32>)
        %96 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%95]  @QK2L1_3_0[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 74 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%95]  @QK2L1_3_1[%c0_3, %c0_3, %c0_3] (%results_9[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 74 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %97 = air.channel.get async [%async_token_10]  @VIn_0[%arg12] (%results_11[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 1 : i32>)
        %98 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%97]  @V2L1_0_0[%c0_3, %c0_3, %c0_3] (%results_11[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 76 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%97]  @V2L1_0_1[%c0_3, %c0_3, %c0_3] (%results_11[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 76 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %99 = air.channel.get async [%async_token_12]  @VIn_1[%arg12] (%results_13[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 1 : i32>)
        %100 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%99]  @V2L1_1_0[%c0_3, %c0_3, %c0_3] (%results_13[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 78 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%99]  @V2L1_1_1[%c0_3, %c0_3, %c0_3] (%results_13[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 78 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %101 = air.channel.get async [%async_token_14]  @VIn_2[%arg12] (%results_15[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 1 : i32>)
        %102 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%101]  @V2L1_2_0[%c0_3, %c0_3, %c0_3] (%results_15[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 80 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%101]  @V2L1_2_1[%c0_3, %c0_3, %c0_3] (%results_15[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 80 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %103 = air.channel.get async [%async_token_16]  @VIn_3[%arg12] (%results_17[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 1 : i32>)
        %104 = scf.if %75 -> (!air.async.token) {
          %108 = air.channel.put async [%103]  @V2L1_3_0[%c0_3, %c0_3, %c0_3] (%results_17[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 82 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        } else {
          %108 = air.channel.put async [%103]  @V2L1_3_1[%c0_3, %c0_3, %c0_3] (%results_17[%c0_3, %c0_3, %c0_3, %c0_3] [%c8, %c8, %c8, %c8] [%c8, %c512, %c64_1, %c1_2]) {id = 82 : i32} : (memref<64x64xbf16, 1 : i32>)
          scf.yield %108 : !air.async.token
        }
        %105 = scf.parallel (%arg16) = (%c0_3) to (%c4) step (%c1_2) init (%async_token_18) -> !air.async.token {
          %108 = affine.apply #map28()[%arg16]
          %109 = air.channel.get async [%async_token_18]  @Gp2L2[%arg16, %c0_3] (%results_19[%108, %c0_3] [%c64_1, %c64_1] [%c64_1, %c1_2]) {id = 83 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %106 = air.channel.put async [%105]  @GpOut[%arg12] (%results_19[] [] []) {id = 84 : i32} : (memref<256x64xbf16, 1 : i32>)
        %107 = air.herd @herd_0 async [%async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28, %async_token_30, %async_token_32, %async_token_34]  tile (%arg16, %arg17) in (%arg18=%c4, %arg19=%c4) args(%arg20=%results_21, %arg21=%results_23, %arg22=%results_25, %arg23=%results_27, %arg24=%results_29, %arg25=%results_31, %arg26=%results_33, %arg27=%results_35, %arg28=%arg12) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %108 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            ...
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 37 : i32}
            affine.yield %158 : !air.async.token
          }
          %109 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%108]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%108]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 40 : i32}
            affine.yield %158 : !air.async.token
          }
          %110 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%109]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%109]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 43 : i32}
            affine.yield %158 : !air.async.token
          }
          %111 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%110]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%110]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 46 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %114 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 52 : i32}
            affine.yield %158 : !air.async.token
          }
          %115 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%114]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 90 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%114]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 90 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 55 : i32}
            affine.yield %158 : !air.async.token
          }
          %116 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%115]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%115]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 58 : i32}
            affine.yield %158 : !air.async.token
          }
          %117 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%116]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%116]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 92 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 61 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %119 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 93 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 93 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 67 : i32}
            affine.yield %158 : !air.async.token
          }
          %120 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%119]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 94 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%119]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 94 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 70 : i32}
            affine.yield %158 : !air.async.token
          }
          %121 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%120]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%120]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 95 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 73 : i32}
            affine.yield %158 : !air.async.token
          }
          %122 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%121]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 96 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%121]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 96 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 76 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %124 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 97 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 97 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 82 : i32}
            affine.yield %158 : !air.async.token
          }
          %125 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%124]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%124]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 98 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 85 : i32}
            affine.yield %158 : !air.async.token
          }
          %126 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%125]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 99 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%125]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 99 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 88 : i32}
            affine.yield %158 : !air.async.token
          }
          %127 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%126]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 100 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%126]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 100 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 91 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %129 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 101 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 97 : i32}
            affine.yield %158 : !air.async.token
          }
          %130 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%129]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 102 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%129]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 102 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 100 : i32}
            affine.yield %158 : !air.async.token
          }
          %131 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%130]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 103 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%130]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 103 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 103 : i32}
            affine.yield %158 : !air.async.token
          }
          %132 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%131]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 104 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%131]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 104 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 106 : i32}
            affine.yield %158 : !air.async.token
          }
          scf.if %113 {
          ...
          %133 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            ...
            %159 = scf.if %158 -> (!air.async.token) {
              ...
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 105 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 112 : i32}
            affine.yield %158 : !air.async.token
          }
          %134 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%133]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 106 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%133]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 106 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 115 : i32}
            affine.yield %158 : !air.async.token
          }
          %135 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%134]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 107 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%134]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 107 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 118 : i32}
            affine.yield %158 : !air.async.token
          }
          %136 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%135]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 108 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%135]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 108 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 121 : i32}
            affine.yield %158 : !air.async.token
          }
          scf.if %118 {
          ...
          %137 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 109 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 109 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 127 : i32}
            affine.yield %158 : !air.async.token
          }
          %138 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%137]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 110 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%137]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 110 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 130 : i32}
            affine.yield %158 : !air.async.token
          }
          %139 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%138]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 111 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%138]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 111 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 133 : i32}
            affine.yield %158 : !air.async.token
          }
          %140 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%139]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 112 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%139]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 112 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 136 : i32}
            affine.yield %158 : !air.async.token
          }
          scf.if %123 {
          ...
          %141 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            ...
            %159 = scf.if %158 -> (!air.async.token) {
              ...
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 113 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 142 : i32}
            affine.yield %158 : !air.async.token
          }
          %142 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%141]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 114 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%141]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 114 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 145 : i32}
            affine.yield %158 : !air.async.token
          }
          %143 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%142]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 115 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%142]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 115 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 148 : i32}
            affine.yield %158 : !air.async.token
          }
          %144 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%143]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 116 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%143]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 116 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 151 : i32}
            affine.yield %158 : !air.async.token
          }
          scf.if %128 {
          ...
          %145 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 117 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 117 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 157 : i32}
            affine.yield %158 : !air.async.token
          }
          %146 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%145]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 118 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%145]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 118 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 160 : i32}
            affine.yield %158 : !air.async.token
          }
          %147 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%146]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 119 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%146]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 119 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 163 : i32}
            affine.yield %158 : !air.async.token
          }
          %148 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%147]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 120 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%147]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 120 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 166 : i32}
            affine.yield %158 : !air.async.token
          }
          %async_token_62 = air.execute [%async_token_61, %148] {
            %collapse_shape = memref.collapse_shape %arg24 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %149 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%async_token_62]  @QK2L1_0_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 121 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%async_token_62]  @QK2L1_0_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 121 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 169 : i32}
            affine.yield %158 : !air.async.token
          }
          %150 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%149]  @QK2L1_1_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 122 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%149]  @QK2L1_1_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 122 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 172 : i32}
            affine.yield %158 : !air.async.token
          }
          %151 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%150]  @QK2L1_2_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 123 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%150]  @QK2L1_2_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 123 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 175 : i32}
            affine.yield %158 : !air.async.token
          }
          %152 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%151]  @QK2L1_3_0[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 124 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%151]  @QK2L1_3_1[%c0_56, %arg17, %arg16] (%arg22[] [] []) {id = 124 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 178 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %153 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async  @V2L1_0_0[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 125 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async  @V2L1_0_1[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 125 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 181 : i32}
            affine.yield %158 : !air.async.token
          }
          %154 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%153]  @V2L1_1_0[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 126 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%153]  @V2L1_1_1[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 126 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 184 : i32}
            affine.yield %158 : !air.async.token
          }
          %155 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%154]  @V2L1_2_0[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 127 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%154]  @V2L1_2_1[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 127 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 187 : i32}
            affine.yield %158 : !air.async.token
          }
          %156 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %158 = arith.cmpi eq, %arg28, %c0_56 : index
            %159 = scf.if %158 -> (!air.async.token) {
              %160 = air.channel.get async [%155]  @V2L1_3_0[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 128 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            } else {
              %160 = air.channel.get async [%155]  @V2L1_3_1[%c0_56, %arg17, %arg16] (%arg23[] [] []) {id = 128 : i32} : (memref<64x64xbf16, 2 : i32>)
              scf.yield %160 : !air.async.token
            }
            affine.yield %159 : !air.async.token
          } else {
            %158 = air.wait_all async  {id = 190 : i32}
            affine.yield %158 : !air.async.token
          }
          ...
          %async_token_70 = air.execute [%156, %async_token_69] {
            %collapse_shape = memref.collapse_shape %arg24 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %157 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            ...
            %159 = air.channel.put async [%async_token_58, %async_token_70]  @cascade_gp[%arg16, %158] (%arg25[] [] []) {id = 129 : i32} : (memref<64x64xbf16, 2 : i32>)
            %160 = air.channel.put async [%async_token_60]  @cascade_up[%arg16, %158] (%arg26[] [] []) {id = 130 : i32} : (memref<64x1xbf16, 2 : i32>)
            %161 = air.channel.put async [%async_token_59, %async_token_72]  @cascade_sp[%arg16, %158] (%arg27[] [] []) {id = 131 : i32} : (memref<64x1xbf16, 2 : i32>)
            %162 = air.wait_all async [%159, %160, %161]  {id = 197 : i32}
            ...
            %158 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              ...
              %160 = air.channel.get async [%async_token_75]  @cascade_gp[%arg16, %arg17] (%results_76[] [] []) {id = 132 : i32} : (memref<64x64xbf16, 2 : i32>)
              %161 = air.channel.get async [%async_token_77]  @cascade_up[%arg16, %arg17] (%results_78[] [] []) {id = 133 : i32} : (memref<64x1xbf16, 2 : i32>)
              %162 = air.channel.get async [%async_token_79]  @cascade_sp[%arg16, %arg17] (%results_80[] [] []) {id = 134 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %164 = air.channel.put async [%async_token_93]  @cascade_gp[%arg16, %163] (%results_76[] [] []) {id = 135 : i32} : (memref<64x64xbf16, 2 : i32>)
              %165 = air.channel.put async [%async_token_90]  @cascade_up[%arg16, %163] (%arg26[] [] []) {id = 136 : i32} : (memref<64x1xbf16, 2 : i32>)
              %166 = air.channel.put async [%async_token_99]  @cascade_sp[%arg16, %163] (%results_80[] [] []) {id = 137 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %167 = air.wait_all async [%164, %165, %166]  {id = 194 : i32}
              ...
              %160 = air.channel.get async [%async_token_75]  @cascade_gp[%arg16, %arg17] (%results_76[] [] []) {id = 138 : i32} : (memref<64x64xbf16, 2 : i32>)
              %161 = air.channel.get async [%async_token_77]  @cascade_up[%arg16, %arg17] (%results_78[] [] []) {id = 139 : i32} : (memref<64x1xbf16, 2 : i32>)
              %162 = air.channel.get async [%async_token_79]  @cascade_sp[%arg16, %arg17] (%results_80[] [] []) {id = 140 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_81, %results_82 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 69 : i32}
              ...
              %163 = air.channel.put async [%async_token_100]  @Gp2L2[%arg16, %c0_56] (%results_76[%c0_56, %c0_56, %c0_56, %c0_56] [%c8_55, %c8_55, %c8_55, %c8_55] [%c64_54, %c8_55, %c512_53, %c1_57]) {id = 141 : i32} : (memref<64x64xbf16, 2 : i32>)
            ...
            %159 = air.wait_all async [%async_token_58, %async_token_59, %async_token_60, %145, %146, %147, %async_token_62, %149, %150, %151, %153, %154, %155, %async_token_70, %async_token_72]  {id = 198 : i32}
            affine.yield %159 : !air.async.token
          }
        }
        ...
        %async_token_44 = air.execute [%78] {
          memref.dealloc %results : memref<64x64xbf16, 1 : i32>
        } {id = 100 : i32}
        %async_token_45 = air.execute [%98] {
