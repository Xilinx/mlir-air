...
module {
  ...
  func.func @attention_bf16(%arg0: memref<512x512xbf16>, %arg1: memref<512x128xbf16>, %arg2: memref<512x128xbf16>, %arg3: memref<512x512xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 3 : i32} {
      ...
      %24 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %33 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          ...
          %50 = scf.if %49 -> (!air.async.token) {
            ...
            %51 = air.channel.put async [%48]  @Q2L1_1_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          }
          scf.yield %50 : !air.async.token
        }
        %34 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %33) -> (!air.async.token) {
          %48 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 15 : i32} : (memref<64x64xbf16, 1 : i32>)
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50 = scf.if %49 -> (!air.async.token) {
            %51 = air.channel.put async [%48]  @Q2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          } else {
            %51 = air.channel.put async [%48]  @Q2L1_1_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          }
          scf.yield %50 : !air.async.token
        }
        %35 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %34) -> (!air.async.token) {
          %48 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 17 : i32} : (memref<64x64xbf16, 1 : i32>)
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50 = scf.if %49 -> (!air.async.token) {
            %51 = air.channel.put async [%48]  @Q2L1_0_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          } else {
            %51 = air.channel.put async [%48]  @Q2L1_1_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          }
          scf.yield %50 : !air.async.token
        }
        %36 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %35) -> (!air.async.token) {
          ...
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50 = scf.if %49 -> (!air.async.token) {
            %51 = air.channel.put async [%48]  @Q2L1_0_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          } else {
            %51 = air.channel.put async [%48]  @Q2L1_1_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %51 : !air.async.token
          }
          scf.yield %50 : !air.async.token
        }
        %37 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %36) -> (!air.async.token) {
          %48 = air.channel.get async [%arg17]  @KIn[%arg12] (%results[] [] []) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @K2L1_0_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @K2L1_1_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %51 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @K2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @K2L1_1_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %52 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @K2L1_0_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @K2L1_1_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %53 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @K2L1_0_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @K2L1_1_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %54 = air.wait_all async [%50, %51, %52, %53]  {id = 10 : i32}
          scf.yield %54 : !air.async.token
        }
        %38 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %async_token_9) -> (!air.async.token) {
          %48 = air.channel.get async [%arg17]  @VIn[%arg12] (%results_10[] [] []) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %51 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %52 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @V2L1_0_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @V2L1_1_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %53 = scf.if %49 -> (!air.async.token) {
            %55 = air.channel.put async [%48]  @V2L1_0_3[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          } else {
            %55 = air.channel.put async [%48]  @V2L1_1_3[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %55 : !air.async.token
          }
          %54 = air.wait_all async [%50, %51, %52, %53]  {id = 12 : i32}
          scf.yield %54 : !air.async.token
        }
        %39 = air.herd @herd_0 async [%async_token_13, %async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_14, %arg21=%results_16, %arg22=%results_18, %arg23=%results_20, %arg24=%results_22, %arg25=%results_24, %arg26=%results_26, %arg27=%arg12, %arg28=%results_28) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {id = 1 : i32, link_with = "attn_npu2.o"} {
          ...
          %50 = scf.if %49 -> (!air.async.token) {
            %65 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %68 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %68 : !air.async.token
                } else {
                  %68 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %68 : !air.async.token
                }
                affine.yield %67 : !air.async.token
              }
            ...
            %65 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %68 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %68 : !air.async.token
                } else {
                  %68 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %68 : !air.async.token
                }
                affine.yield %67 : !air.async.token
              }
          ...
          scf.if %58 {
            %async_token_54 = air.execute [%57] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 22 : i32}
          }
          %59 = air.wait_all async [%async_token_46, %async_token_47, %async_token_48]  {id = 28 : i32}
          %60 = scf.for %arg29 = %c0_45 to %c8_42 step %c1_44 iter_args(%arg30 = %59) -> (!air.async.token) {
            ...
            %65 = scf.if %49 -> (!air.async.token) {
              %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %71 = air.channel.get async [%arg30]  @K2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %71 : !air.async.token
              } else {
                %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %72 = air.channel.get async [%arg30]  @K2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %72 : !air.async.token
                } else {
                  %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %73 = air.channel.get async [%arg30]  @K2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  } else {
                    %73 = air.channel.get async [%arg30]  @K2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  }
                  affine.yield %72 : !air.async.token
                }
              ...
              %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %71 = air.channel.get async [%arg30]  @K2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %71 : !air.async.token
              } else {
                %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %72 = air.channel.get async [%arg30]  @K2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %72 : !air.async.token
                } else {
                  %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %73 = air.channel.get async [%arg30]  @K2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  } else {
                    %73 = air.channel.get async [%arg30]  @K2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  }
                  affine.yield %72 : !air.async.token
                }
            ...
            %async_token_55 = air.execute [%async_token_54, %65] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %66 = scf.if %49 -> (!air.async.token) {
              %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %71 = air.channel.get async [%arg30]  @V2L1_0_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %71 : !air.async.token
              } else {
                %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %72 = air.channel.get async [%arg30]  @V2L1_0_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %72 : !air.async.token
                } else {
                  %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %73 = air.channel.get async [%arg30]  @V2L1_0_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  } else {
                    %73 = air.channel.get async [%arg30]  @V2L1_0_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  }
                  affine.yield %72 : !air.async.token
                }
              ...
              %70 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %71 = air.channel.get async [%arg30]  @V2L1_1_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %71 : !air.async.token
              } else {
                %71 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %72 = air.channel.get async [%arg30]  @V2L1_1_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %72 : !air.async.token
                } else {
                  %72 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %73 = air.channel.get async [%arg30]  @V2L1_1_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  } else {
                    %73 = air.channel.get async [%arg30]  @V2L1_1_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %73 : !air.async.token
                  }
                  affine.yield %72 : !air.async.token
                }
            ...
            %async_token_65 = air.execute [%66, %async_token_64] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %69 = air.wait_all async [%async_token_56, %async_token_65, %async_token_67]  {id = 29 : i32}
          ...
          %61 = air.channel.put async [%async_token_51]  @Gp2L2[%arg17, %arg16] (%arg24[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_42, %c8_42, %c8_42, %c8_42] [%c64_41, %c8_42, %c512_40, %c1_44]) {id = 37 : i32} : (memref<64x64xbf16, 2 : i32>)
        ...
        %40 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%async_token_11) -> !air.async.token {
          ...
          %49 = air.channel.get async [%async_token_11]  @Gp2L2[%c0_7, %arg16] (%results_12[%48, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 38 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %41 = air.channel.put async [%40]  @GpOut[%arg12] (%results_12[] [] []) {id = 39 : i32} : (memref<256x64xbf16, 1 : i32>)
        %42 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%41) -> !air.async.token {
          %48 = affine.apply #map11()[%arg16]
          %49 = air.channel.get async [%41]  @Gp2L2[%c1_5, %arg16] (%results_12[%48, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 40 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%49 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %50 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %50 : !air.async.token
        ...
        %43 = air.channel.put async [%42]  @GpOut[%arg12] (%results_12[] [] []) {id = 41 : i32} : (memref<256x64xbf16, 1 : i32>)
        %44 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%43) -> !air.async.token {
          %48 = affine.apply #map11()[%arg16]
          %49 = air.channel.get async [%43]  @Gp2L2[%c2_2, %arg16] (%results_12[%48, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 42 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%49 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %50 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %50 : !air.async.token
        ...
        %45 = air.channel.put async [%44]  @GpOut[%arg12] (%results_12[] [] []) {id = 43 : i32} : (memref<256x64xbf16, 1 : i32>)
        %46 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%45) -> !air.async.token {
          %48 = affine.apply #map11()[%arg16]
          %49 = air.channel.get async [%45]  @Gp2L2[%c3, %arg16] (%results_12[%48, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 44 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%49 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %50 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %50 : !air.async.token
        ...
        %47 = air.channel.put async [%46]  @GpOut[%arg12] (%results_12[] [] []) {id = 45 : i32} : (memref<256x64xbf16, 1 : i32>)
      ...
      %25 = air.channel.get async [%24]  @GpOut[%c0] (%arg11[%1, %5] [%c256, %c64] [%c512, %c1_1]) {id = 46 : i32} : (memref<512x512xbf16>)
      %26 = air.channel.get async [%24]  @GpOut[%c0] (%arg11[%1, %7] [%c256, %c64] [%c512, %c1_1]) {id = 47 : i32} : (memref<512x512xbf16>)
      %27 = air.channel.get async [%24]  @GpOut[%c0] (%arg11[%1, %9] [%c256, %c64] [%c512, %c1_1]) {id = 48 : i32} : (memref<512x512xbf16>)
      %28 = air.channel.get async [%24]  @GpOut[%c0] (%arg11[%1, %11] [%c256, %c64] [%c512, %c1_1]) {id = 49 : i32} : (memref<512x512xbf16>)
      %29 = air.channel.get async [%24]  @GpOut[%c1_1] (%arg11[%1, %16] [%c256, %c64] [%c512, %c1_1]) {id = 50 : i32} : (memref<512x512xbf16>)
      %30 = air.channel.get async [%24]  @GpOut[%c1_1] (%arg11[%1, %18] [%c256, %c64] [%c512, %c1_1]) {id = 51 : i32} : (memref<512x512xbf16>)
      %31 = air.channel.get async [%24]  @GpOut[%c1_1] (%arg11[%1, %20] [%c256, %c64] [%c512, %c1_1]) {id = 52 : i32} : (memref<512x512xbf16>)
      %32 = air.channel.get async [%24]  @GpOut[%c1_1] (%arg11[%1, %22] [%c256, %c64] [%c512, %c1_1]) {id = 53 : i32} : (memref<512x512xbf16>)
    }
    return
  }
}
