    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 1 : i32} {
      ...
      %24 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %33 = scf.for %arg16 = %c0_8 to %c4_9 step %c1_6 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 13 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %63 = air.channel.put async [%60]  @Q2L1_0_0[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          } else {
            %63 = air.channel.put async [%60]  @Q2L1_1_0[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 15 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          }
          scf.yield %62 : !air.async.token
        }
        %34 = scf.for %arg16 = %c0_8 to %c4_9 step %c1_6 iter_args(%arg17 = %33) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %63 = air.channel.put async [%60]  @Q2L1_0_1[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 17 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          } else {
            %63 = air.channel.put async [%60]  @Q2L1_1_1[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          }
          scf.yield %62 : !air.async.token
        }
        %35 = scf.for %arg16 = %c0_8 to %c4_9 step %c1_6 iter_args(%arg17 = %34) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 19 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %63 = air.channel.put async [%60]  @Q2L1_0_2[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          } else {
            %63 = air.channel.put async [%60]  @Q2L1_1_2[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          }
          scf.yield %62 : !air.async.token
        }
        %36 = scf.for %arg16 = %c0_8 to %c4_9 step %c1_6 iter_args(%arg17 = %35) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %63 = air.channel.put async [%60]  @Q2L1_0_3[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          } else {
            %63 = air.channel.put async [%60]  @Q2L1_1_3[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %63 : !air.async.token
          }
          scf.yield %62 : !air.async.token
        }
        %37 = scf.for %arg16 = %c0_8 to %c8_7 step %c1_6 iter_args(%arg17 = %36) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @KIn[%arg12] (%results[] [] []) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62:4 = scf.if %61 -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            %64 = air.channel.put async [%60]  @K2L1_0_0[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
            %65 = air.channel.put async [%60]  @K2L1_0_1[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%60]  @K2L1_0_2[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%60]  @K2L1_0_3[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64, %65, %66, %67 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          } else {
            %64 = air.channel.put async [%60]  @K2L1_1_0[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            %65 = air.channel.put async [%60]  @K2L1_1_1[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%60]  @K2L1_1_2[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%60]  @K2L1_1_3[%c0_8, %c0_8, %c0_8] (%results[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64, %65, %66, %67 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          }
          %63 = air.wait_all async [%62#0, %62#1, %62#2, %62#3] 
          scf.yield %63 : !air.async.token
        }
        %38 = scf.for %arg16 = %c0_8 to %c8_7 step %c1_6 iter_args(%arg17 = %async_token_10) -> (!air.async.token) {
          %60 = air.channel.get async [%arg17]  @VIn[%arg12] (%results_11[] [] []) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
          %61 = arith.cmpi eq, %arg12, %c0_8 : index
          %62:4 = scf.if %61 -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            %64 = air.channel.put async [%60]  @V2L1_0_0[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
            %65 = air.channel.put async [%60]  @V2L1_0_1[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%60]  @V2L1_0_2[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%60]  @V2L1_0_3[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64, %65, %66, %67 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          } else {
            %64 = air.channel.put async [%60]  @V2L1_1_0[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 39 : i32} : (memref<64x64xbf16, 1 : i32>)
            %65 = air.channel.put async [%60]  @V2L1_1_1[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 40 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%60]  @V2L1_1_2[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 41 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%60]  @V2L1_1_3[%c0_8, %c0_8, %c0_8] (%results_11[%c0_8, %c0_8, %c0_8, %c0_8] [%c8_7, %c8_7, %c8_7, %c8_7] [%c8_7, %c512_5, %c64_4, %c1_6]) {id = 42 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %64, %65, %66, %67 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          }
          %63 = air.wait_all async [%62#0, %62#1, %62#2, %62#3] 
          scf.yield %63 : !air.async.token
        ...
        %39 = air.herd @herd_0 async [%async_token_14, %async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_9, %arg19=%c4_9) args(%arg20=%results_15, %arg21=%results_17, %arg22=%results_19, %arg23=%results_21, %arg24=%results_23, %arg25=%results_25, %arg26=%results_27, %arg27=%arg12, %arg28=%results_29) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {id = 3 : i32, link_with = "attn_npu2.o"} {
          ...
          %async_token_50, %results_51 = air.execute -> (i32) {
            %73 = memref.load %arg28[%c1_45] : memref<3xi32, 2 : i32>
            air.execute_terminator %73 : i32
          }
          %60 = arith.cmpi eq, %results_51, %c0_i32 : i32
          scf.if %60 {
          ...
          %61 = arith.cmpi eq, %arg27, %c0_46 : index
          scf.if %61 {
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_0_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_0_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_0_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_0_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
            ...
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_1_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_1_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_1_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_1_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
          ...
          scf.if %61 {
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_0_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_0_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_0_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_0_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
            ...
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_1_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_1_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_1_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_1_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
          ...
          scf.if %61 {
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_0_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_0_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_0_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_0_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
            ...
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_1_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_1_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_1_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_1_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
          ...
          scf.if %61 {
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_0_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_0_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_0_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_0_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
            ...
            %73 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %74 = air.channel.get async  @Q2L1_1_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %74 : !air.async.token
            } else {
              %74 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %75 = air.channel.get async  @Q2L1_1_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %75 : !air.async.token
              } else {
                %75 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %76 = air.channel.get async  @Q2L1_1_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                } else {
                  %76 = air.channel.get async  @Q2L1_1_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %76 : !air.async.token
                }
                affine.yield %75 : !air.async.token
              }
          ...
          %67 = air.wait_all async [%async_token_47, %async_token_48, %async_token_49] 
          %68 = scf.for %arg29 = %c0_46 to %c8_43 step %c1_45 iter_args(%arg30 = %67) -> (!air.async.token) {
            ...
            scf.if %61 {
              %76 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %77 = air.channel.get async [%arg30]  @K2L1_0_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %77 : !air.async.token
              } else {
                %77 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %78 = air.channel.get async [%arg30]  @K2L1_0_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %78 : !air.async.token
                } else {
                  %78 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %79 = air.channel.get async [%arg30]  @K2L1_0_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  } else {
                    %79 = air.channel.get async [%arg30]  @K2L1_0_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  }
                  affine.yield %78 : !air.async.token
                }
              ...
              %76 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %77 = air.channel.get async [%arg30]  @K2L1_1_0[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %77 : !air.async.token
              } else {
                %77 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %78 = air.channel.get async [%arg30]  @K2L1_1_1[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %78 : !air.async.token
                } else {
                  %78 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %79 = air.channel.get async [%arg30]  @K2L1_1_2[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  } else {
                    %79 = air.channel.get async [%arg30]  @K2L1_1_3[%c0_46, %c0_46, %arg16] (%arg21[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  }
                  affine.yield %78 : !air.async.token
                }
            ...
            scf.if %61 {
              %76 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %77 = air.channel.get async [%arg30]  @V2L1_0_0[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %77 : !air.async.token
              } else {
                %77 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %78 = air.channel.get async [%arg30]  @V2L1_0_1[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %78 : !air.async.token
                } else {
                  %78 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %79 = air.channel.get async [%arg30]  @V2L1_0_2[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  } else {
                    %79 = air.channel.get async [%arg30]  @V2L1_0_3[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  }
                  affine.yield %78 : !air.async.token
                }
              ...
              %76 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %77 = air.channel.get async [%arg30]  @V2L1_1_0[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %77 : !air.async.token
              } else {
                %77 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %78 = air.channel.get async [%arg30]  @V2L1_1_1[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %78 : !air.async.token
                } else {
                  %78 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %79 = air.channel.get async [%arg30]  @V2L1_1_2[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  } else {
                    %79 = air.channel.get async [%arg30]  @V2L1_1_3[%c0_46, %c0_46, %arg16] (%arg22[] [] []) {id = 90 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %79 : !air.async.token
                  }
                  affine.yield %78 : !air.async.token
                }
            ...
            %73 = arith.index_cast %arg29 : index to i32
            %async_token_57, %results_58 = air.execute [%arg30] -> (i32) {
              %76 = memref.load %arg28[%c0_46] : memref<3xi32, 2 : i32>
              air.execute_terminator %76 : i32
            }
            %74 = arith.addi %results_58, %62 : i32
            %async_token_59 = air.execute [%async_token_56] {
              func.call @apply_causal_mask(%arg23, %74, %73) : (memref<64x64xbf16, 2 : i32>, i32, i32) -> ()
            }
            ...
            %75 = air.wait_all async [%async_token_57, %async_token_66, %async_token_68] 
          ...
          %69 = air.channel.put async [%async_token_52]  @Gp2L2[%arg17, %arg16] (%arg24[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_43, %c8_43, %c8_43, %c8_43] [%c64_42, %c8_43, %c512_41, %c1_45]) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
          %async_token_53, %results_54 = air.execute [%68] -> (i32) {
            %73 = memref.load %arg28[%c2_44] : memref<3xi32, 2 : i32>
            air.execute_terminator %73 : i32
          }
          %70 = arith.addi %results_54, %c1_i32 : i32
          %71 = arith.cmpi sge, %70, %c1_i32 : i32
          scf.if %71 {
            %async_token_55, %results_56 = air.execute [%async_token_53] -> (i32) {
              %74 = memref.load %arg28[%c0_46] : memref<3xi32, 2 : i32>
              air.execute_terminator %74 : i32
            }
            %73 = arith.addi %results_56, %c4_i32 : i32
            %async_token_57 = air.execute [%async_token_55] {
              memref.store %73, %arg28[%c0_46] : memref<3xi32, 2 : i32>
            }
          ...
          scf.if %72 {
            %async_token_55 = air.execute {
              memref.store %70, %arg28[%c2_44] : memref<3xi32, 2 : i32>
            }
          }
        }
        ...
        %41 = air.channel.get async [%async_token_12]  @Gp2L2[%c0_8, %c1_6] (%results_13[%c64_4, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 93 : i32} : (memref<256x64xbf16, 1 : i32>)
        %42 = air.channel.get async [%async_token_12]  @Gp2L2[%c0_8, %c2_3] (%results_13[%c128_2, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 94 : i32} : (memref<256x64xbf16, 1 : i32>)
        %43 = air.channel.get async [%async_token_12]  @Gp2L2[%c0_8, %c3] (%results_13[%c192, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 95 : i32} : (memref<256x64xbf16, 1 : i32>)
        %44 = air.channel.put async [%40, %41, %42, %43]  @GpOut[%arg12] (%results_13[] [] []) {id = 96 : i32} : (memref<256x64xbf16, 1 : i32>)
        %45 = air.channel.get async [%44]  @Gp2L2[%c1_6, %c0_8] (%results_13[%c0_8, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 97 : i32} : (memref<256x64xbf16, 1 : i32>)
        %46 = air.channel.get async [%44]  @Gp2L2[%c1_6, %c1_6] (%results_13[%c64_4, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 98 : i32} : (memref<256x64xbf16, 1 : i32>)
        %47 = air.channel.get async [%44]  @Gp2L2[%c1_6, %c2_3] (%results_13[%c128_2, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 99 : i32} : (memref<256x64xbf16, 1 : i32>)
        %48 = air.channel.get async [%44]  @Gp2L2[%c1_6, %c3] (%results_13[%c192, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 100 : i32} : (memref<256x64xbf16, 1 : i32>)
        %49 = air.channel.put async [%45, %46, %47, %48]  @GpOut[%arg12] (%results_13[] [] []) {id = 101 : i32} : (memref<256x64xbf16, 1 : i32>)
        %50 = air.channel.get async [%49]  @Gp2L2[%c2_3, %c0_8] (%results_13[%c0_8, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 102 : i32} : (memref<256x64xbf16, 1 : i32>)
        %51 = air.channel.get async [%49]  @Gp2L2[%c2_3, %c1_6] (%results_13[%c64_4, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 103 : i32} : (memref<256x64xbf16, 1 : i32>)
        %52 = air.channel.get async [%49]  @Gp2L2[%c2_3, %c2_3] (%results_13[%c128_2, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 104 : i32} : (memref<256x64xbf16, 1 : i32>)
        %53 = air.channel.get async [%49]  @Gp2L2[%c2_3, %c3] (%results_13[%c192, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 105 : i32} : (memref<256x64xbf16, 1 : i32>)
        %54 = air.channel.put async [%50, %51, %52, %53]  @GpOut[%arg12] (%results_13[] [] []) {id = 106 : i32} : (memref<256x64xbf16, 1 : i32>)
        %55 = air.channel.get async [%54]  @Gp2L2[%c3, %c0_8] (%results_13[%c0_8, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 107 : i32} : (memref<256x64xbf16, 1 : i32>)
        %56 = air.channel.get async [%54]  @Gp2L2[%c3, %c1_6] (%results_13[%c64_4, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 108 : i32} : (memref<256x64xbf16, 1 : i32>)
        %57 = air.channel.get async [%54]  @Gp2L2[%c3, %c2_3] (%results_13[%c128_2, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 109 : i32} : (memref<256x64xbf16, 1 : i32>)
        %58 = air.channel.get async [%54]  @Gp2L2[%c3, %c3] (%results_13[%c192, %c0_8] [%c64_4, %c64_4] [%c64_4, %c1_6]) {id = 110 : i32} : (memref<256x64xbf16, 1 : i32>)
        %59 = air.channel.put async [%55, %56, %57, %58]  @GpOut[%arg12] (%results_13[] [] []) {id = 111 : i32} : (memref<256x64xbf16, 1 : i32>)
