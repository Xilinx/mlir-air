    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 1 : i32} {
      ...
      %24 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %39 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %33) -> (!air.async.token) {
          ...
          %62 = arith.cmpi eq, %arg12, %c0_7 : index
          %63:4 = scf.if %62 -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            %65 = air.channel.put async [%async_token_13, %61]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%async_token_13, %61]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%async_token_13, %61]  @V2L1_0_2[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
            %68 = air.channel.put async [%async_token_13, %61]  @V2L1_0_3[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %65, %66, %67, %68 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          } else {
            %65 = air.channel.put async [%async_token_13, %61]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 39 : i32} : (memref<64x64xbf16, 1 : i32>)
            %66 = air.channel.put async [%async_token_13, %61]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 40 : i32} : (memref<64x64xbf16, 1 : i32>)
            %67 = air.channel.put async [%async_token_13, %61]  @V2L1_1_2[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 41 : i32} : (memref<64x64xbf16, 1 : i32>)
            %68 = air.channel.put async [%async_token_13, %61]  @V2L1_1_3[%c0_7, %c0_7, %c0_7] (%results_14[%c0_7, %c0_7, %c0_7] [%c8_6, %c64_4, %c8_6] [%c8_6, %c64_4, %c1_5]) {id = 42 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %65, %66, %67, %68 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          }
          %64 = air.wait_all async [%63#0, %63#1, %63#2, %63#3] 
        ...
        %40 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%arg12) : index attributes {id = 3 : i32, link_with = "attn_npu2.o"} {
          ...
          %70 = air.channel.put async [%async_token_25, %async_token_36]  @Gp2L2[%arg17, %arg16] (%results_26[%c0_14, %c0_14, %c0_14] [%c64_13, %c8_17, %c8_17] [%c8_17, %c512_18, %c1_15]) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
        ...
        %50 = air.channel.put async [%46, %47, %48, %49]  @GpOut[%arg12] (%results_10[] [] []) {id = 101 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %55 = air.channel.put async [%51, %52, %53, %54]  @GpOut[%arg12] (%results_10[] [] []) {id = 106 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %60 = air.channel.put async [%56, %57, %58, %59]  @GpOut[%arg12] (%results_10[] [] []) {id = 111 : i32} : (memref<256x64xbf16, 1 : i32>)
