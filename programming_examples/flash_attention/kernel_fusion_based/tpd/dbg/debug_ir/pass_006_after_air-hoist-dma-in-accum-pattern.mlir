    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 3 : i32} {
      ...
      %26 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %44 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %43) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @Q2L1[%arg12, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %46 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %45) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @Q2L1[%arg12, %c1_5, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %48 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %47) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @Q2L1[%arg12, %c2_2, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %50 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %49) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @Q2L1[%arg12, %c3, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %52 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %51) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @K2L1[%arg12, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
          %70 = air.channel.put async [%arg17, %68]  @K2L1[%arg12, %c1_5, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
          %71 = air.channel.put async [%arg17, %68]  @K2L1[%arg12, %c2_2, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
          %72 = air.channel.put async [%arg17, %68]  @K2L1[%arg12, %c3, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %54 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %53) -> (!air.async.token) {
          ...
          %69 = air.channel.put async [%arg17, %68]  @V2L1[%arg12, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
          %70 = air.channel.put async [%arg17, %68]  @V2L1[%arg12, %c1_5, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
          %71 = air.channel.put async [%arg17, %68]  @V2L1[%arg12, %c2_2, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
          %72 = air.channel.put async [%arg17, %68]  @V2L1[%arg12, %c3, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %55 = air.herd @herd_0 async [%async_token_13, %async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_14, %arg21=%results_16, %arg22=%results_18, %arg23=%results_20, %arg24=%results_22, %arg25=%results_24, %arg26=%results_26, %arg27=%arg12, %arg28=%results_28) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {id = 1 : i32, link_with = "attn_npu2.o"} {
          ...
          %async_token_49, %results_50 = air.execute -> (i32) {
            %101 = memref.load %arg28[%c1_44] : memref<3xi32, 2 : i32>
          ...
          %70 = scf.if %68 -> (!air.async.token) {
            ...
            %101 = air.wait_all async [%async_token_56]  {id = 14 : i32}
          ...
          %75 = scf.if %73 -> (!air.async.token) {
            ...
            %101 = air.wait_all async [%async_token_54]  {id = 17 : i32}
            scf.yield %101 : !air.async.token
          } else {
          ...
          %80 = scf.if %78 -> (!air.async.token) {
            ...
            %101 = air.wait_all async [%async_token_54]  {id = 20 : i32}
            scf.yield %101 : !air.async.token
          } else {
          ...
          %85 = scf.if %83 -> (!air.async.token) {
            ...
            %101 = air.wait_all async [%async_token_54]  {id = 23 : i32}
            scf.yield %101 : !air.async.token
          } else {
          ...
          %90 = scf.if %88 -> (!air.async.token) {
            %async_token_54 = air.execute [%86] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 22 : i32}
            %101 = air.wait_all async [%async_token_54]  {id = 26 : i32}
            scf.yield %101 : !air.async.token
          } else {
            %101 = air.wait_all async  {id = 27 : i32}
            scf.yield %101 : !air.async.token
          }
          %91 = air.wait_all async [%async_token_46, %async_token_47, %async_token_48]  {id = 28 : i32}
          %92 = scf.for %arg29 = %c0_45 to %c8_42 step %c1_44 iter_args(%arg30 = %91) -> (!air.async.token) {
            ...
            %async_token_55 = air.execute [%arg30, %101, %async_token_54] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %105 = arith.addi %results_57, %104 : i32
            ...
            %async_token_65 = air.execute [%arg30, %async_token_64, %102] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %106 = air.wait_all async [%async_token_56, %async_token_65, %async_token_67]  {id = 29 : i32}
            scf.yield %106 : !air.async.token
          }
          %async_token_51 = air.execute [%92, %92] {
            func.call @div_gp_sp(%arg26, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
          } {id = 36 : i32}
          %93 = air.channel.put async [%async_token_51]  @Gp2L2[%arg17, %arg16] (%arg24[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_42, %c8_42, %c8_42, %c8_42] [%c64_41, %c8_42, %c512_40, %c1_44]) {id = 37 : i32} : (memref<64x64xbf16, 2 : i32>)
          %async_token_52, %results_53 = air.execute [%92] -> (i32) {
            %101 = memref.load %arg28[%c2_43] : memref<3xi32, 2 : i32>
            air.execute_terminator %101 : i32
          } {id = 37 : i32}
          %94 = arith.addi %results_53, %c1_i32 : i32
          %95 = arith.cmpi sge, %94, %c1_i32 : i32
          %96 = air.wait_all async [%async_token_52]  {id = 30 : i32}
          %97 = scf.if %95 -> (!air.async.token) {
            %async_token_54, %results_55 = air.execute [%async_token_52] -> (i32) {
              %103 = memref.load %arg28[%c0_45] : memref<3xi32, 2 : i32>
              air.execute_terminator %103 : i32
            } {id = 38 : i32}
            %101 = arith.addi %results_55, %c4_i32 : i32
            %async_token_56 = air.execute [%async_token_54] {
              memref.store %101, %arg28[%c0_45] : memref<3xi32, 2 : i32>
            } {id = 39 : i32}
            %async_token_57 = air.execute [%async_token_56] {
              memref.store %c0_i32, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            } {id = 40 : i32}
            %102 = air.wait_all async [%async_token_57]  {id = 31 : i32}
          ...
          %100 = scf.if %98 -> (!air.async.token) {
            %async_token_54 = air.execute {
              memref.store %94, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            } {id = 41 : i32}
            %101 = air.wait_all async [%async_token_54]  {id = 34 : i32}
            scf.yield %101 : !air.async.token
          } else {
