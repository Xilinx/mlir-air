  ...
  func.func @attention_bf16(%arg0: memref<512x512xbf16>, %arg1: memref<512x128xbf16>, %arg2: memref<512x128xbf16>, %arg3: memref<512x512xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 3 : i32} {
      ...
      %26 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %43 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %async_token) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 13 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %61 = air.channel.put async [%58]  @Q2L1_0_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          } else {
            %61 = air.channel.put async [%58]  @Q2L1_1_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          }
          scf.yield %60 : !air.async.token
        }
        %44 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %43) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 15 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %61 = air.channel.put async [%58]  @Q2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          } else {
            %61 = air.channel.put async [%58]  @Q2L1_1_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          }
          scf.yield %60 : !air.async.token
        }
        %45 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %44) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 17 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %61 = air.channel.put async [%58]  @Q2L1_0_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          } else {
            %61 = air.channel.put async [%58]  @Q2L1_1_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          }
          scf.yield %60 : !air.async.token
        }
        %46 = scf.for %arg16 = %c0_7 to %c4_8 step %c1_5 iter_args(%arg17 = %45) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @QIn[%arg12] (%results[] [] []) {id = 19 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %61 = air.channel.put async [%58]  @Q2L1_0_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          } else {
            %61 = air.channel.put async [%58]  @Q2L1_1_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %61 : !air.async.token
          }
          scf.yield %60 : !air.async.token
        }
        %47 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %46) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @KIn[%arg12] (%results[] [] []) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @K2L1_0_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @K2L1_1_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %61 = arith.cmpi eq, %arg12, %c0_7 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @K2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @K2L1_1_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %63 = arith.cmpi eq, %arg12, %c0_7 : index
          %64 = scf.if %63 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @K2L1_0_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @K2L1_1_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %65 = arith.cmpi eq, %arg12, %c0_7 : index
          %66 = scf.if %65 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @K2L1_0_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @K2L1_1_3[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %67 = air.wait_all async [%60, %62, %64, %66]  {id = 10 : i32}
          scf.yield %67 : !air.async.token
        }
        %48 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %async_token_9) -> (!air.async.token) {
          %58 = air.channel.get async [%arg17]  @VIn[%arg12] (%results_10[] [] []) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
          %59 = arith.cmpi eq, %arg12, %c0_7 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %61 = arith.cmpi eq, %arg12, %c0_7 : index
          %62 = scf.if %61 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %63 = arith.cmpi eq, %arg12, %c0_7 : index
          %64 = scf.if %63 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @V2L1_0_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @V2L1_1_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %65 = arith.cmpi eq, %arg12, %c0_7 : index
          %66 = scf.if %65 -> (!air.async.token) {
            %68 = air.channel.put async [%58]  @V2L1_0_3[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          } else {
            %68 = air.channel.put async [%58]  @V2L1_1_3[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            scf.yield %68 : !air.async.token
          }
          %67 = air.wait_all async [%60, %62, %64, %66]  {id = 12 : i32}
          scf.yield %67 : !air.async.token
        }
        %49 = air.herd @herd_0 async [%async_token_13, %async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_14, %arg21=%results_16, %arg22=%results_18, %arg23=%results_20, %arg24=%results_22, %arg25=%results_24, %arg26=%results_26, %arg27=%arg12, %arg28=%results_28) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {id = 1 : i32, link_with = "attn_npu2.o"} {
          ...
          %async_token_49, %results_50 = air.execute -> (i32) {
            %81 = memref.load %arg28[%c1_44] : memref<3xi32, 2 : i32>
            air.execute_terminator %81 : i32
          } {id = 15 : i32}
          %58 = arith.cmpi eq, %results_50, %c0_i32 : i32
          scf.if %58 {
          ...
          %59 = arith.cmpi eq, %arg27, %c0_45 : index
          %60 = scf.if %59 -> (!air.async.token) {
            %81 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %82 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %82 : !air.async.token
            } else {
              %82 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %83 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %83 : !air.async.token
              } else {
                %83 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %84 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %84 : !air.async.token
                } else {
                  %84 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %84 : !air.async.token
                }
                affine.yield %83 : !air.async.token
              }
            ...
            %81 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %82 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %82 : !air.async.token
            } else {
              %82 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %83 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %83 : !air.async.token
              } else {
                %83 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %84 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %84 : !air.async.token
                } else {
                  %84 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %84 : !air.async.token
                }
                affine.yield %83 : !air.async.token
              }
          ...
          scf.if %66 {
            %async_token_54 = air.execute [%64] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 20 : i32}
          }
          %67 = arith.cmpi eq, %arg27, %c0_45 : index
          ...
          %74 = arith.cmpi eq, %73, %c3_i32 : i32
          scf.if %74 {
            %async_token_54 = air.execute [%72] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 22 : i32}
          }
          %75 = air.wait_all async [%async_token_46, %async_token_47, %async_token_48]  {id = 28 : i32}
          %76 = scf.for %arg29 = %c0_45 to %c8_42 step %c1_44 iter_args(%arg30 = %75) -> (!air.async.token) {
            ...
            %81 = arith.cmpi eq, %arg27, %c0_45 : index
            %82 = scf.if %81 -> (!air.async.token) {
              %89 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %90 = air.channel.get async [%arg30]  @K2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %90 : !air.async.token
              } else {
                %90 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %91 = air.channel.get async [%arg30]  @K2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %91 : !air.async.token
                } else {
                  %91 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %92 = air.channel.get async [%arg30]  @K2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  } else {
                    %92 = air.channel.get async [%arg30]  @K2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  }
                  affine.yield %91 : !air.async.token
                }
              ...
              %89 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %90 = air.channel.get async [%arg30]  @K2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %90 : !air.async.token
              } else {
                %90 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %91 = air.channel.get async [%arg30]  @K2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %91 : !air.async.token
                } else {
                  %91 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %92 = air.channel.get async [%arg30]  @K2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  } else {
                    %92 = air.channel.get async [%arg30]  @K2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  }
                  affine.yield %91 : !air.async.token
                }
            ...
            %async_token_55 = air.execute [%async_token_54, %82] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %84 = scf.if %83 -> (!air.async.token) {
              %89 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %90 = air.channel.get async [%arg30]  @V2L1_0_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %90 : !air.async.token
              } else {
                %90 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %91 = air.channel.get async [%arg30]  @V2L1_0_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %91 : !air.async.token
                } else {
                  %91 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %92 = air.channel.get async [%arg30]  @V2L1_0_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  } else {
                    %92 = air.channel.get async [%arg30]  @V2L1_0_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  }
                  affine.yield %91 : !air.async.token
                }
              ...
              %89 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %90 = air.channel.get async [%arg30]  @V2L1_1_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %90 : !air.async.token
              } else {
                %90 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %91 = air.channel.get async [%arg30]  @V2L1_1_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %91 : !air.async.token
                } else {
                  %91 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %92 = air.channel.get async [%arg30]  @V2L1_1_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  } else {
                    %92 = air.channel.get async [%arg30]  @V2L1_1_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %92 : !air.async.token
                  }
                  affine.yield %91 : !air.async.token
                }
            ...
            %85 = arith.index_cast %arg29 : index to i32
            %async_token_56, %results_57 = air.execute [%arg30] -> (i32) {
              %89 = memref.load %arg28[%c0_45] : memref<3xi32, 2 : i32>
              air.execute_terminator %89 : i32
            } {id = 25 : i32}
            %86 = arith.index_cast %arg16 : index to i32
            %87 = arith.addi %results_57, %86 : i32
            %async_token_58 = air.execute [%arg30, %async_token_55] {
              func.call @apply_causal_mask(%arg23, %87, %85) : (memref<64x64xbf16, 2 : i32>, i32, i32) -> ()
            } {id = 26 : i32}
            ...
            %async_token_63 = air.execute [%async_token_58, %async_token_59, %async_token_61] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_65 = air.execute [%84, %async_token_64] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %88 = air.wait_all async [%async_token_56, %async_token_65, %async_token_67]  {id = 29 : i32}
          ...
          %77 = air.channel.put async [%async_token_51]  @Gp2L2[%arg17, %arg16] (%arg24[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_42, %c8_42, %c8_42, %c8_42] [%c64_41, %c8_42, %c512_40, %c1_44]) {id = 37 : i32} : (memref<64x64xbf16, 2 : i32>)
          %async_token_52, %results_53 = air.execute [%76] -> (i32) {
            %81 = memref.load %arg28[%c2_43] : memref<3xi32, 2 : i32>
            air.execute_terminator %81 : i32
          } {id = 37 : i32}
          %78 = arith.addi %results_53, %c1_i32 : i32
          %79 = arith.cmpi sge, %78, %c1_i32 : i32
          scf.if %79 {
            %async_token_54, %results_55 = air.execute [%async_token_52] -> (i32) {
              %82 = memref.load %arg28[%c0_45] : memref<3xi32, 2 : i32>
              air.execute_terminator %82 : i32
            } {id = 38 : i32}
            %81 = arith.addi %results_55, %c4_i32 : i32
            %async_token_56 = air.execute [%async_token_54] {
              memref.store %81, %arg28[%c0_45] : memref<3xi32, 2 : i32>
            } {id = 39 : i32}
            %async_token_57 = air.execute [%async_token_56] {
              memref.store %c0_i32, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            } {id = 40 : i32}
          }
          %80 = arith.cmpi slt, %78, %c1_i32 : i32
          scf.if %80 {
            %async_token_54 = air.execute {
              memref.store %78, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            } {id = 41 : i32}
          }
        }
        %50 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%async_token_11) -> !air.async.token {
          %58 = affine.apply #map11()[%arg16]
          %59 = air.channel.get async [%async_token_11]  @Gp2L2[%c0_7, %arg16] (%results_12[%58, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 38 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%59 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %60 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %60 : !air.async.token
          }
        }
        %51 = air.channel.put async [%50]  @GpOut[%arg12] (%results_12[] [] []) {id = 39 : i32} : (memref<256x64xbf16, 1 : i32>)
        %52 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%51) -> !air.async.token {
          %58 = affine.apply #map11()[%arg16]
          %59 = air.channel.get async [%51]  @Gp2L2[%c1_5, %arg16] (%results_12[%58, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 40 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%59 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %60 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %60 : !air.async.token
        ...
        %53 = air.channel.put async [%52]  @GpOut[%arg12] (%results_12[] [] []) {id = 41 : i32} : (memref<256x64xbf16, 1 : i32>)
        %54 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%53) -> !air.async.token {
          %58 = affine.apply #map11()[%arg16]
          %59 = air.channel.get async [%53]  @Gp2L2[%c2_2, %arg16] (%results_12[%58, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 42 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%59 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %60 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %60 : !air.async.token
        ...
        %55 = air.channel.put async [%54]  @GpOut[%arg12] (%results_12[] [] []) {id = 43 : i32} : (memref<256x64xbf16, 1 : i32>)
        %56 = scf.parallel (%arg16) = (%c0_7) to (%c4_8) step (%c1_5) init (%55) -> !air.async.token {
          %58 = affine.apply #map11()[%arg16]
          %59 = air.channel.get async [%55]  @Gp2L2[%c3, %arg16] (%results_12[%58, %c0_7] [%c64_3, %c64_3] [%c64_3, %c1_5]) {id = 44 : i32} : (memref<256x64xbf16, 1 : i32>)
          scf.reduce(%59 : !air.async.token) {
          ^bb0(%arg17: !air.async.token, %arg18: !air.async.token):
            %60 = air.wait_all async [%arg17, %arg18] 
            scf.reduce.return %60 : !air.async.token
