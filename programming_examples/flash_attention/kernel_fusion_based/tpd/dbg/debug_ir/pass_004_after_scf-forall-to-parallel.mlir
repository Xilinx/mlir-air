    ...
    air.launch (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> {
      ...
      air.segment @attn_seg  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) {
        ...
        air.herd @herd_0  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%alloc_11, %arg21=%alloc_12, %arg22=%alloc_13, %arg23=%alloc_14, %arg24=%alloc_15, %arg25=%alloc_16, %arg26=%alloc_17, %arg27=%arg12, %arg28=%alloc_18) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {link_with = "attn_npu2.o"} {
          ...
          %21 = memref.load %arg28[%c1_35] : memref<3xi32, 2 : i32>
          %22 = arith.cmpi eq, %21, %c0_i32 : i32
          scf.if %22 {
            memref.store %c0_i32, %arg28[%c0_36] : memref<3xi32, 2 : i32>
            memref.store %c1_i32, %arg28[%c1_35] : memref<3xi32, 2 : i32>
            memref.store %c0_i32, %arg28[%c2_34] : memref<3xi32, 2 : i32>
          }
          ...
          scf.for %arg29 = %c0_36 to %c8_33 step %c1_35 {
            ...
            %36 = memref.load %arg28[%c0_36] : memref<3xi32, 2 : i32>
            ...
            %alloc_38 = memref.alloc() : memref<64x1xbf16, 2 : i32>
            func.call @fused_softmax(%collapse_shape, %arg25, %alloc_37, %alloc_38) : (memref<4096xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            func.call @mul_r_gp(%alloc_38, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            ...
            func.call @accum_sp_r_s(%arg26, %alloc_38, %alloc_37) : (memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            func.call @vector_copy_32elems(%c0_i32, %alloc_37, %arg26) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
            memref.dealloc %alloc_37 : memref<64x1xbf16, 2 : i32>
            memref.dealloc %alloc_38 : memref<64x1xbf16, 2 : i32>
          }
          func.call @div_gp_sp(%arg26, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
          air.channel.put  @Gp2L2[%arg17, %arg16] (%arg24[%c0_36, %c0_36, %c0_36, %c0_36] [%c8_33, %c8_33, %c8_33, %c8_33] [%c64_32, %c8_33, %c512_31, %c1_35]) : (memref<64x64xbf16, 2 : i32>)
          %31 = memref.load %arg28[%c2_34] : memref<3xi32, 2 : i32>
          %32 = arith.addi %31, %c1_i32 : i32
          %33 = arith.cmpi sge, %32, %c1_i32 : i32
          scf.if %33 {
            %35 = memref.load %arg28[%c0_36] : memref<3xi32, 2 : i32>
            %36 = arith.addi %35, %c4_i32 : i32
            memref.store %36, %arg28[%c0_36] : memref<3xi32, 2 : i32>
            memref.store %c0_i32, %arg28[%c2_34] : memref<3xi32, 2 : i32>
          }
          %34 = arith.cmpi slt, %32, %c1_i32 : i32
          scf.if %34 {
            memref.store %32, %arg28[%c2_34] : memref<3xi32, 2 : i32>
          }
        }
        ...
        scf.parallel (%arg16) = (%c0_25) to (%c4_26) step (%c1_27) {
          %21 = affine.apply #map11()[%arg16]
        ...
        scf.parallel (%arg16) = (%c0_28) to (%c4_29) step (%c1_30) {
          %21 = affine.apply #map11()[%arg16]
