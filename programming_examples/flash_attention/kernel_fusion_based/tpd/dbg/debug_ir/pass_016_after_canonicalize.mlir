    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c2, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<512x512xbf16>, memref<512x128xbf16>, memref<512x128xbf16>, memref<512x512xbf16> attributes {id = 1 : i32} {
      ...
      %24 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c2_0, %arg15=%c1_1) attributes {id = 2 : i32} {
        ...
        %37 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %36) -> (!air.async.token) {
          ...
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50:4 = scf.if %49 -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            %52 = air.channel.put async [%48]  @K2L1_0_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
            %53 = air.channel.put async [%48]  @K2L1_0_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
            %54 = air.channel.put async [%48]  @K2L1_0_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
            ...
            scf.yield %52, %53, %54, %55 : !air.async.token, !air.async.token, !air.async.token, !air.async.token
          } else {
            %52 = air.channel.put async [%48]  @K2L1_1_0[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
            %53 = air.channel.put async [%48]  @K2L1_1_1[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
            %54 = air.channel.put async [%48]  @K2L1_1_2[%c0_7, %c0_7, %c0_7] (%results[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
          ...
          %51 = air.wait_all async [%50#0, %50#1, %50#2, %50#3] 
          scf.yield %51 : !air.async.token
        }
        %38 = scf.for %arg16 = %c0_7 to %c8_6 step %c1_5 iter_args(%arg17 = %async_token_9) -> (!air.async.token) {
          ...
          %49 = arith.cmpi eq, %arg12, %c0_7 : index
          %50:4 = scf.if %49 -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            %52 = air.channel.put async [%48]  @V2L1_0_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
            %53 = air.channel.put async [%48]  @V2L1_0_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
            %54 = air.channel.put async [%48]  @V2L1_0_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 39 : i32} : (memref<64x64xbf16, 1 : i32>)
            ...
            %52 = air.channel.put async [%48]  @V2L1_1_0[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
            %53 = air.channel.put async [%48]  @V2L1_1_1[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
            %54 = air.channel.put async [%48]  @V2L1_1_2[%c0_7, %c0_7, %c0_7] (%results_10[%c0_7, %c0_7, %c0_7, %c0_7] [%c8_6, %c8_6, %c8_6, %c8_6] [%c8_6, %c512_4, %c64_3, %c1_5]) {id = 40 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %39 = air.herd @herd_0 async [%async_token_13, %async_token_15, %async_token_17, %async_token_19, %async_token_21, %async_token_23, %async_token_25, %async_token_27]  tile (%arg16, %arg17) in (%arg18=%c4_8, %arg19=%c4_8) args(%arg20=%results_14, %arg21=%results_16, %arg22=%results_18, %arg23=%results_20, %arg24=%results_22, %arg25=%results_24, %arg26=%results_26, %arg27=%arg12, %arg28=%results_28) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, index, memref<3xi32, 2 : i32> attributes {id = 3 : i32, link_with = "attn_npu2.o"} {
          ...
          %async_token_49, %results_50 = air.execute -> (i32) {
            %61 = memref.load %arg28[%c1_44] : memref<3xi32, 2 : i32>
            air.execute_terminator %61 : i32
          }
          ...
          scf.if %49 {
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 43 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 44 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 46 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
            ...
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 47 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 48 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 49 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 50 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
          ...
          scf.if %49 {
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 51 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 52 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
            ...
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
          ...
          %52 = arith.cmpi eq, %50, %c1_i32 : i32
          scf.if %52 {
            %async_token_54 = air.execute {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          ...
          scf.if %49 {
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
            ...
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
          ...
          %53 = arith.cmpi eq, %50, %c2_i32 : i32
          scf.if %53 {
            %async_token_54 = air.execute {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          ...
          scf.if %49 {
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
            ...
            %61 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async  @Q2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async  @Q2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async  @Q2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async  @Q2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 74 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
          ...
          %54 = arith.cmpi eq, %50, %c3_i32 : i32
          scf.if %54 {
            %async_token_54 = air.execute {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            }
          ...
          %56 = scf.for %arg29 = %c0_45 to %c8_42 step %c1_44 iter_args(%arg30 = %55) -> (!air.async.token) {
            ...
            scf.if %49 {
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg30]  @K2L1_0_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 75 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg30]  @K2L1_0_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg30]  @K2L1_0_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 77 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg30]  @K2L1_0_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 78 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
              ...
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg30]  @K2L1_1_0[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg30]  @K2L1_1_1[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 80 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg30]  @K2L1_1_2[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 81 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg30]  @K2L1_1_3[%c0_45, %c0_45, %arg16] (%arg21[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
            ...
            scf.if %49 {
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg30]  @V2L1_0_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 83 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg30]  @V2L1_0_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 84 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg30]  @V2L1_0_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg30]  @V2L1_0_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 86 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
              ...
              %64 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
                %65 = air.channel.get async [%arg30]  @V2L1_1_0[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 87 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %65 : !air.async.token
              } else {
                %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                  %66 = air.channel.get async [%arg30]  @V2L1_1_1[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 88 : i32} : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %66 : !air.async.token
                } else {
                  %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                    %67 = air.channel.get async [%arg30]  @V2L1_1_2[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 89 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  } else {
                    %67 = air.channel.get async [%arg30]  @V2L1_1_3[%c0_45, %c0_45, %arg16] (%arg22[] [] []) {id = 90 : i32} : (memref<64x64xbf16, 2 : i32>)
                    affine.yield %67 : !air.async.token
                  }
                  affine.yield %66 : !air.async.token
                }
            ...
            %61 = arith.index_cast %arg29 : index to i32
            %async_token_56, %results_57 = air.execute [%arg30] -> (i32) {
              %64 = memref.load %arg28[%c0_45] : memref<3xi32, 2 : i32>
              air.execute_terminator %64 : i32
            }
            %62 = arith.addi %results_57, %50 : i32
            %async_token_58 = air.execute [%async_token_55] {
              func.call @apply_causal_mask(%arg23, %62, %61) : (memref<64x64xbf16, 2 : i32>, i32, i32) -> ()
            }
            ...
            %63 = air.wait_all async [%async_token_56, %async_token_65, %async_token_67] 
          ...
          %57 = air.channel.put async [%async_token_51]  @Gp2L2[%arg17, %arg16] (%arg24[%c0_45, %c0_45, %c0_45, %c0_45] [%c8_42, %c8_42, %c8_42, %c8_42] [%c64_41, %c8_42, %c512_40, %c1_44]) {id = 91 : i32} : (memref<64x64xbf16, 2 : i32>)
          %async_token_52, %results_53 = air.execute [%56] -> (i32) {
            %61 = memref.load %arg28[%c2_43] : memref<3xi32, 2 : i32>
            air.execute_terminator %61 : i32
          }
          %58 = arith.addi %results_53, %c1_i32 : i32
          %59 = arith.cmpi sge, %58, %c1_i32 : i32
          scf.if %59 {
            %async_token_54, %results_55 = air.execute [%async_token_52] -> (i32) {
              %62 = memref.load %arg28[%c0_45] : memref<3xi32, 2 : i32>
              air.execute_terminator %62 : i32
            }
            %61 = arith.addi %results_55, %c4_i32 : i32
            %async_token_56 = air.execute [%async_token_54] {
              memref.store %61, %arg28[%c0_45] : memref<3xi32, 2 : i32>
            }
            %async_token_57 = air.execute [%async_token_56] {
              memref.store %c0_i32, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            }
          }
          %60 = arith.cmpi slt, %58, %c1_i32 : i32
          scf.if %60 {
            %async_token_54 = air.execute {
              memref.store %58, %arg28[%c2_43] : memref<3xi32, 2 : i32>
            }
          }
        }
