module {
  aie.device(npu2) @attn_seg {
    ...
    aie.runtime_sequence @attention_bf16(%arg0: memref<256x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<256x64xbf16>) {
      %0 = aiex.dma_configure_task_for @air_QK2L1_0 {
        aie.dma_bd(%arg0 : memref<256x64xbf16>, 0, 4096, [<size = 4, stride = 4096>, <size = 8, stride = 8>, <size = 64, stride = 64>, <size = 8, stride = 1>])
        aie.end
      } {repeat_count = 3 : i32}
