...
module {
  ...
  func.func @attention_bf16(%arg0: memref<256x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<256x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<256x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<256x64xbf16> attributes {id = 3 : i32} {
      ...
      %14 = air.channel.get async  @GpOut[%c0] (%arg11[] [] []) : (memref<256x64xbf16>)
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_0, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %22 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %23 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %38 = air.channel.get async  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %38 : !air.async.token
          } else {
            %38 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %39 = air.channel.get async  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %39 : !air.async.token
            } else {
              %39 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %40 = air.channel.get async  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %40 : !air.async.token
              } else {
                %40 = air.channel.get async  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %40 : !air.async.token
              }
              affine.yield %39 : !air.async.token
            }
          ...
          scf.if %28 {
            %async_token_51 = air.execute [%26] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 17 : i32}
          }
          %29 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %38 = air.channel.get async  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %38 : !air.async.token
          } else {
            %38 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
          ...
          %30 = arith.index_cast %arg16 : index to i32
          %31 = arith.cmpi eq, %30, %c2_i32 : i32
          scf.if %31 {
            %async_token_51 = air.execute [%29] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
          }
          ...
          scf.if %34 {
            %async_token_51 = air.execute [%32] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
          }
          %35 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50]  {id = 35 : i32}
          %36 = scf.for %arg27 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg28 = %35) -> (!air.async.token) {
            ...
            %38 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async [%arg28]  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %45 = air.channel.get async [%arg28]  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %45 : !air.async.token
              } else {
                %45 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %46 = air.channel.get async [%arg28]  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %46 : !air.async.token
                } else {
                  %46 = air.channel.get async [%arg28]  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %46 : !air.async.token
                }
                affine.yield %45 : !air.async.token
              }
            ...
            %39 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async  @V2L1_0[%arg16, %arg17] (%arg22[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = air.wait_all async  {id = 25 : i32}
              affine.yield %44 : !air.async.token
            }
            %40 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async [%arg28, %39]  @V2L1_1[%arg16, %arg17] (%arg22[] [] []) {id = 30 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = air.wait_all async  {id = 28 : i32}
              affine.yield %44 : !air.async.token
            }
            %41 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async [%arg28, %40]  @V2L1_2[%arg16, %arg17] (%arg22[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = air.wait_all async  {id = 31 : i32}
              affine.yield %44 : !air.async.token
            }
            %42 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %44 = air.channel.get async [%arg28, %41]  @V2L1_3[%arg16, %arg17] (%arg22[] [] []) {id = 32 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %44 : !air.async.token
            } else {
              %44 = air.wait_all async  {id = 34 : i32}
              affine.yield %44 : !air.async.token
            }
            %async_token_52 = air.execute [%async_token_51, %38] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_59 = air.execute [%arg28, %async_token_58, %42] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %43 = air.wait_all async [%39, %40, %41, %async_token_59, %async_token_61]  {id = 36 : i32}
            scf.yield %43 : !air.async.token
          }
          %37 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %38 = arith.subi %arg17, %c1_45 : index
            %39 = air.channel.put async [%36]  @cascade_gp[%arg16, %38] (%arg24[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 2 : i32>)
            %40 = air.channel.put async [%36]  @cascade_up[%arg16, %38] (%arg25[] [] []) {id = 34 : i32} : (memref<64x1xbf16, 2 : i32>)
            %41 = air.channel.put async [%36]  @cascade_sp[%arg16, %38] (%arg26[] [] []) {id = 35 : i32} : (memref<64x1xbf16, 2 : i32>)
            %42 = air.wait_all async [%39, %40, %41]  {id = 41 : i32}
            affine.yield %42 : !air.async.token
          } else {
            %38 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %39 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %40 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %41 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_59 = air.execute [%async_token_57, %36] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_58) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_60 = air.execute [%async_token_59, %40] {
              ...
              %async_token_67 = air.execute [%async_token_63, %39] {
                func.call @mul_r_gp(%results_62, %results_52) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_68 = air.execute [%async_token_66, %36] {
              ...
              %async_token_73 = air.execute [%async_token_72, %async_token_67, %41] {
              ...
              %42 = arith.subi %arg17, %c1_45 : index
              %43 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %42] (%results_52[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %44 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %42] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %45 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %42] (%results_56[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %46 = air.wait_all async [%43, %44, %45]  {id = 38 : i32}
              affine.yield %46 : !air.async.token
            } else {
              %async_token_51, %results_52 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %39 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %40 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %41 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %42 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_77 = air.execute [%42] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
