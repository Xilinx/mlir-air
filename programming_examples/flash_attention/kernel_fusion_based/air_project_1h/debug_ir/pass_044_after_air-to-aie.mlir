...
module {
  ...
  func.func @attention_bf16(%arg0: memref<256x64xbf16>, %arg1: memref<512x64xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<256x64xbf16>) {
    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<256x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<256x64xbf16> attributes {id = 1 : i32} {
      ...
      %2 = air.channel.put async  @QK2L1_0[%c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 1 : i32, metadataArray = [{base = "air_QK2L1_0", index = 0 : i32}]} : (memref<256x64xbf16>)
      %3 = air.channel.put async  @QK2L1_1[%c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 2 : i32, metadataArray = [{base = "air_QK2L1_1", index = 0 : i32}]} : (memref<256x64xbf16>)
      %4 = air.channel.put async  @QK2L1_2[%c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 3 : i32, metadataArray = [{base = "air_QK2L1_2", index = 0 : i32}]} : (memref<256x64xbf16>)
      %5 = air.channel.put async  @QK2L1_3[%c0, %c0] (%arg8[%c0, %c0, %c0, %c0, %1] [%c4, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 4 : i32, metadataArray = [{base = "air_QK2L1_3", index = 0 : i32}]} : (memref<256x64xbf16>)
      %6 = air.channel.put async  @QK2L1_0[%c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %c0] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 5 : i32, metadataArray = [{base = "air_QK2L1_0", index = 0 : i32}]} : (memref<512x64xbf16>)
      %7 = air.channel.put async  @QK2L1_1[%c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %c8192] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 6 : i32, metadataArray = [{base = "air_QK2L1_1", index = 0 : i32}]} : (memref<512x64xbf16>)
      %8 = air.channel.put async  @QK2L1_2[%c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %c16384] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 7 : i32, metadataArray = [{base = "air_QK2L1_2", index = 0 : i32}]} : (memref<512x64xbf16>)
      %9 = air.channel.put async  @QK2L1_3[%c0, %c0] (%arg9[%c0, %c0, %c0, %c0, %c24576] [%c2, %c8, %c8, %c8, %c8] [%c4096, %c8, %c512, %c64, %c1_0]) {id = 8 : i32, metadataArray = [{base = "air_QK2L1_3", index = 0 : i32}]} : (memref<512x64xbf16>)
      %10 = air.channel.put async  @VIn_0[%c0] (%arg10[%c0, %c0, %c0] [%c2, %c64, %c64] [%c4096, %c64, %c1_0]) {id = 9 : i32, metadataArray = [{base = "air_VIn_0", index = 0 : i32}]} : (memref<512x64xbf16>)
      %11 = air.channel.put async  @VIn_1[%c0] (%arg10[%c0, %c0, %c8192] [%c2, %c64, %c64] [%c4096, %c64, %c1_0]) {id = 10 : i32, metadataArray = [{base = "air_VIn_1", index = 0 : i32}]} : (memref<512x64xbf16>)
      %12 = air.channel.put async  @VIn_2[%c0] (%arg10[%c0, %c0, %c16384] [%c2, %c64, %c64] [%c4096, %c64, %c1_0]) {id = 11 : i32, metadataArray = [{base = "air_VIn_2", index = 0 : i32}]} : (memref<512x64xbf16>)
      %13 = air.channel.put async  @VIn_3[%c0] (%arg10[%c0, %c0, %c24576] [%c2, %c64, %c64] [%c4096, %c64, %c1_0]) {id = 12 : i32, metadataArray = [{base = "air_VIn_3", index = 0 : i32}]} : (memref<512x64xbf16>)
      %14 = air.channel.get async  @channel_0[%c0, %c0] (%arg11[%c0, %c0] [%c64, %c64] [%c64, %c1_0]) {id = 13 : i32, metadataArray = [{base = "air_channel_0_0", index = 0 : i32}, {base = "air_channel_0_1", index = 1 : i32}, {base = "air_channel_0_2", index = 2 : i32}, {base = "air_channel_0_3", index = 3 : i32}]} : (memref<256x64xbf16>)
      %15 = air.channel.get async  @channel_0[%c1_0, %c0] (%arg11[%c64, %c0] [%c64, %c64] [%c64, %c1_0]) {id = 14 : i32, metadataArray = [{base = "air_channel_0_0", index = 0 : i32}, {base = "air_channel_0_1", index = 1 : i32}, {base = "air_channel_0_2", index = 2 : i32}, {base = "air_channel_0_3", index = 3 : i32}]} : (memref<256x64xbf16>)
      %16 = air.channel.get async  @channel_0[%c2, %c0] (%arg11[%c128, %c0] [%c64, %c64] [%c64, %c1_0]) {id = 15 : i32, metadataArray = [{base = "air_channel_0_0", index = 0 : i32}, {base = "air_channel_0_1", index = 1 : i32}, {base = "air_channel_0_2", index = 2 : i32}, {base = "air_channel_0_3", index = 3 : i32}]} : (memref<256x64xbf16>)
      %17 = air.channel.get async  @channel_0[%c3, %c0] (%arg11[%c192, %c0] [%c64, %c64] [%c64, %c1_0]) {id = 16 : i32, metadataArray = [{base = "air_channel_0_0", index = 0 : i32}, {base = "air_channel_0_1", index = 1 : i32}, {base = "air_channel_0_2", index = 2 : i32}, {base = "air_channel_0_3", index = 3 : i32}]} : (memref<256x64xbf16>)
      %18 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_0, %arg15=%c1_0) attributes {id = 2 : i32, x_loc = 0 : i64, x_size = 8 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %21 = air.channel.get async [%async_token_17]  @VIn_0[%c0_6] (%results_18[] [] []) {id = 19 : i32} : (memref<64x64xbf16, 1 : i32>)
        %22 = air.channel.put async [%21]  @V2L1_0[%c0_6, %c0_6] (%results_18[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %23 = air.channel.get async [%async_token_20]  @VIn_1[%c0_6] (%results_21[] [] []) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
        %24 = air.channel.put async [%23]  @V2L1_1[%c0_6, %c0_6] (%results_21[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 22 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %25 = air.channel.get async [%async_token_23]  @VIn_1[%c0_6] (%results_24[] [] []) {id = 23 : i32} : (memref<64x64xbf16, 1 : i32>)
        %26 = air.channel.put async [%25]  @V2L1_1[%c0_6, %c0_6] (%results_24[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 24 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %27 = air.channel.get async [%async_token_26]  @VIn_2[%c0_6] (%results_27[] [] []) {id = 25 : i32} : (memref<64x64xbf16, 1 : i32>)
        %28 = air.channel.put async [%27]  @V2L1_2[%c0_6, %c0_6] (%results_27[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 26 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %29 = air.channel.get async [%async_token_29]  @VIn_2[%c0_6] (%results_30[] [] []) {id = 27 : i32} : (memref<64x64xbf16, 1 : i32>)
        %30 = air.channel.put async [%29]  @V2L1_2[%c0_6, %c0_6] (%results_30[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 28 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %31 = air.channel.get async [%async_token_32]  @VIn_3[%c0_6] (%results_33[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 1 : i32>)
        %32 = air.channel.put async [%31]  @V2L1_3[%c0_6, %c0_6] (%results_33[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 30 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %33 = air.channel.get async [%async_token_35]  @VIn_3[%c0_6] (%results_36[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 1 : i32>)
        %34 = air.channel.put async [%33]  @V2L1_3[%c0_6, %c0_6] (%results_36[%c0_6, %c0_6, %c0_6] [%c8_3, %c64_2, %c8_3] [%c8_3, %c64_2, %c1_4]) {id = 32 : i32} : (memref<64x64xbf16, 1 : i32>)
        %async_token_37 = air.execute [%34] {
          memref.dealloc %results_36 : memref<64x64xbf16, 1 : i32>
        }
        %35 = air.channel.get async [%async_token]  @Gp2L2[%c0_6, %c0_6] (%results[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 1 : i32>)
        %36 = air.channel.get async [%async_token_8]  @Gp2L2[%c1_4, %c0_6] (%results_9[] [] []) {id = 34 : i32} : (memref<64x64xbf16, 1 : i32>)
        %37 = air.channel.get async [%async_token_10]  @Gp2L2[%c2_5, %c0_6] (%results_11[] [] []) {id = 35 : i32} : (memref<64x64xbf16, 1 : i32>)
        %38 = air.channel.get async [%async_token_12]  @Gp2L2[%c3_1, %c0_6] (%results_13[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 1 : i32>)
        %39 = air.channel.put async [%35]  @channel_0[%c0_6, %c0_6] (%results[] [] []) {id = 37 : i32} : (memref<64x64xbf16, 1 : i32>)
        %40 = air.channel.put async [%36]  @channel_0[%c1_4, %c0_6] (%results_9[] [] []) {id = 38 : i32} : (memref<64x64xbf16, 1 : i32>)
        %41 = air.channel.put async [%37]  @channel_0[%c2_5, %c0_6] (%results_11[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 1 : i32>)
        %42 = air.channel.put async [%38]  @channel_0[%c3_1, %c0_6] (%results_13[] [] []) {id = 40 : i32} : (memref<64x64xbf16, 1 : i32>)
        %43 = air.herd @herd_0 async  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) attributes {id = 3 : i32, link_with = "attn.o", x_loc = 0 : i64, y_loc = 2 : i64} {
          ...
          %51 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_53]  @QK2L1_0[%arg16, %arg17] (%results_54[] [] []) {id = 53 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async [%async_token_53]  @QK2L1_1[%arg16, %arg17] (%results_54[] [] []) {id = 54 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_2[%arg16, %arg17] (%results_54[] [] []) {id = 55 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_3[%arg16, %arg17] (%results_54[] [] []) {id = 56 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              }
              affine.yield %66 : !air.async.token
            }
          ...
          %53 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_53]  @QK2L1_0[%arg16, %arg17] (%results_54[] [] []) {id = 57 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async [%async_token_53]  @QK2L1_1[%arg16, %arg17] (%results_54[] [] []) {id = 58 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_2[%arg16, %arg17] (%results_54[] [] []) {id = 59 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_3[%arg16, %arg17] (%results_54[] [] []) {id = 60 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              }
              affine.yield %66 : !air.async.token
            }
          ...
          %54 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_60]  @V2L1_0[%arg16, %arg17] (%results_61[] [] []) {id = 61 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
          ...
          %55 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_60, %54]  @V2L1_1[%arg16, %arg17] (%results_61[] [] []) {id = 62 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %56 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_60, %55]  @V2L1_2[%arg16, %arg17] (%results_61[] [] []) {id = 63 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %57 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_60, %56]  @V2L1_3[%arg16, %arg17] (%results_61[] [] []) {id = 64 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %58 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_53]  @QK2L1_0[%arg16, %arg17] (%results_54[] [] []) {id = 65 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %66 = air.channel.get async [%async_token_53]  @QK2L1_1[%arg16, %arg17] (%results_54[] [] []) {id = 66 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %66 : !air.async.token
            } else {
              %66 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_2[%arg16, %arg17] (%results_54[] [] []) {id = 67 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              } else {
                %67 = air.channel.get async [%async_token_53]  @QK2L1_3[%arg16, %arg17] (%results_54[] [] []) {id = 68 : i32} : (memref<64x64xbf16, 2 : i32>)
                affine.yield %67 : !air.async.token
              }
              affine.yield %66 : !air.async.token
            }
          ...
          %59 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_79]  @V2L1_0[%arg16, %arg17] (%results_80[] [] []) {id = 69 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %60 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_79, %59]  @V2L1_1[%arg16, %arg17] (%results_80[] [] []) {id = 70 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %61 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_79, %60]  @V2L1_2[%arg16, %arg17] (%results_80[] [] []) {id = 71 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %62 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %65 = air.channel.get async [%async_token_79, %61]  @V2L1_3[%arg16, %arg17] (%results_80[] [] []) {id = 72 : i32} : (memref<64x64xbf16, 2 : i32>)
            affine.yield %65 : !air.async.token
          } else {
            %65 = air.wait_all async 
            affine.yield %65 : !air.async.token
          ...
          %64 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %66 = air.channel.put async [%async_token_51, %63]  @cascade_gp[%arg16, %65] (%results_52[] [] []) {id = 73 : i32} : (memref<64x64xbf16, 2 : i32>)
            %67 = air.channel.put async [%async_token_49]  @cascade_up[%arg16, %65] (%results_50[] [] []) {id = 74 : i32} : (memref<64x1xbf16, 2 : i32>)
            %68 = air.channel.put async [%async_token_47, %63]  @cascade_sp[%arg16, %65] (%results_48[] [] []) {id = 75 : i32} : (memref<64x1xbf16, 2 : i32>)
            ...
            %65 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %66 = air.channel.get async [%async_token_103]  @cascade_gp[%arg16, %arg17] (%results_104[] [] []) {id = 76 : i32} : (memref<64x64xbf16, 2 : i32>)
              %67 = air.channel.get async [%async_token_105]  @cascade_up[%arg16, %arg17] (%results_106[] [] []) {id = 77 : i32} : (memref<64x1xbf16, 2 : i32>)
              %68 = air.channel.get async [%async_token_107]  @cascade_sp[%arg16, %arg17] (%results_108[] [] []) {id = 78 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %70 = air.channel.put async [%async_token_121]  @cascade_gp[%arg16, %69] (%results_104[] [] []) {id = 79 : i32} : (memref<64x64xbf16, 2 : i32>)
              %71 = air.channel.put async [%async_token_49, %async_token_118]  @cascade_up[%arg16, %69] (%results_50[] [] []) {id = 80 : i32} : (memref<64x1xbf16, 2 : i32>)
              %72 = air.channel.put async [%async_token_127]  @cascade_sp[%arg16, %69] (%results_108[] [] []) {id = 81 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %66 = air.channel.get async [%async_token_103]  @cascade_gp[%arg16, %arg17] (%results_104[] [] []) {id = 82 : i32} : (memref<64x64xbf16, 2 : i32>)
              %67 = air.channel.get async [%async_token_105]  @cascade_up[%arg16, %arg17] (%results_106[] [] []) {id = 83 : i32} : (memref<64x1xbf16, 2 : i32>)
              %68 = air.channel.get async [%async_token_107]  @cascade_sp[%arg16, %arg17] (%results_108[] [] []) {id = 84 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_109, %results_110 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              }
              ...
              %69 = air.channel.put async [%async_token_128]  @Gp2L2[%arg16, %c0_43] (%results_104[%c0_43, %c0_43, %c0_43] [%c64_42, %c8_45, %c8_45] [%c8_45, %c512_46, %c1_44]) {id = 85 : i32} : (memref<64x64xbf16, 2 : i32>)
