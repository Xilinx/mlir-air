      ...
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_0, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %22 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %23 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %35 = air.channel.get async  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %35 : !air.async.token
          } else {
            %35 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %36 = air.channel.get async  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %36 : !air.async.token
            } else {
              %36 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %37 = air.channel.get async  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %37 : !air.async.token
              } else {
                %37 = air.channel.get async  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %37 : !air.async.token
              }
              affine.yield %36 : !air.async.token
            }
          ...
          %32 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50]  {id = 35 : i32}
          %33 = scf.for %arg27 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg28 = %32) -> (!air.async.token) {
            ...
            %35 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async [%arg28]  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %42 = air.channel.get async [%arg28]  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %42 : !air.async.token
              } else {
                %42 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %43 = air.channel.get async [%arg28]  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %43 : !air.async.token
                } else {
                  %43 = air.channel.get async [%arg28]  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %43 : !air.async.token
                }
                affine.yield %42 : !air.async.token
              }
            ...
            %36 = affine.if #set3()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async  @V2L1_0[%arg16, %arg17] (%arg22[] [] []) {id = 29 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = air.wait_all async  {id = 25 : i32}
              affine.yield %41 : !air.async.token
            }
            %37 = affine.if #set4()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async [%arg28, %36]  @V2L1_1[%arg16, %arg17] (%arg22[] [] []) {id = 30 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = air.wait_all async  {id = 28 : i32}
              affine.yield %41 : !air.async.token
            }
            %38 = affine.if #set5()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async [%arg28, %37]  @V2L1_2[%arg16, %arg17] (%arg22[] [] []) {id = 31 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = air.wait_all async  {id = 31 : i32}
              affine.yield %41 : !air.async.token
            }
            %39 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
              %41 = air.channel.get async [%arg28, %38]  @V2L1_3[%arg16, %arg17] (%arg22[] [] []) {id = 32 : i32} : (memref<64x64xbf16, 2 : i32>)
              affine.yield %41 : !air.async.token
            } else {
              %41 = air.wait_all async  {id = 34 : i32}
              affine.yield %41 : !air.async.token
            }
            %async_token_52 = air.execute [%async_token_51, %35] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_59 = air.execute [%arg28, %async_token_58, %39] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %40 = air.wait_all async [%36, %37, %38, %async_token_59, %async_token_61]  {id = 36 : i32}
            scf.yield %40 : !air.async.token
          }
          %34 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            %35 = arith.subi %arg17, %c1_45 : index
            %36 = air.channel.put async [%33]  @cascade_gp[%arg16, %35] (%arg24[] [] []) {id = 33 : i32} : (memref<64x64xbf16, 2 : i32>)
            %37 = air.channel.put async [%33]  @cascade_up[%arg16, %35] (%arg25[] [] []) {id = 34 : i32} : (memref<64x1xbf16, 2 : i32>)
            %38 = air.channel.put async [%33]  @cascade_sp[%arg16, %35] (%arg26[] [] []) {id = 35 : i32} : (memref<64x1xbf16, 2 : i32>)
            %39 = air.wait_all async [%36, %37, %38]  {id = 41 : i32}
            ...
            %35 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %36 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %37 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %38 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %async_token_68 = air.execute [%async_token_66, %33] {
              ...
              %40 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %39] (%results_52[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %41 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %39] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %42 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %39] (%results_56[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              ...
              %43 = air.wait_all async [%40, %41, %42]  {id = 38 : i32}
              affine.yield %43 : !air.async.token
            } else {
              %async_token_51, %results_52 = air.execute -> (memref<64x64xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x64xbf16, 2 : i32>
              ...
              %36 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %37 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %38 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %39 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
