    ...
    %0 = air.launch async (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1) args(%arg8=%arg0, %arg9=%arg1, %arg10=%arg2, %arg11=%arg3) : memref<256x64xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<256x64xbf16> attributes {id = 3 : i32} {
      ...
      %15 = air.segment @attn_seg async  unroll(%arg12, %arg13) in (%arg14=%c1_0, %arg15=%c1_0) attributes {id = 2 : i32} {
        ...
        %17 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %16) -> (!air.async.token) {
          %28 = air.channel.get async [%arg17]  @VIn_0[%c0_6] (%results[] [] []) {id = 14 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_0[%c0_6, %c0_6] (%results[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 15 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %19 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %18) -> (!air.async.token) {
          %28 = air.channel.get async [%arg17]  @VIn_1[%c0_6] (%results_9[] [] []) {id = 16 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_1[%c0_6, %c0_6] (%results_9[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 17 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %21 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %20) -> (!air.async.token) {
          %28 = air.channel.get async [%arg17]  @VIn_2[%c0_6] (%results_11[] [] []) {id = 18 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_2[%c0_6, %c0_6] (%results_11[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 19 : i32} : (memref<64x64xbf16, 1 : i32>)
        ...
        %23 = scf.for %arg16 = %c0_6 to %c2_5 step %c1_4 iter_args(%arg17 = %22) -> (!air.async.token) {
          %28 = air.channel.get async [%arg17]  @VIn_3[%c0_6] (%results_13[] [] []) {id = 20 : i32} : (memref<64x64xbf16, 1 : i32>)
          %29 = air.channel.put async [%arg17, %28]  @V2L1_3[%c0_6, %c0_6] (%results_13[%c0_6, %c0_6, %c0_6, %c0_6] [%c8_3, %c8_3, %c8_3, %c8_3] [%c8_3, %c512_2, %c64_1, %c1_4]) {id = 21 : i32} : (memref<64x64xbf16, 1 : i32>)
          %30 = air.wait_all async [%29]  {id = 8 : i32}
          scf.yield %30 : !air.async.token
        }
        %24 = air.wait_all async [%async_token_14]  {id = 9 : i32}
        %25 = scf.parallel (%arg16) = (%c0_6) to (%c4_7) step (%c1_4) init (%24) -> !air.async.token {
          %28 = affine.apply #map1()[%arg16]
          %29 = air.channel.get async [%24]  @Gp2L2[%arg16, %c0_6] (%results_15[%28, %c0_6] [%c64_1, %c64_1] [%c64_1, %c1_4]) {id = 22 : i32} : (memref<256x64xbf16, 1 : i32>)
        ...
        %27 = air.herd @herd_0 async [%async_token_16, %async_token_18, %async_token_20, %async_token_22, %async_token_24, %async_token_26, %async_token_28]  tile (%arg16, %arg17) in (%arg18=%c4_7, %arg19=%c4_7) args(%arg20=%results_17, %arg21=%results_19, %arg22=%results_21, %arg23=%results_23, %arg24=%results_25, %arg25=%results_27, %arg26=%results_29) : memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32> attributes {id = 1 : i32, link_with = "attn.o"} {
          ...
          %28 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
            %52 = air.channel.get async  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
            affine.yield %52 : !air.async.token
          } else {
            %52 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
              %53 = air.channel.get async  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %53 : !air.async.token
            } else {
              %53 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                %54 = air.channel.get async  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %54 : !air.async.token
              } else {
                %54 = air.channel.get async  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %54 : !air.async.token
              }
              affine.yield %53 : !air.async.token
            }
          ...
          %32 = scf.if %30 -> (!air.async.token) {
            ...
            %52 = air.wait_all async [%async_token_51]  {id = 12 : i32}
          ...
          %37 = scf.if %35 -> (!air.async.token) {
            %async_token_51 = air.execute [%33] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 17 : i32}
            %52 = air.wait_all async [%async_token_51]  {id = 15 : i32}
            scf.yield %52 : !air.async.token
          } else {
          ...
          %42 = scf.if %40 -> (!air.async.token) {
            %async_token_51 = air.execute [%38] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 18 : i32}
            %52 = air.wait_all async [%async_token_51]  {id = 18 : i32}
            scf.yield %52 : !air.async.token
          } else {
          ...
          %47 = scf.if %45 -> (!air.async.token) {
            %async_token_51 = air.execute [%43] {
              func.call @copy_tile(%arg21, %arg20) : (memref<64x64xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 19 : i32}
            %52 = air.wait_all async [%async_token_51]  {id = 21 : i32}
            scf.yield %52 : !air.async.token
          } else {
            %52 = air.wait_all async  {id = 22 : i32}
            scf.yield %52 : !air.async.token
          }
          %48 = air.wait_all async [%async_token_48, %async_token_49, %async_token_50]  {id = 35 : i32}
          %49 = scf.for %arg27 = %c0_46 to %c2_47 step %c1_45 iter_args(%arg28 = %48) -> (!air.async.token) {
            ...
            %52 = affine.if #set()[%arg16, %arg17] -> !air.async.token {
              %62 = air.channel.get async [%arg28]  @QK2L1_0[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
              affine.yield %62 : !air.async.token
            } else {
              %62 = affine.if #set1()[%arg16, %arg17] -> !air.async.token {
                %63 = air.channel.get async [%arg28]  @QK2L1_1[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                affine.yield %63 : !air.async.token
              } else {
                %63 = affine.if #set2()[%arg16, %arg17] -> !air.async.token {
                  %64 = air.channel.get async [%arg28]  @QK2L1_2[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                } else {
                  %64 = air.channel.get async [%arg28]  @QK2L1_3[%arg16, %arg17] (%arg21[] [] []) : (memref<64x64xbf16, 2 : i32>)
                  affine.yield %64 : !air.async.token
                }
                affine.yield %63 : !air.async.token
              }
            ...
            %async_token_52 = air.execute [%arg28, %52, %async_token_51] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_57 = air.execute [%async_token_55, %async_token_53, %async_token_52, %arg28] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
            ...
            %async_token_58 = air.execute [%async_token_57, %arg28] {
              func.call @mul_r_gp(%results_56, %arg24) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
            } {id = 25 : i32}
            %async_token_59 = air.execute [%arg28, %async_token_58, %60] {
              %collapse_shape = memref.collapse_shape %arg23 [[0, 1]] : memref<64x64xbf16, 2 : i32> into memref<4096xbf16, 2 : i32>
          ...
          %51 = affine.if #set6()[%arg16, %arg17] -> !air.async.token {
            ...
            %53 = affine.if #set7()[%arg16, %arg17] -> !air.async.token {
              ...
              %55 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 36 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 37 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 38 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 34 : i32}
              %async_token_59 = air.execute [%async_token_57, %52] {
                func.call @vector_copy_32elems(%c0_i32, %arg25, %results_58) : (i32, memref<64x1xbf16, 2 : i32>, memref<64x1xbf16, 2 : i32>) -> ()
              } {id = 35 : i32}
              %async_token_60 = air.execute [%async_token_59, %56] {
              ...
              %async_token_67 = air.execute [%async_token_63, %55] {
                func.call @mul_r_gp(%results_62, %results_52) : (memref<64x1xbf16, 2 : i32>, memref<64x64xbf16, 2 : i32>) -> ()
              } {id = 41 : i32}
              %async_token_68 = air.execute [%async_token_66, %52] {
              ...
              %async_token_73 = air.execute [%async_token_72, %async_token_67, %57] {
              ...
              %async_token_74 = air.execute [%async_token_73, %async_token_68, %52] {
              ...
              %58 = arith.subi %arg17, %c1_45 : index
              %59 = air.channel.put async [%async_token_69]  @cascade_gp[%arg16, %58] (%results_52[] [] []) {id = 39 : i32} : (memref<64x64xbf16, 2 : i32>)
              %60 = air.channel.put async [%async_token_66]  @cascade_up[%arg16, %58] (%arg25[] [] []) {id = 40 : i32} : (memref<64x1xbf16, 2 : i32>)
              %61 = air.channel.put async [%async_token_75]  @cascade_sp[%arg16, %58] (%results_56[] [] []) {id = 41 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_76 = air.execute [%59] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              } {id = 49 : i32}
              %async_token_77 = air.execute [%async_token_63] {
                memref.dealloc %results_54 : memref<64x1xbf16, 2 : i32>
              } {id = 50 : i32}
              %async_token_78 = air.execute [%61] {
                memref.dealloc %results_56 : memref<64x1xbf16, 2 : i32>
              } {id = 51 : i32}
              ...
              %55 = air.channel.get async [%async_token_51]  @cascade_gp[%arg16, %arg17] (%results_52[] [] []) {id = 42 : i32} : (memref<64x64xbf16, 2 : i32>)
              %56 = air.channel.get async [%async_token_53]  @cascade_up[%arg16, %arg17] (%results_54[] [] []) {id = 43 : i32} : (memref<64x1xbf16, 2 : i32>)
              %57 = air.channel.get async [%async_token_55]  @cascade_sp[%arg16, %arg17] (%results_56[] [] []) {id = 44 : i32} : (memref<64x1xbf16, 2 : i32>)
              %async_token_57, %results_58 = air.execute -> (memref<64x1xbf16, 2 : i32>) {
                %alloc = memref.alloc() : memref<64x1xbf16, 2 : i32>
                air.execute_terminator %alloc : memref<64x1xbf16, 2 : i32>
              } {id = 59 : i32}
              ...
              %58 = air.channel.put async [%async_token_76]  @Gp2L2[%arg16, %c0_46] (%results_52[%c0_46, %c0_46, %c0_46, %c0_46] [%c8_44, %c8_44, %c8_44, %c8_44] [%c64_43, %c8_44, %c512_42, %c1_45]) {id = 45 : i32} : (memref<64x64xbf16, 2 : i32>)
              %async_token_77 = air.execute [%58] {
                memref.dealloc %results_52 : memref<64x64xbf16, 2 : i32>
              } {id = 75 : i32}
