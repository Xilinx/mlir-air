...
//
// Flash attention kernel for KV cache prefill.
// Forked from kernel_fusion_based/attn_npu2.cc.
// RoPE is applied on the host before sending Q/K to the NPU.
// TODO: Add on-chip rope_sincos that computes sin/cos directly on AIE2P.
//
//===----------------------------------------------------------------------===//
