module {
  ...
  func.func @copy(%arg0: memref<32x16xi32>, %arg1: memref<32x16xi32>) {
    air.launch () in () args(%arg2=%arg0, %arg3=%arg1) : memref<32x16xi32>, memref<32x16xi32> {
      air.channel.put  @ChanIn[] (%arg2[] [] []) : (memref<32x16xi32>)
      air.channel.get  @ChanOut[] (%arg3[] [] []) : (memref<32x16xi32>)
      air.segment @seg  {
        ...
        air.herd @partial_herd  tile (%arg4, %arg5) in (%arg6=%c1, %arg7=%c1_0) {
          ...
          scf.for %arg8 = %c0 to %c512 step %c1_1 {
          ...
          scf.for %arg8 = %c0_2 to %c512_3 step %c1_4 {
            %alloc = memref.alloc() : memref<1x1xi32, 2 : i32>
            %alloc_5 = memref.alloc() : memref<1x1xi32, 2 : i32>
