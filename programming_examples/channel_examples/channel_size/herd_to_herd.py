...
CHANNEL_SIZE = 4
assert IMAGE_SIZE[0] % CHANNEL_SIZE == 0
...
def build_module():
    ...
    partial_image_type_l1 = MemRefType.get(
        shape=[
            IMAGE_SIZE[0] // CHANNEL_SIZE,
            IMAGE_SIZE[1],
        ],  # Process half the image at a time
        element_type=T.i32(),
    ...
    ChannelOp("Herd2Herd", size=[1, CHANNEL_SIZE])
            ...
            def segment_body():
                ...
                def herd_body(tx, ty, sx, sy):
                    ...
                    for channel_index in range(CHANNEL_SIZE):
                        ...
                        ChannelPut(
                            "Herd2Herd", partial_image_out, indices=[1, channel_index]
                        )
                ...
                def herd_body(tx, ty, sx, sy):
                    ...
                    for channel_index in range(CHANNEL_SIZE):
                        ...
                        ChannelGet(
                            "Herd2Herd", partial_image_in, indices=[1, channel_index]
                        )
