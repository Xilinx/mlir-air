...
def prepare_air_project(quant: str = "bf16"):
    ...
    # - mv_int4_bf16.o  : int4-AWQ GEMV micro-kernel (decode int4 ELFs only)
    obj_names = [
        "silu_and_mul.o",
        "rope.o",
        "attn.o",
...
class KernelCache:
    ...
    def compile_and_cache(
        ...
        # objects — detect from the kernel name so callers don't have to pass
        # an extra flag through every compile_and_cache invocation.
