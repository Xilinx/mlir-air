...
//
///@file qwen3-0.6b.h
///@brief Define the model parameters for the qwen3-0.6b model
#ifndef __QWEN3_0_6B_H__
#define __QWEN3_0_6B_H__

#if MODEL_TYPE == QWEN3_0_6B
