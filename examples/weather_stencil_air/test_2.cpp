...
//   mlir_aie_clear_tile_memory(_xaie, 6, 4);
  ...
  EventMonitor pc0(_xaie, 4, 1, 0, XAIE_EVENT_BROADCAST_0_MEM,XAIE_EVENT_LOCK_14_ACQ_MEM, XAIE_EVENT_NONE_MEM,XAIE_MEM_MOD);
  pc0.set();
  EventMonitor pc1(_xaie, 4, 5, 0, XAIE_EVENT_BROADCAST_1_MEM,XAIE_EVENT_LOCK_14_ACQ_MEM, XAIE_EVENT_NONE_MEM,XAIE_MEM_MOD);
  pc1.set();
