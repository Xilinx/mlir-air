...
int main(int argc, char *argv[]) {
  ...
  uint32_t *ddr_ptr_in_1 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_IN * sizeof(uint32_t));
  if(ddr_ptr_in_1 == NULL) {
    printf("Failed to allocate ddr_ptr_in_1\n");
    return 1;
  }

  uint32_t *ddr_ptr_in_2 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_IN * sizeof(uint32_t));
  if(ddr_ptr_in_2 == NULL) {
    printf("Failed to allocate ddr_ptr_in_2\n");
    return 1;
  }

  uint32_t *ddr_ptr_in_3 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_IN * sizeof(uint32_t));
  ...
  uint32_t *ddr_ptr_out_1 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_OUT * sizeof(uint32_t));
  if(ddr_ptr_out_1 == NULL) {
    printf("Failed to allocate ddr_ptr_out_1\n");
    return 1;
  }

  uint32_t *ddr_ptr_out_2 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_OUT * sizeof(uint32_t));
  if(ddr_ptr_out_2 == NULL) {
    printf("Failed to allocate ddr_ptr_out_2\n");
    return 1;
  }

  uint32_t *ddr_ptr_out_3 = (uint32_t *)air_dev_mem_alloc(DMA_COUNT_OUT * sizeof(uint32_t));
  ...
  dispatch_packet_t *pkt =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt, 0, shim_one_col, 1, 0, 4, 2, air_dev_mem_get_pa(ddr_ptr_in_0),
  ...
  dispatch_packet_t *pkt2 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt2, 0, shim_one_col, 0, 0, 4, 2, air_dev_mem_get_pa(ddr_ptr_out_0),
...
*/
  ...
  dispatch_packet_t *pkt3 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt3, 0, shim_one_col, 1, 1, 4, 2, air_dev_mem_get_pa(ddr_ptr_in_1),
                       DMA_COUNT_IN * sizeof(float), 1, 0, 1, 0, 1, 0);
  ...
  dispatch_packet_t *pkt4 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt4, 0, shim_one_col, 0, 1, 4, 2, air_dev_mem_get_pa(ddr_ptr_out_1),
                       DMA_COUNT_OUT * sizeof(float), 1, 0, 1, 0, 1, 0);
...
*/
  ...
  dispatch_packet_t *pkt5 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt5, 0, shim_two_col, 1, 0, 4, 2, air_dev_mem_get_pa(ddr_ptr_in_2),
                       DMA_COUNT_IN * sizeof(float), 1, 0, 1, 0, 1, 0);
  ...
  dispatch_packet_t *pkt6 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt6, 0, shim_two_col, 0, 0, 4, 2, air_dev_mem_get_pa(ddr_ptr_out_2),
                       DMA_COUNT_OUT * sizeof(float), 1, 0, 1, 0, 1, 0);
  ...
  dispatch_packet_t *pkt7 =
      (dispatch_packet_t *)(queues[0]->base_address_vaddr) + packet_id;
  air_packet_nd_memcpy(pkt7, 0, shim_two_col, 1, 1, 4, 2, air_dev_mem_get_pa(ddr_ptr_in_3),
                       DMA_COUNT_IN * sizeof(float), 1, 0, 1, 0, 1, 0);
