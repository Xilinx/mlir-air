...
lowering_pipeline = ",".join([
    ...
    "air-linalg-codegen{input-filter=linalg.matmul14 herd-size=2,2 l1-tile-size=32,32,32}",
    "air-linalg-codegen{input-filter=linalg.matmul16 herd-size=2,2 l1-tile-size=32,32,32}",
    "air-rm-linalg-name",
    "canonicalize",
    "cse",
    "air-par-to-herd",
