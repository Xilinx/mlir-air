...
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 1 : i32} : (memref<64x64xi32, 1 : i32>, memref<128x128xi32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 2 : i32} : (memref<64x64xi32, 1 : i32>, memref<128x128xi32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 3 : i32} : (memref<64x64xi32, 1 : i32>, memref<128x128xi32>
# CHECK: air.herd @herd_0 tile (%{{.*}}, %{{.*}}) in (%{{.*}}=%c2, %{{.*}}=%c2)
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 4 : i32} : (memref<32x32xi32, 2 : i32>, memref<64x64xi32, 1 : i32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 5 : i32} : (memref<32x32xi32, 2 : i32>, memref<64x64xi32, 1 : i32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 6 : i32} : (memref<32x32xi32, 2 : i32>, memref<64x64xi32, 1 : i32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 7 : i32} : (memref<64x64xi32, 1 : i32>, memref<32x32xi32, 2 : i32>
# CHECK: air.dma_memcpy_nd ({{.*}}) {id = 8 : i32} : (memref<128x128xi32>, memref<64x64xi32, 1 : i32>
@run
