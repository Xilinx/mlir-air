...
class XRTBackend(AirBackend):
    ...
    def __init__(
        ...
        Args:
            ...
            keep_loops_rolled: leave the runtime sequence's constant-trip loops rolled for aiecc to unroll instead of unrolling them in AIR. The instruction stream is unchanged.
        ...
        self.keep_loops_rolled = keep_loops_rolled
    ...
    def compile(
        ...
        with air.ir.Context():
            ...
            if self.keep_loops_rolled:
                aircc_options += ["--keep-loops-rolled"]
