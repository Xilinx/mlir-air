...
module @lineGeneratorStitcherTwoAIEMultipleBufferElements {
    ...
    %core11 = AIE.core(%tile11) {
        ...
        //AIE.useLock(%lock11_{%c16 mod 3}, "Acquire", 1, 0) 
        ...
        scf.for %indexInHeight = %c0 to %height step %M { //NOTE: manually unrolled so if height is set to 10, iteration 9 will still happen, + 2 unrolled out of bound
            ...
            AIE.useLock(%lock11_1, "Acquire", 0, 0) // acquire for produce
            ...
            AIE.useLock(%lock11_1, "Release", 1, 0) // release for consume

            AIE.useLock(%lock11_2, "Acquire", 0, 0) // acquire for produce
            ...
            AIE.useLock(%lock11_2, "Release", 1, 0) // release for consume
        }
    ...
    %core12 = AIE.core(%tile12) {
        ...
        scf.for %rowNumber = %c0 to %height step %M { //NOTE: manually unrolled so if height is set to 10, iteration 9 will still happen, + 2 unrolled out of bound
            ...
            AIE.useLock(%lock11_1, "Acquire", 1, 0) // acquire for consume
            ...
            AIE.useLock(%lock11_1, "Release", 0, 0) // release for produce

            AIE.useLock(%lock11_2, "Acquire", 1, 0) // acquire for consume
            ...
            AIE.useLock(%lock11_2, "Release", 0, 0) // release for produce
