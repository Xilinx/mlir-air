...
struct air_rt_aie_functions_t {
  void (*configure_cores)(air_libxaie1_ctx_t *);
  void (*configure_switchboxes)(air_libxaie1_ctx_t *);
  void (*initialize_locks)(air_libxaie1_ctx_t *);
  void (*configure_dmas)(air_libxaie1_ctx_t *);
  void (*start_cores)(air_libxaie1_ctx_t *);
};
