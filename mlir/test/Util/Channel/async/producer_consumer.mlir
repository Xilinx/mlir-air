...
// RUN: %OPT -O3 -o %T/producer_consumer.async.opt.ll < %T/producer_consumer.async.ll
// RUN: %LLC %T/producer_consumer.async.opt.ll -filetype=obj -o %T/producer_consumer.async.o
