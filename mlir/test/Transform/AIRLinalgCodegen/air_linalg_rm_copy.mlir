...
// CHECK:       %[[A0:.*]] = memref.alloc() : memref<2560xf32, 2 : i32>
// CHECK-NEXT:  %[[A1:.*]] = memref.alloc() : memref<2560xf32, 2 : i32>
...
func.func @test_copy_remove(%arg0: memref<10240xf32>) -> memref<10240xf32> {
  ...
  scf.parallel (%arg1) = (%c0) to (%c10240) step (%c5120) {
    scf.for %arg2 = %c0 to %c5120 step %c2560 {
      ...
      %alloc_1 = memref.alloc() : memref<2560xf32, 2 : i32>
      %alloc_2 = memref.alloc() : memref<2560xf32, 2 : i32>
      memref.copy %subview, %alloc_1 : memref<2560xf32, strided<[1], offset: ?>> to memref<2560xf32, 2 : i32>
      memref.copy %subview_0, %alloc_2 : memref<2560xf32, strided<[1], offset: ?>> to memref<2560xf32, 2 : i32>
      linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins(%alloc_1 : memref<2560xf32, 2 : i32>) outs(%alloc_2 : memref<2560xf32, 2 : i32>) {
      ^bb0(%in: f32, %out: f32):
        %2 = arith.cmpf ugt, %in, %cst : f32
        %3 = arith.select %2, %in, %cst : f32
        linalg.yield %3 : f32
      }
      memref.copy %alloc_2, %subview_0 : memref<2560xf32, 2 : i32> to memref<2560xf32, strided<[1], offset: ?>>
      memref.dealloc %alloc_1 : memref<2560xf32, 2 : i32>
      memref.dealloc %alloc_2 : memref<2560xf32, 2 : i32>
    }
  }
...
// CHECK:       %[[A0:.*]] = memref.alloc() : memref<2560xf32, 2 : i32>
// CHECK-NEXT:  %[[A1:.*]] = memref.alloc() : memref<1280xf32, 2 : i32>
// CHECK-NEXT:  memref.copy %{{.*}}, %[[A0]]
...
func.func @test_copy_reduce(%arg0: memref<10240xf32>) -> memref<10240xf32> {
  ...
  scf.parallel (%arg1) = (%c0) to (%c10240) step (%c5120) {
    scf.for %arg2 = %c0 to %c5120 step %c2560 {
      ...
      %alloc_1 = memref.alloc() : memref<2560xf32, 2 : i32>
      %alloc_2 = memref.alloc() : memref<1280xf32, 2 : i32>
      memref.copy %subview, %alloc_1 : memref<2560xf32, strided<[1], offset: ?>> to memref<2560xf32, 2 : i32>
      memref.copy %subview_0, %alloc_2 : memref<1280xf32, strided<[1], offset: ?>> to memref<1280xf32, 2 : i32>
      linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["reduction"]} ins(%alloc_1 : memref<2560xf32, 2 : i32>) outs(%alloc_2 : memref<1280xf32, 2 : i32>) {
      ^bb0(%in: f32, %out: f32):
        %2 = arith.cmpf ugt, %in, %out : f32
        %3 = arith.select %2, %in, %out : f32
        linalg.yield %3 : f32
      }
      memref.copy %alloc_2, %subview_0 : memref<1280xf32, 2 : i32> to memref<1280xf32, strided<[1], offset: ?>>
      memref.dealloc %alloc_1 : memref<2560xf32, 2 : i32>
      memref.dealloc %alloc_2 : memref<1280xf32, 2 : i32>
    }
  }
  return %alloc : memref<10240xf32>
}
...
func.func @test_copy_use(%arg0: memref<10240xf32>) -> memref<10240xf32> {
  ...
  scf.parallel (%arg1) = (%c0) to (%c10240) step (%c5120) {
    scf.for %arg2 = %c0 to %c5120 step %c2560 {
      ...
      memref.copy %subview, %alloc_1 : memref<2560xf32, strided<[1], offset: ?>> to memref<2560xf32, 2 : i32>
      memref.copy %subview_0, %alloc_2 : memref<2560xf32, strided<[1], offset: ?>> to memref<2560xf32, 2 : i32>
      func.call @external(%alloc_2) : (memref<2560xf32, 2 : i32>) -> ()
      linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins(%alloc_1 : memref<2560xf32, 2 : i32>) outs(%alloc_2 : memref<2560xf32, 2 : i32>) {
      ^bb0(%in: f32, %out: f32):
        %2 = arith.cmpf ugt, %in, %cst : f32
        %3 = arith.select %2, %in, %cst : f32
...
func.func private @external(%arg0: memref<2560xf32, 2 : i32>) -> ()