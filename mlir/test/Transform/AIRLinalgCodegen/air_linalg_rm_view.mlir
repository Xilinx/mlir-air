...
// CHECK: %7 = memref.alloc() : memref<1x16x18x18xf32, 1>
// CHECK: %8 = memref.alloc() : memref<32x16x3x3xf32, 1>
// CHECK: %9 = memref.alloc() : memref<1x32x16x16xf32, 1>
// CHECK: linalg.copy(%4, %7) : memref<1x16x18x18xf32, #map1>, memref<1x16x18x18xf32, 1> 
// CHECK: linalg.copy(%5, %8) : memref<32x16x3x3xf32, #map2>, memref<32x16x3x3xf32, 1> 
// CHECK: linalg.copy(%6, %9) : memref<1x32x16x16xf32, #map3>, memref<1x32x16x16xf32, 1> 
// CHECK: linalg.conv_2d_nchw_fchw {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%7, %8 : memref<1x16x18x18xf32, 1>, memref<32x16x3x3xf32, 1>) outs(%9 : memref<1x32x16x16xf32, 1>)
// CHECK: linalg.copy(%9, %6) : memref<1x32x16x16xf32, 1>, memref<1x32x16x16xf32, #map3> 
// CHECK: memref.dealloc %7 : memref<1x16x18x18xf32, 1>
// CHECK: memref.dealloc %8 : memref<32x16x3x3xf32, 1>
// CHECK: memref.dealloc %9 : memref<1x32x16x16xf32, 1>
    ...
    scf.parallel (%arg2, %arg3) = (%c0, %c0) to (%c64, %c128) step (%c16, %c32) {
      scf.for %arg4 = %c0 to %c64 step %c16 {
        scf.for %arg5 = %c0 to %c64 step %c16 {
          ...
          linalg.copy(%4, %8) : memref<1x16x18x18xf32, #map1>, memref<1x16x18x18xf32> 
          linalg.copy(%5, %10) : memref<32x16x3x3xf32, #map2>, memref<32x16x3x3xf32> 
          linalg.copy(%6, %12) : memref<1x32x16x16xf32, #map3>, memref<1x32x16x16xf32> 
          ...
          linalg.copy(%12, %6) : memref<1x32x16x16xf32>, memref<1x32x16x16xf32, #map3> 
