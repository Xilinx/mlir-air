...
// CHECK: %[[EVENT5:.*]] = air.dma_memcpy_nd {{.*}}broadcast = [[$SET0]]{{.*}}
// CHECK: affine.yield %[[EVENT1]]
// CHECK: %[[EVENT6:.*]] = air.dma_memcpy_nd {{.*}}broadcast = [[$SET1]]{{.*}}
...
module {
  func.func @matmul(%arg0: memref<512x512xbf16>, %arg1: memref<512x512xbf16>, %arg2: memref<512x512xbf16>) {
    ...
    %5 = air.launch_herd async [%asyncToken_1, %asyncToken_3, %asyncToken_5]  tile (%arg7, %arg8) in (%arg9=%c2, %arg10=%c2) args(%arg11=%valOut_2, %arg12=%valOut_4, %arg13=%valOut_6) : memref<64x64xbf16, 1>, memref<64x64xbf16, 1>, memref<64x64xbf16, 1> attributes {id = 1 : i32, sym_name = "herd_0"} {
