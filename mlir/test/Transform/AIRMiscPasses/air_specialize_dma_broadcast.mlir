...
// CHECK: [[$SET2:#set[0-9]+]] = affine_set<()[s0, s1] : (s0 == 0, s1 >= 0)>
// CHECK: [[$SET3:#set[0-9]+]] = affine_set<()[s0, s1] : (s0 - 1 == 0, s1 >= 0)>
...
module {
  func.func @matmul(%arg0: memref<512x512xbf16>, %arg1: memref<512x512xbf16>, %arg2: memref<512x512xbf16>) {
    ...
    %asyncToken, %valOut = air.region async  {
      ...
      air.region_terminator %1 : memref<512x512xbf16>
    ...
    %0 = scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c512, %c512) step (%c64, %c64) init (%asyncToken_0) -> !air.async.token {
      %1 = scf.for %arg5 = %c0 to %c512 step %c64 iter_args(%arg6 = %asyncToken_0) -> (!air.async.token) {
        %asyncToken_1, %valOut_2 = air.region async [%arg6]  : (!air.async.token) {
          %8 = memref.alloc() : memref<64x64xbf16, 1>
          air.region_terminator %8 : memref<64x64xbf16, 1>
        } {id = 3 : i32} : (memref<64x64xbf16, 1>)
        %asyncToken_3, %valOut_4 = air.region async [%arg6]  : (!air.async.token) {
          %8 = memref.alloc() : memref<64x64xbf16, 1>
          air.region_terminator %8 : memref<64x64xbf16, 1>
        } {id = 4 : i32} : (memref<64x64xbf16, 1>)
        %asyncToken_5, %valOut_6 = air.region async [%arg6]  : (!air.async.token) {
          %8 = memref.alloc() : memref<64x64xbf16, 1>
          air.region_terminator %8 : memref<64x64xbf16, 1>
        ...
        %asyncToken_7 = air.region async [%5]  : (!air.async.token) {
        ...
        %asyncToken_9 = air.region async [%6]  : (!air.async.token) {
