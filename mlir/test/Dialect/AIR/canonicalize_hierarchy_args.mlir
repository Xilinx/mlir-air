...
// Prune block arguments for air.herd and air.segment
// CHECK: %[[EVENT0:.*]] = air.launch async{{.*}}args(%[[VALUE1:.*]]=%[[VALUE0:.*]])
// CHECK: %[[EVENT1:.*]] = air.segment async{{.*}}args(%[[VALUE2:.*]]=%[[VALUE1]])
...
module {
  func.func @foo(%arg0: memref<256xi32, 2>) {
    ...
    %0 = air.launch async (%arg1, %arg2) in (%arg3=%c1, %arg4=%c1) args(%arg5=%arg0) : memref<256xi32, 2> attributes {id = 13 : i32} {
      ...
      %2 = air.segment async  unroll(%arg6, %arg7) in (%arg8=%c1_1, %arg9=%c1_1) args(%arg10=%arg5, %newarg1=%valOut) : memref<256xi32, 2>, memref<512xi32, 3> attributes {id = 82 : i32} {
