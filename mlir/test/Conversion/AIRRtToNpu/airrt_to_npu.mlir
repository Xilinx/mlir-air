...
module {
  ...
  func.func @func0(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId2} : (i32, i64, i64, memref<64xi32>)
    %p = airrt.segment_load "segment0" : i64
    %c7_i32 = arith.constant 7 : i32
    airrt.dma_memcpy_nd(%c7_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId7} : (i32, i64, i64, memref<64xi32>)
    return
  }
}
...
module {
  ...
  func.func @func1(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    %c2_i32 = arith.constant 2 : i32
    %c64_i64 = arith.constant 64 : i64
    %0 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId2} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    %p = airrt.segment_load "segment0" : i64
    %1 = airrt.wait_all : !airrt.event
    %c7_i32 = arith.constant 7 : i32
    %2 = airrt.dma_memcpy_nd(%c7_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId7} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    airrt.wait_all %0, %2
    return
  }
}
  ...
  func.func @func2(%arg0: memref<32x32xi32>, %arg1: memref<32x32xi32>, %arg2: memref<32x32xi32>) {
    ...
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 1 {
        ...
        %6 = airrt.dma_memcpy_nd(%c5_i32, %2, %3, %arg2[%c0_i64, %c0_i64, %4, %5], [%c1_i64, %c1_i64, %c32_i64, %c32_i64], [%c0_i64, %c0_i64, %c32_i64, %c1_i64]) {metadata = @airMemcpyId5} : (i32, i64, i64, memref<32x32xi32>) : !airrt.event
        %7 = airrt.dma_memcpy_nd(%c6_i32, %2, %3, %arg0[%c0_i64, %c0_i64, %4, %c0_i64], [%c1_i64, %c1_i64, %c32_i64, %c32_i64], [%c0_i64, %c0_i64, %c32_i64, %c1_i64]) {metadata = @airMemcpyId6} : (i32, i64, i64, memref<32x32xi32>) : !airrt.event
        %8 = airrt.dma_memcpy_nd(%c7_i32, %2, %3, %arg1[%c0_i64, %c0_i64, %c0_i64, %5], [%c1_i64, %c1_i64, %c32_i64, %c32_i64], [%c0_i64, %c0_i64, %c32_i64, %c1_i64]) {metadata = @airMemcpyId7} : (i32, i64, i64, memref<32x32xi32>) : !airrt.event
        %9 = airrt.dma_memcpy_nd(%c16_i32, %2, %3, %arg2[%c0_i64, %c0_i64, %4, %5], [%c1_i64, %c1_i64, %c32_i64, %c32_i64], [%c0_i64, %c0_i64, %c32_i64, %c1_i64]) {metadata = @airMemcpyId16} : (i32, i64, i64, memref<32x32xi32>) : !airrt.event
      ...
      affine.for %arg2 = 0 to 1 {
        affine.for %arg3 = 0 to 2 {
          affine.for %arg4 = 0 to 2 {
            ...
            %4 = arith.index_cast %0 : index to i64
            %5 = arith.index_cast %1 : index to i64
            %6 = airrt.dma_memcpy_nd(%c14_i32, %2, %3, %arg0[%c0_i64, %c0_i64, %4, %5], [%c1_i64, %c1_i64, %c4_i64, %c4_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @airMemcpyId14} : (i32, i64, i64, memref<8x8xi32>) : !airrt.event
            airrt.wait_all %6
          }
        }
        %p = airrt.segment_load "segment_0" : i64
      ...
      affine.for %arg2 = 0 to 1 {
        affine.for %arg3 = 0 to 2 {
          affine.for %arg4 = 0 to 2 {
            ...
            %4 = arith.index_cast %0 : index to i64
            %5 = arith.index_cast %1 : index to i64
            %6 = airrt.dma_memcpy_nd(%c14_i32, %2, %3, %arg0[%c0_i64, %c0_i64, %4, %5], [%c1_i64, %c1_i64, %c4_i64, %c4_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @air_channel_1} : (i32, i64, i64, memref<8x8xi32>) : !airrt.event
            airrt.wait_all %6
          }
        }
        %p = airrt.segment_load "segment_0" : i64
...
module {
  aie.device(npu1_1col) {
    ...
    func.func @func11(%arg0: memref<128x128xbf16>, %arg1: memref<128x128xbf16>) {
      ...
      %c1_i64 = arith.constant 1 : i64
      airrt.dma_memcpy_nd(%c0_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c4_i64, %c4_i64, %c32_i64, %c32_i64], [%c4096_i64, %c32_i64, %c128_i64, %c1_i64]) {metadata = @md0} : (i32, i64, i64, memref<128x128xbf16>)
      return
    }
  }
}
...
module {
  ...
  func.func @func12() {
    ...
    airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %alloc[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c32_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @md0} : (i32, i64, i64, memref<32xbf16>)
    %p = airrt.segment_load "segment_0" : i64
    return
  }
}
  ...
  func.func @func18() {
    ...
    affine.for %arg3 = 0 to 4 {
      affine.for %arg4 = 0 to 4 {
        ...
        %16 = airrt.dma_memcpy_nd(%c26_i32, %12, %13, %alloc[%c0_i64, %c0_i64, %14, %15], [%c1_i64, %c1_i64, %c64_i64, %c64_i64], [%c0_i64, %c0_i64, %c32768_i64, %c1_i64]) {metadata = @airMemcpyId26} : (i32, i64, i64, memref<8192x32768xi32>) : !airrt.event
        %p = airrt.segment_load "segment_0" : i64
      }
    }
    return
  ...
  func.func @func21(%arg0: memref<9728x2432xbf16>) {
    ...
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 1 {
        ...
        %4 = airrt.dma_memcpy_nd(%c10_i32, %1, %2, %arg0[%c0_i64, %c0_i64, %c0_i64, %3], [%c152_i64, %c2_i64, %c64_i64, %c64_i64], [%c155648_i64, %c64_i64, %c2432_i64, %c1_i64]) {metadata = @airMemcpyId10} : (i32, i64, i64, memref<9728x2432xbf16>) : !airrt.event
        %p = airrt.segment_load "segment_0" : i64
      }
    }
    return
...
module {
  ...
  func.func @await_clustering(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input_channel} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @output_channel} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    // First synchronization point
    airrt.wait_all %0, %1
    // Second batch: another pair of DMAs
    %2 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input_channel} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    %3 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @output_channel} : (i32, i64, i64, memref<64xi32>) : !airrt.event
...
module {
  ...
  func.func @free_task_for_mm2s(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @mm2s_input} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    // S2MM (device to host, output) - should get dma_await_task
    %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @s2mm_output} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    airrt.wait_all %0, %1
    %p = airrt.segment_load "segment_0" : i64
    return
  }
...
module {
  ...
  func.func @multiple_mm2s_free(%arg0: memref<64xi32>, %arg1: memref<64xi32>, %arg2: memref<64xi32>) {
    ...
    // Two MM2S inputs
    %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input_a} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input_b} : (i32, i64, i64, memref<64xi32>) : !airrt.event
    // One S2MM output
    %2 = airrt.dma_memcpy_nd(%c3_i32, %c0_i64, %c0_i64, %arg2[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @output_c} : (i32, i64, i64, memref<64xi32>) : !airrt.event
...
module {
  ...
  func.func @packet_attr_transfer(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId2, packet = #aie.packet_info<pkt_type = 0, pkt_id = 3>} : (i32, i64, i64, memref<64xi32>)
    %p = airrt.segment_load "segment0" : i64
...
module {
  ...
  func.func @packet_attr_with_dims(%arg0: memref<32x64xi32>, %arg1: memref<64xi32>) {
    ...
    airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c2_i64, %c64_i64], [%c0_i64, %c0_i64, %c64_i64, %c0_i64]) {metadata = @airMemcpyId2, packet = #aie.packet_info<pkt_type = 0, pkt_id = 5>} : (i32, i64, i64, memref<32x64xi32>)
    %p = airrt.segment_load "segment0" : i64
    airrt.dma_memcpy_nd(%c7_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId7} : (i32, i64, i64, memref<64xi32>)
    return
  }
...
module {
  aie.device(npu1_1col) {
    ...
    func.func @broadcast_stride_zero(%arg0: memref<64xbf16>) {
      ...
      airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c2_i64, %c2_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {metadata = @airMemcpyId2} : (i32, i64, i64, memref<64xbf16>)
      return
    }
  }
}
...
module {
  aie.device(npu1_1col) {
    ...
    func.func @broadcast_stride_zero_nested(%arg0: memref<64xbf16>) {
      ...
      airrt.dma_memcpy_nd(%c4_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c2_i64, %c3_i64, %c2_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {metadata = @airMemcpyId4} : (i32, i64, i64, memref<64xbf16>)
      return
    }
  }
}
...
module {
  aie.device(npu1_1col) {
    ...
    func.func @bd_repeat_dim_size1_gap(%arg0: memref<512x512xbf16>) {
      ...
      airrt.dma_memcpy_nd(%c5_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c64_i64], [%c4_i64, %c1_i64, %c128_i64, %c64_i64], [%c65536_i64, %c64_i64, %c512_i64, %c1_i64]) {metadata = @airMemcpyId5} : (i32, i64, i64, memref<512x512xbf16>)
      return
    }
  }
}
