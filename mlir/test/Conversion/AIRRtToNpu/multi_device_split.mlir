...
module {
  ...
  func.func @reconfigure_example(%arg0: memref<512xi32>) {
    ...
    affine.for %arg1 = 0 to 1 {
      %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_in_add_two} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_out_add_two} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      airrt.wait_all %0, %1
    ...
    affine.for %arg1 = 0 to 1 {
      %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_in_add_three} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_out_add_three} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      airrt.wait_all %0, %1
...
module {
  ...
  func.func @mixed_seg_herd(%arg0: memref<512xi32>) {
    ...
    affine.for %arg1 = 0 to 1 {
      %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_in_seg} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_out_seg} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      airrt.wait_all %0, %1
    ...
    affine.for %arg1 = 0 to 1 {
      %0 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_in_herd} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      %1 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c512_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @air_channel_out_herd} : (i32, i64, i64, memref<512xi32>) : !airrt.event
      airrt.wait_all %0, %1
