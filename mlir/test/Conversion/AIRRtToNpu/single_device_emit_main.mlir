...
module {
  ...
  func.func @single_launch(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    affine.for %arg2 = 0 to 1 {
      ...
      %1 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId1} : (i32, i64, i64, memref<64xi32>) : !airrt.event
      %2 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @airMemcpyId2} : (i32, i64, i64, memref<64xi32>) : !airrt.event
...
module {
  ...
  func.func @with_output(%arg0: memref<64xi32>, %arg1: memref<64xi32>) {
    ...
    affine.for %arg2 = 0 to 1 {
      ...
      // Two input DMAs (MM2S)
      %1 = airrt.dma_memcpy_nd(%c1_i32, %c0_i64, %c0_i64, %arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input1_alloc} : (i32, i64, i64, memref<64xi32>) : !airrt.event
      %2 = airrt.dma_memcpy_nd(%c2_i32, %c0_i64, %c0_i64, %arg1[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @input2_alloc} : (i32, i64, i64, memref<64xi32>) : !airrt.event
      // Output DMA (S2MM) - writes to the allocated output buffer
      %3 = airrt.dma_memcpy_nd(%c3_i32, %c0_i64, %c0_i64, %output[%c0_i64, %c0_i64, %c0_i64, %c0_i64], [%c1_i64, %c1_i64, %c1_i64, %c64_i64], [%c0_i64, %c0_i64, %c0_i64, %c0_i64]) {metadata = @output_alloc} : (i32, i64, i64, memref<64xi32>) : !airrt.event
