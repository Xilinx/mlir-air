  ...
  func.func @func0(%arg0: memref<8x16xi32>, %arg1: memref<16x8xi32>, %arg2: memref<8x8xi32>) {
    ...
    affine.for %arg3 = 0 to 1 {
      affine.for %arg4 = 0 to 1 {
        ...
        %5 = airrt.dma_memcpy_nd(%c4_i32, %2, %3, %arg0[%c0_i64, %c0_i64, %4, %c0_i64], [%c1_i64, %c1_i64, %c8_i64, %c16_i64], [%c0_i64, %c0_i64, %c16_i64, %c1_i64]) {metadata = @airMemcpyId4} : (i32, i64, i64, memref<8x16xi32>) : !airrt.event
        %6 = airrt.wait_all %5 : !airrt.event
        %7 = arith.index_cast %0 : index to i64
        %8 = airrt.dma_memcpy_nd(%c4_i32, %2, %3, %arg1[%c0_i64, %c0_i64, %c0_i64, %7], [%c1_i64, %c1_i64, %c16_i64, %c8_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @airMemcpyId5} : (i32, i64, i64, memref<16x8xi32>) : !airrt.event
        %9 = airrt.dma_memcpy_nd(%c16_i32, %2, %3, %alloc[%c0_i64, %c0_i64, %4, %7], [%c1_i64, %c1_i64, %c8_i64, %c8_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @airMemcpyId16} : (i32, i64, i64, memref<8x8xi32>) : !airrt.event
  ...
  func.func @func1() {
    ...
    affine.for %arg0 = 0 to 1 {
      affine.for %arg1 = 0 to 1 {
        ...
        %8 = airrt.dma_memcpy_nd(%c4_i32, %5, %6, %0[%c0_i64, %c0_i64, %7, %c0_i64], [%c1_i64, %c1_i64, %c8_i64, %c16_i64], [%c0_i64, %c0_i64, %c16_i64, %c1_i64]) {metadata = @airMemcpyId4} : (i32, i64, i64, memref<8x16xi32>) : !airrt.event
        ...
        %13 = airrt.dma_memcpy_nd(%c4_i32, %10, %11, %1[%c0_i64, %c0_i64, %c0_i64, %12], [%c1_i64, %c1_i64, %c16_i64, %c8_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @airMemcpyId5} : (i32, i64, i64, memref<16x8xi32>) : !airrt.event
        ...
        %20 = airrt.dma_memcpy_nd(%c16_i32, %16, %17, %2[%c0_i64, %c0_i64, %18, %19], [%c1_i64, %c1_i64, %c8_i64, %c8_i64], [%c0_i64, %c0_i64, %c8_i64, %c1_i64]) {metadata = @airMemcpyId16} : (i32, i64, i64, memref<8x8xi32>) : !airrt.event
        %p = airrt.segment_load "segment_0" : i64
      }
    }
    return
  ...
  func.func @func2() {
    ...
    affine.for %arg0 = 0 to 1 {
      affine.for %arg1 = 0 to 1 {
        ...
        %16 = airrt.dma_memcpy_nd(%c4_i32, %13, %14, %0[%c0_i64, %c0_i64, %15, %c0_i64], [%c1_i64, %c8_i64, %c128_i64, %c256_i64], [%c0_i64, %c256_i64, %c2048_i64, %c1_i64]) {metadata = @airMemcpyId10} : (i32, i64, i64, memref<2048x2048xbf16>) : !airrt.event
        ...
        %23 = airrt.dma_memcpy_nd(%c7_i32, %20, %21, %3[%c0_i64, %c0_i64, %c0_i64, %22], [%c1_i64, %c1_i64, %c2048_i64, %c128_i64], [%c0_i64, %c0_i64, %c2048_i64, %c1_i64]) {metadata = @airMemcpyId13} : (i32, i64, i64, memref<2048x2048xbf16>) : !airrt.event
        ...
        %33 = airrt.dma_memcpy_nd(%c26_i32, %29, %30, %6[%c0_i64, %c0_i64, %31, %32], [%c1_i64, %c1_i64, %c128_i64, %c128_i64], [%c0_i64, %c0_i64, %c2048_i64, %c1_i64]) {metadata = @airMemcpyId26} : (i32, i64, i64, memref<2048x2048xbf16>) : !airrt.event
        %p = airrt.segment_load "segment_0" : i64
