...
// CHECK: %1 = llvm.bitcast %0 : !llvm.ptr to !llvm.ptr
// CHECK: %2 = call @__airrt_segment_load(%1) : (!llvm.ptr) -> i64
// CHECK: %3 = llvm.mlir.addressof @__airrt_string_elk : !llvm.ptr
// CHECK: %4 = llvm.bitcast %3 : !llvm.ptr to !llvm.ptr
// CHECK: %5 = call @__airrt_herd_load(%4) : (!llvm.ptr) -> i64
// CHECK: %6 = llvm.mlir.addressof @__airrt_string_deer : !llvm.ptr
// CHECK: %7 = llvm.bitcast %6 : !llvm.ptr to !llvm.ptr
// CHECK: %8 = call @__airrt_herd_load(%7) : (!llvm.ptr) -> i64
module {
