...
// CHECK: %[[EVENT1:.*]] = air.channel.get async{{.*}}@channel_1[]
// CHECK: %[[EVENT2:.*]] = air.herd @herd_0 async{{.*}}tile (%[[VALUE2:.*]], %[[VALUE3:.*]]) in
...
// CHECK: %[[EVENT3:.*]] = air.channel.get async{{.*}}@channel_0[]
// CHECK: %[[EVENT4:.*]] = air.channel.put async{{.*}}@channel_1[]
