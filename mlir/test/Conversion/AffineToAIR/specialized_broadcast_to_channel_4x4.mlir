...
module {
// CHECK: air.channel @channel_3 [] {broadcast_shape = [1, 4]}
// CHECK: air.channel @channel_2 [] {broadcast_shape = [1, 4]}
// CHECK: air.channel @channel_1 [] {broadcast_shape = [1, 4]}
// CHECK: air.channel @channel_0 [] {broadcast_shape = [1, 4]}
