//===- air_channel_to_objectfifo_distribute.mlir ----------------*- MLIR -*-===//
//
...
// CHECK:    aie.objectfifo @air_channel_3(%[[VAL_1]], {%[[VAL_3]]}, 1 : i32) : !aie.objectfifo<memref<16xi32>>
// CHECK:    aie.objectfifo @air_channel_2(%[[VAL_1]], {%[[VAL_2]]}, 1 : i32) : !aie.objectfifo<memref<16xi32>>
// CHECK:    aie.objectfifo @air_channel_0(%[[VAL_0]], {%[[VAL_1]]}, 1 : i32) : !aie.objectfifo<memref<32xi32>>
// CHECK:    aie.objectfifo.link [@air_channel_0] -> [@air_channel_2, @air_channel_3]()
// CHECK:    %[[VAL_4:.*]] = aie.core(%[[VAL_3]]) {
// CHECK:      %[[VAL_5:.*]] = aie.objectfifo.acquire @air_channel_3(Consume, 1) : !aie.objectfifosubview<memref<16xi32>>
// CHECK:      %[[VAL_6:.*]] = aie.objectfifo.subview.access %[[VAL_5]][0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
// CHECK:      aie.objectfifo.release @air_channel_3(Consume, 1)
// CHECK:      aie.end
// CHECK:    } {elf_file = "segment_0_core_5_4.elf"}
// CHECK:    %[[VAL_5:.*]] = aie.core(%[[VAL_2]]) {
// CHECK:      %[[VAL_6:.*]] = aie.objectfifo.acquire @air_channel_2(Consume, 1) : !aie.objectfifosubview<memref<16xi32>>
// CHECK:      %[[VAL_7:.*]] = aie.objectfifo.subview.access %[[VAL_6]][0] : !aie.objectfifosubview<memref<16xi32>> -> memref<16xi32>
// CHECK:      aie.objectfifo.release @air_channel_2(Consume, 1)
// CHECK:      aie.end
  ...
  func.func @L2toL1(%arg0: memref<32xi32>) {
    ...
    air.launch (%arg1, %arg2) in (%arg3=%c1, %arg4=%c2) args(%arg5=%arg0) : memref<32xi32> attributes {id = 1 : i32} {
      ...
      %2 = air.segment async args(%arg6=%arg1, %arg7=%arg2) : index, index attributes {id = 3 : i32} {
        ...
        %6 = air.channel.put async [%5] @channel_1[%c0_2, %c0_2] (%results_1[%c0_2] [%c16] []) {id = 5 : i32} : (memref<32xi32, 1>)
        %7 = air.channel.put async [%5] @channel_1[%c0_2, %c1_2] (%results_1[%c16] [%c16] []) {id = 6 : i32} : (memref<32xi32, 1>)
        
        %8 = air.herd @herd_0 async [%4] tile (%arg8, %arg9) in (%arg10=%c1_2, %arg11=%c2_2) attributes {id = 7 : i32} {
            ...
            %10 = air.channel.get async [%async_token_2, %9] @channel_1[%arg8, %arg9] (%results_2[] [] []) {id = 8 : i32} : (memref<16xi32, 2>)
