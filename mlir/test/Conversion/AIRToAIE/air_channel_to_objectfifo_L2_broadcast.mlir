...
// CHECK:      aie.objectfifo.acquire @air_channel_1(Consume, 1) : memref<32xi32>
    ...
    air.launch (%arg1, %arg2) in (%arg3=%c1, %arg4=%c2) args(%arg5=%arg0) : memref<32xi32> attributes {id = 1 : i32} {
      ...
      %2 = air.segment async args(%arg6=%arg1, %arg7=%arg2) : index, index attributes {id = 3 : i32} {
        ...
        %7 = air.herd @herd_0 async [%6] tile (%arg8, %arg9) in (%arg10=%c1_2, %arg11=%c2_2) attributes {id = 6 : i32} {
            ...
            %9 = air.channel.get async [%async_token_2, %8] @channel_1[%arg8, %arg9] (%results_2[] [] []) {id = 7 : i32} : (memref<32xi32, 2>)
