...
// CHECK:   %[[VAL_4:.*]] = AIE.buffer(%[[VAL_3]]){{.*}}memref<64x96xbf16>
// CHECK:   %[[VAL_5:.*]] = AIE.buffer(%[[VAL_3]]){{.*}}memref<96x64xbf16>
// CHECK:   %[[VAL_6:.*]] = AIE.buffer(%[[VAL_3]]){{.*}}memref<64x64xbf16>
// CHECK:   %[[VAL_7:.*]] = AIE.buffer(%[[VAL_2]]){{.*}}memref<64x96xbf16>
// CHECK:   %[[VAL_8:.*]] = AIE.buffer(%[[VAL_2]]){{.*}}memref<96x64xbf16>
// CHECK:   %[[VAL_9:.*]] = AIE.buffer(%[[VAL_2]]){{.*}}memref<64x64xbf16>
// CHECK:   %[[VAL_10:.*]] = AIE.buffer(%[[VAL_1]]){{.*}}memref<64x96xbf16>
// CHECK:   %[[VAL_11:.*]] = AIE.buffer(%[[VAL_1]]){{.*}}memref<96x64xbf16>
// CHECK:   %[[VAL_12:.*]] = AIE.buffer(%[[VAL_1]]){{.*}}memref<64x64xbf16>
// CHECK:   %[[VAL_13:.*]] = AIE.buffer(%[[VAL_0]]){{.*}}memref<64x96xbf16>
// CHECK:   %[[VAL_14:.*]] = AIE.buffer(%[[VAL_0]]){{.*}}memref<96x64xbf16>
// CHECK:   %[[VAL_15:.*]] = AIE.buffer(%[[VAL_0]]){{.*}}memref<64x64xbf16>
