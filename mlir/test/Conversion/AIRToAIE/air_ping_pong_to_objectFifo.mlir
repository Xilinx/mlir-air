...
// CHECK:   %[[VAL_3:.*]] = AIE.objectFifo.createObjectFifo(%[[VAL_1]], {%[[VAL_0]]}, 2 : i32) {sym_name = "air_channel_0"} : !AIE.objectFifo<memref<32xi32>>
...
// CHECK:       AIE.objectFifo.release<Produce> (%[[VAL_3]] : !AIE.objectFifo<memref<32xi32>>, 1)
// CHECK:     }
// CHECK:     AIE.end
