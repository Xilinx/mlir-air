...
module attributes {torch.debug_module_name = "mmult"} {
  func.func @forward(%a0: memref<64x64xi32>, %a1: memref<64x64xi32>, %a2: memref<64x64xi32>) {
    air.segment @segment0 args(%arg0=%a0, %arg1=%a1, %arg2=%a2) : memref<64x64xi32>, memref<64x64xi32>, memref<64x64xi32> {
      ...
      %0 = memref.alloc() {alignment = 128 : i64} : memref<64x64xi32, 1>
      linalg.fill ins(%c0_i32 : i32) outs(%0 : memref<64x64xi32, 1>)
      %1 = memref.alloc() {alignment = 128 : i64} : memref<64x64xi32, 1>
      memref.copy %0, %1 : memref<64x64xi32, 1> to memref<64x64xi32, 1>
      air.herd @herd_0  tile (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) args(%arg7=%arg0, %arg8=%arg1, %arg9=%1) : memref<64x64xi32>, memref<64x64xi32>, memref<64x64xi32, 1> {
        ...
        scf.for %arg10 = %c0 to %c64 step %c32 {
          ...
          air.dma_memcpy_nd (%6[] [] [], %arg9[%2, %3] [%c32, %c32] [%c64, %c1]) {id = 3 : i32} : (memref<32x32xi32, 2>, memref<64x64xi32, 1>)
          linalg.matmul ins(%4, %5 : memref<32x32xi32, 2>, memref<32x32xi32, 2>) outs(%6 : memref<32x32xi32, 2>)
          air.dma_memcpy_nd (%arg9[%2, %3] [%c32, %c32] [%c64, %c1], %6[] [] []) {id = 4 : i32} : (memref<64x64xi32, 1>, memref<32x32xi32, 2>)
          memref.dealloc %4 : memref<32x32xi32, 2>
          memref.dealloc %5 : memref<32x32xi32, 2>
          memref.dealloc %6 : memref<32x32xi32, 2>
        }
      }
      memref.copy %1, %arg2 : memref<64x64xi32, 1> to memref<64x64xi32>
    }
    return
  }
}
