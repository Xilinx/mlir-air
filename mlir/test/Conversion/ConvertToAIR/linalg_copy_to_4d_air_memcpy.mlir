...
//CHECK: air.dma_memcpy_nd (%{{.*}}[] [] [], %{{.*}}[0, %{{.*}}, %{{.*}}, %{{.*}}] [1, 16, 18, 18] [278784, 4356, 66, 1])
//CHECK: air.dma_memcpy_nd (%{{.*}}[] [] [], %{{.*}}[%{{.*}}, %{{.*}}, 0, 0] [32, 16, 3, 3] [576, 9, 3, 1])
//CHECK: air.dma_memcpy_nd (%{{.*}}[] [] [], %{{.*}}[0, %{{.*}}, %{{.*}}, %{{.*}}] [1, 32, 16, 16] [524288, 4096, 64, 1])
//CHECK: air.dma_memcpy_nd (%{{.*}}[0, %{{.*}}, %{{.*}}, %{{.*}}] [1, 32, 16, 16] [524288, 4096, 64, 1], %{{.*}}[] [] [])
