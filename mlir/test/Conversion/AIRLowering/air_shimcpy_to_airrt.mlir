...
module  {
  ...
  // CHECK: airrt.dma_memcpy_nd(%c1_i32, %{{.*}}, %{{.*}}, %arg0[%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c1_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}]) : (i32, i64, i64, memref<4096x1024x512xi32>, [i64, i64, i64, i64], [i64, i64, i64, i64], [i64, i64, i64, i64])
  // CHECK: airrt.dma_memcpy_nd(%c2_i32, %{{.*}}, %{{.*}}, %arg1[%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c1_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}]) : (i32, i64, i64, memref<4096x1024x512xi32>, [i64, i64, i64, i64], [i64, i64, i64, i64], [i64, i64, i64, i64])
  // CHECK: airrt.dma_memcpy_nd(%c3_i32, %{{.*}}, %{{.*}}, %arg2[%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c1_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}]) : (i32, i64, i64, memref<4096x1024x512xi32>, [i64, i64, i64, i64], [i64, i64, i64, i64], [i64, i64, i64, i64])
  // CHECK: airrt.dma_memcpy_nd(%c4_i32, %{{.*}}, %{{.*}}, %arg2[%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c1_i64, %{{.*}}, %{{.*}}, %{{.*}}], [%c0_i64, %{{.*}}, %{{.*}}, %{{.*}}]) : (i32, i64, i64, memref<4096x1024x512xi32>, [i64, i64, i64, i64], [i64, i64, i64, i64], [i64, i64, i64, i64])
