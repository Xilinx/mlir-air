...
module  {
  ...
  // CHECK: airrt.dma_memcpy_nd(%c1_i32, %{{.*}}, %{{.*}}, %arg0[0, %{{.*}}, %{{.*}}, %{{.*}}], [1, 32, 32, 128], [0, 524288, 512, 1]) : (i32, i64, i64, memref<4096x1024x512xi32>)
  // CHECK: airrt.dma_memcpy_nd(%c2_i32, %{{.*}}, %{{.*}}, %arg1[0, %{{.*}}, %{{.*}}, %{{.*}}], [1, 32, 32, 128], [0, 524288, 512, 1]) : (i32, i64, i64, memref<4096x1024x512xi32>)
  // CHECK: airrt.dma_memcpy_nd(%c3_i32, %{{.*}}, %{{.*}}, %arg2[0, %{{.*}}, %{{.*}}, %{{.*}}], [1, 32, 32, 128], [0, 524288, 512, 1]) : (i32, i64, i64, memref<4096x1024x512xi32>)
  // CHECK: airrt.dma_memcpy_nd(%c4_i32, %{{.*}}, %{{.*}}, %arg2[0, %{{.*}}, %{{.*}}, %{{.*}}], [1, 32, 32, 128], [0, 524288, 512, 1]) : (i32, i64, i64, memref<4096x1024x512xi32>)
