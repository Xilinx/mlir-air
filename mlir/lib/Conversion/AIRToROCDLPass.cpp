...
#include "air/Conversion/Passes.h.inc"
  ...
  struct ConvertAIRToROCDLPass : public  impl::ConvertAIRToROCDLBase<ConvertAIRToROCDLPass> { 
    ...
    void runOnOperation() override {
      ...
      patterns.add<AffineApplyToSubPattern, DMAMemcpyToSubPattern, SCFForToSubPattern>(&getContext());
      ...
      module.walk([&](air::LaunchOp launchOp) {
          launchOp.walk([&](air::SegmentOp segmentOp) {
              ...
              gpu::LaunchOp gpuLaunchOp = convertLaunchToGPULaunch(launchOp, builder, gridXVal, gridYVal);
      ...
      module.walk([&](gpu::LaunchOp gpuLaunchOp) {
          module.walk([&](air::LaunchOp launchOp) {
              ...
              for (auto &operation : llvm::make_early_inc_range(launchBlock.without_terminator())) {
